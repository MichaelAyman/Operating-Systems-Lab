...
int main(int argc, char *argv[]){
  ...
  32:	68 38 08 00 00       	push   $0x838
		...
		gid = getpgid(pid);
                printf(2,"CHILD\nPID: %d\n",pid);
  37:	6a 02                	push   $0x2
  39:	e8 d2 04 00 00       	call   510 <printf>
                printf(2,"PGID: %d\n",gid);
  3e:	83 c4 0c             	add    $0xc,%esp
  41:	56                   	push   %esi
  42:	68 48 08 00 00       	push   $0x848
  47:	6a 02                	push   $0x2
...
float sqrt(int num) {
 ...
 333:	d9 05 64 08 00 00    	flds   0x864
 ...
 34e:	dc ea                	fsubr  %st,%st(2)
    eps = eps / 10;
 350:	d8 35 68 08 00 00    	fdivs  0x868
  for (i = 0; i < 5; i++) {
 ...
 519:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 589:	ff 24 85 74 08 00 00 	jmp    *0x874(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 697:	90                   	nop
          s = "(null)";
 698:	ba 6c 08 00 00       	mov    $0x86c,%edx
        while(*s != 0){
 ...
 6b1:	a1 a8 0b 00 00       	mov    0xba8,%eax
{
 ...
 6f1:	5b                   	pop    %ebx
  freep = p;
 6f2:	89 15 a8 0b 00 00    	mov    %edx,0xba8
}
 6f8:	5e                   	pop    %esi
 6f9:	5f                   	pop    %edi
 6fa:	5d                   	pop    %ebp
 ...
 729:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 72c:	89 15 a8 0b 00 00    	mov    %edx,0xba8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 749:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 74c:	8b 3d a8 0b 00 00    	mov    0xba8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 78f:	73 4f                	jae    7e0 <malloc+0xa0>
    ...
    if(p == freep)
 791:	8b 3d a8 0b 00 00    	mov    0xba8,%edi
 ...
 7ba:	e8 f1 fe ff ff       	call   6b0 <free>
  return freep;
 7bf:	8b 15 a8 0b 00 00    	mov    0xba8,%edx
 ...
 7ec:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7ef:	89 15 a8 0b 00 00    	mov    %edx,0xba8
}
 ...
 807:	0b 00 00 
    base.s.size = 0;
 80a:	bf ac 0b 00 00       	mov    $0xbac,%edi
    base.s.ptr = freep = prevp = &base;
 80f:	c7 05 ac 0b 00 00 ac 	movl   $0xbac,0xbac
 816:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 819:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 81b:	c7 05 b0 0b 00 00 00 	movl   $0x0,0xbb0
 822:	00 00 00 
    if(p->s.size >= nunits){
