...
int main(int argc, char *argv[]){
  ...
  10:	83 ec 0c             	sub    $0xc,%esp
	...
	//create child using fork
        int child_pid = fork();
  13:	e8 56 03 00 00       	call   36e <fork>
        int pid;
  ...
  1a:	7e 37                	jle    53 <main+0x53>
                pid = getpid();
  1c:	e8 d5 03 00 00       	call   3f6 <getpid>
		gid = getpgid(pid);
  ...
  25:	89 c3                	mov    %eax,%ebx
		gid = getpgid(pid);
  27:	e8 f2 03 00 00       	call   41e <getpgid>
                printf(2,"PARENT\nPID: %d\n",pid);
  ...
  32:	68 88 08 00 00       	push   $0x888
		...
		gid = getpgid(pid);
                printf(2,"CHILD\nPID: %d\n",pid);
  37:	6a 02                	push   $0x2
  39:	e8 e2 04 00 00       	call   520 <printf>
                printf(2,"PGID: %d\n",gid);
  3e:	83 c4 0c             	add    $0xc,%esp
  41:	56                   	push   %esi
  42:	68 98 08 00 00       	push   $0x898
  47:	6a 02                	push   $0x2
  49:	e8 d2 04 00 00       	call   520 <printf>
                exit();
  4e:	e8 23 03 00 00       	call   376 <exit>
                pid = getpid();
  53:	e8 9e 03 00 00       	call   3f6 <getpid>
		setpgid(2);
  ...
  5d:	89 c3                	mov    %eax,%ebx
		setpgid(2);
  5f:	e8 c2 03 00 00       	call   426 <setpgid>
		gid = getpgid(pid);
  64:	89 1c 24             	mov    %ebx,(%esp)
  67:	e8 b2 03 00 00       	call   41e <getpgid>
                printf(2,"CHILD\nPID: %d\n",pid);
...
float sqrt(int num) {
 ...
 328:	d9 05 b8 08 00 00    	flds   0x8b8
 ...
 33e:	dc ea                	fsubr  %st,%st(2)
    eps = eps / 10;
 340:	d8 35 bc 08 00 00    	fdivs  0x8bc
  for (i = 0; i < 5; i++) {
 ...
 468:	89 d1                	mov    %edx,%ecx
{
 ...
 4ab:	0f b6 92 18 09 00 00 	movzbl 0x918(%edx),%edx
 ...
 529:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 593:	ff 24 85 c0 08 00 00 	jmp    *0x8c0(,%eax,4)
 ...
 6c8:	bf b1 08 00 00       	mov    $0x8b1,%edi
...
free(void *ap)
{
 ...
 701:	a1 2c 09 00 00       	mov    0x92c,%eax
{
 ...
 749:	5b                   	pop    %ebx
  freep = p;
 74a:	89 15 2c 09 00 00    	mov    %edx,0x92c
}
 750:	5e                   	pop    %esi
 751:	5f                   	pop    %edi
 752:	5d                   	pop    %ebp
 ...
 787:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 78a:	89 15 2c 09 00 00    	mov    %edx,0x92c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7ac:	8b 15 2c 09 00 00    	mov    0x92c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7eb:	39 05 2c 09 00 00    	cmp    %eax,0x92c
 ...
 80e:	e8 ed fe ff ff       	call   700 <free>
  return freep;
 813:	8b 15 2c 09 00 00    	mov    0x92c,%edx
 ...
 83c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 83f:	89 15 2c 09 00 00    	mov    %edx,0x92c
}
 ...
 84f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 850:	c7 05 2c 09 00 00 30 	movl   $0x930,0x92c
 857:	09 00 00 
    base.s.size = 0;
 85a:	b8 30 09 00 00       	mov    $0x930,%eax
    base.s.ptr = freep = prevp = &base;
 85f:	c7 05 30 09 00 00 30 	movl   $0x930,0x930
 866:	09 00 00 
    base.s.size = 0;
 869:	c7 05 34 09 00 00 00 	movl   $0x0,0x934
 870:	00 00 00 
    if(p->s.size >= nunits){
