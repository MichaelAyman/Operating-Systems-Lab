...
int main(int argc, char *argv[]){
  ...
  10:	83 ec 0c             	sub    $0xc,%esp
	...
	//create child using fork
        int child_pid = fork();
  13:	e8 5c 03 00 00       	call   374 <fork>
        int pid;
        //Check pid to run parent code
        if(child_pid > 0) {
  18:	85 c0                	test   %eax,%eax
  1a:	7e 37                	jle    53 <main+0x53>
                pid = getpid();
  1c:	e8 db 03 00 00       	call   3fc <getpid>
		gid = getpgid(pid);
  ...
  25:	89 c3                	mov    %eax,%ebx
		gid = getpgid(pid);
  27:	e8 f8 03 00 00       	call   424 <getpgid>
                printf(2,"PARENT\nPID: %d\n",pid);
  ...
  32:	68 28 08 00 00       	push   $0x828
		...
		gid = getpgid(pid);
                printf(2,"CHILD\nPID: %d\n",pid);
  37:	6a 02                	push   $0x2
  39:	e8 c2 04 00 00       	call   500 <printf>
                printf(2,"PGID: %d\n",gid);
  3e:	83 c4 0c             	add    $0xc,%esp
  41:	56                   	push   %esi
  42:	68 38 08 00 00       	push   $0x838
  47:	6a 02                	push   $0x2
  49:	e8 b2 04 00 00       	call   500 <printf>
                exit();
  4e:	e8 29 03 00 00       	call   37c <exit>
                pid = getpid();
  53:	e8 a4 03 00 00       	call   3fc <getpid>
		setpgid(2);
  ...
  5d:	89 c3                	mov    %eax,%ebx
		setpgid(2);
  5f:	e8 c8 03 00 00       	call   42c <setpgid>
		gid = getpgid(pid);
  64:	89 1c 24             	mov    %ebx,(%esp)
  67:	e8 b8 03 00 00       	call   424 <getpgid>
                printf(2,"CHILD\nPID: %d\n",pid);
...
float sqrt(int num) {
 ...
 333:	d9 05 54 08 00 00    	flds   0x854
 ...
 34e:	dc ea                	fsubr  %st,%st(2)
    eps = eps / 10;
 350:	d8 35 58 08 00 00    	fdivs  0x858
  for (i = 0; i < 5; i++) {
 ...
 45c:	89 d1                	mov    %edx,%ecx
{
 ...
 4ce:	56                   	push   %esi
 4cf:	57                   	push   %edi
 4d0:	e8 c7 fe ff ff       	call   39c <write>
  while(--i >= 0)
 ...
 509:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 545:	57                   	push   %edi
 546:	56                   	push   %esi
 547:	e8 50 fe ff ff       	call   39c <write>
 ...
 59e:	e8 f9 fd ff ff       	call   39c <write>
        putc(fd, c);
 ...
 5af:	57                   	push   %edi
 5b0:	56                   	push   %esi
 5b1:	e8 e6 fd ff ff       	call   39c <write>
        putc(fd, c);
 ...
 61b:	57                   	push   %edi
 61c:	56                   	push   %esi
 61d:	e8 7a fd ff ff       	call   39c <write>
        while(*s != 0){
 ...
 65c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 65f:	e8 38 fd ff ff       	call   39c <write>
        ap++;
 ...
 687:	90                   	nop
          s = "(null)";
 688:	ba 5c 08 00 00       	mov    $0x85c,%edx
        while(*s != 0){
 ...
 6a1:	a1 98 0b 00 00       	mov    0xb98,%eax
{
 ...
 6e1:	5b                   	pop    %ebx
  freep = p;
 6e2:	89 15 98 0b 00 00    	mov    %edx,0xb98
}
 6e8:	5e                   	pop    %esi
 6e9:	5f                   	pop    %edi
 6ea:	5d                   	pop    %ebp
 ...
 719:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 71c:	89 15 98 0b 00 00    	mov    %edx,0xb98
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 739:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 73c:	8b 3d 98 0b 00 00    	mov    0xb98,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 77f:	73 4f                	jae    7d0 <malloc+0xa0>
    ...
    if(p == freep)
 781:	8b 3d 98 0b 00 00    	mov    0xb98,%edi
 ...
 793:	e8 6c fc ff ff       	call   404 <sbrk>
  if(p == (char*)-1)
 ...
 7aa:	e8 f1 fe ff ff       	call   6a0 <free>
  return freep;
 7af:	8b 15 98 0b 00 00    	mov    0xb98,%edx
 ...
 7ef:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7f0:	c7 05 98 0b 00 00 9c 	movl   $0xb9c,0xb98
 7f7:	0b 00 00 
    base.s.size = 0;
 7fa:	bf 9c 0b 00 00       	mov    $0xb9c,%edi
    base.s.ptr = freep = prevp = &base;
 7ff:	c7 05 9c 0b 00 00 9c 	movl   $0xb9c,0xb9c
 806:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 809:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 80b:	c7 05 a0 0b 00 00 00 	movl   $0x0,0xba0
 812:	00 00 00 
    if(p->s.size >= nunits){
