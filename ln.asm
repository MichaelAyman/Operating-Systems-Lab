   ...
   a:	83 39 03             	cmpl   $0x3,(%ecx)
{
  ...
  20:	e8 cb 04 00 00       	call   4f0 <printf>
    exit();
  25:	e8 32 03 00 00       	call   35c <exit>
  }
  ...
  32:	e8 85 03 00 00       	call   3bc <link>
  37:	83 c4 10             	add    $0x10,%esp
  3a:	85 c0                	test   %eax,%eax
  3c:	78 05                	js     43 <main+0x43>
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
  exit();
  3e:	e8 19 03 00 00       	call   35c <exit>
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
...
float sqrt(int num) {
 ...
 313:	d9 05 40 08 00 00    	flds   0x840
 ...
 32e:	dc ea                	fsubr  %st,%st(2)
    eps = eps / 10;
 330:	d8 35 44 08 00 00    	fdivs  0x844
  for (i = 0; i < 5; i++) {
 ...
 4f9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 569:	ff 24 85 50 08 00 00 	jmp    *0x850(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 677:	90                   	nop
          s = "(null)";
 678:	ba 48 08 00 00       	mov    $0x848,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 691:	a1 80 0b 00 00       	mov    0xb80,%eax
{
 ...
 6d1:	5b                   	pop    %ebx
  freep = p;
 6d2:	89 15 80 0b 00 00    	mov    %edx,0xb80
}
 6d8:	5e                   	pop    %esi
 6d9:	5f                   	pop    %edi
 6da:	5d                   	pop    %ebp
 ...
 709:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 70c:	89 15 80 0b 00 00    	mov    %edx,0xb80
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 729:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 72c:	8b 3d 80 0b 00 00    	mov    0xb80,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 76f:	73 4f                	jae    7c0 <malloc+0xa0>
    ...
    if(p == freep)
 771:	8b 3d 80 0b 00 00    	mov    0xb80,%edi
 ...
 79a:	e8 f1 fe ff ff       	call   690 <free>
  return freep;
 79f:	8b 15 80 0b 00 00    	mov    0xb80,%edx
 ...
 7cc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7cf:	89 15 80 0b 00 00    	mov    %edx,0xb80
}
 ...
 7df:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7e0:	c7 05 80 0b 00 00 84 	movl   $0xb84,0xb80
 7e7:	0b 00 00 
    base.s.size = 0;
 7ea:	bf 84 0b 00 00       	mov    $0xb84,%edi
    base.s.ptr = freep = prevp = &base;
 7ef:	c7 05 84 0b 00 00 84 	movl   $0xb84,0xb84
 7f6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7f9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7fb:	c7 05 88 0b 00 00 00 	movl   $0x0,0xb88
 802:	00 00 00 
    if(p->s.size >= nunits){
