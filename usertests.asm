...
00000120 <iputtest>:
{
  ...
  printf(stdout, "iput test\n");
     ...
     12b:	ff 35 c0 56 00 00    	push   0x56c0
  ...
  if(chdir("/") < 0){
    ...
    printf(stdout, "chdir / failed\n");
     187:	a1 c0 56 00 00       	mov    0x56c0,%eax
  if(chdir("/") < 0){
     18c:	85 d2                	test   %edx,%edx
     18e:	78 2a                	js     1ba <iputtest+0x9a>
  printf(stdout, "iput test ok\n");
     190:	83 ec 08             	sub    $0x8,%esp
     193:	68 74 3f 00 00       	push   $0x3f74
     198:	50                   	push   %eax
     199:	e8 a2 39 00 00       	call   3b40 <printf>
}
    ...
    printf(stdout, "mkdir failed\n");
     1a3:	50                   	push   %eax
     1a4:	50                   	push   %eax
     1a5:	68 a8 3e 00 00       	push   $0x3ea8
     1aa:	ff 35 c0 56 00 00    	push   0x56c0
     1b0:	e8 8b 39 00 00       	call   3b40 <printf>
    exit();
     1b5:	e8 dc 37 00 00       	call   3996 <exit>
    printf(stdout, "chdir / failed\n");
     1ba:	52                   	push   %edx
     1bb:	52                   	push   %edx
     1bc:	68 f3 3e 00 00       	push   $0x3ef3
     1c1:	50                   	push   %eax
     1c2:	e8 79 39 00 00       	call   3b40 <printf>
    exit();
     1c7:	e8 ca 37 00 00       	call   3996 <exit>
    printf(stdout, "unlink ../iputdir failed\n");
     1cc:	51                   	push   %ecx
     1cd:	51                   	push   %ecx
     1ce:	68 d7 3e 00 00       	push   $0x3ed7
     1d3:	ff 35 c0 56 00 00    	push   0x56c0
     1d9:	e8 62 39 00 00       	call   3b40 <printf>
    exit();
     1de:	e8 b3 37 00 00       	call   3996 <exit>
    printf(stdout, "chdir iputdir failed\n");
     1e3:	50                   	push   %eax
     1e4:	50                   	push   %eax
     1e5:	68 b6 3e 00 00       	push   $0x3eb6
     1ea:	ff 35 c0 56 00 00    	push   0x56c0
     1f0:	e8 4b 39 00 00       	call   3b40 <printf>
    exit();
     1f5:	e8 9c 37 00 00       	call   3996 <exit>
...
00000200 <exitiputtest>:
{
  ...
  printf(stdout, "exitiput test\n");
     ...
     20b:	ff 35 c0 56 00 00    	push   0x56c0
  ...
  printf(stdout, "exitiput test ok\n");
     ...
     285:	ff 35 c0 56 00 00    	push   0x56c0
     ...
     2a0:	ff 35 c0 56 00 00    	push   0x56c0
    ...
    printf(stdout, "fork failed\n");
     ...
     2b7:	ff 35 c0 56 00 00    	push   0x56c0
    ...
    exit();
     ...
     2ce:	ff 35 c0 56 00 00    	push   0x56c0
     ...
     2e5:	ff 35 c0 56 00 00    	push   0x56c0
...
00000300 <openiputtest>:
{
  ...
  printf(stdout, "openiput test\n");
     ...
     30b:	ff 35 c0 56 00 00    	push   0x56c0
  ...
  if(pid == 0){
    ...
    if(fd >= 0){
     ...
     351:	68 d0 4e 00 00       	push   $0x4ed0
     356:	ff 35 c0 56 00 00    	push   0x56c0
  ...
  printf(stdout, "openiput test ok\n");
     ...
     39a:	ff 35 c0 56 00 00    	push   0x56c0
    ...
    printf(stdout, "fork failed\n");
     ...
     3bc:	ff 35 c0 56 00 00    	push   0x56c0
    ...
    printf(stdout, "mkdir oidir failed\n");
     ...
     3d3:	ff 35 c0 56 00 00    	push   0x56c0
    ...
    printf(stdout, "unlink failed\n");
     ...
     3ea:	ff 35 c0 56 00 00    	push   0x56c0
...
00000400 <opentest>:
{
  ...
  printf(stdout, "open test\n");
     ...
     40b:	ff 35 c0 56 00 00    	push   0x56c0
  ...
  fd = open("doesnotexist", 0);
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
     447:	a1 c0 56 00 00       	mov    0x56c0,%eax
  if(fd >= 0){
     44c:	85 d2                	test   %edx,%edx
     44e:	79 2a                	jns    47a <opentest+0x7a>
  printf(stdout, "open test ok\n");
     450:	83 ec 08             	sub    $0x8,%esp
     453:	68 d0 3f 00 00       	push   $0x3fd0
     458:	50                   	push   %eax
     459:	e8 e2 36 00 00       	call   3b40 <printf>
}
    ...
    printf(stdout, "open echo failed!\n");
     463:	50                   	push   %eax
     464:	50                   	push   %eax
     465:	68 92 3f 00 00       	push   $0x3f92
     46a:	ff 35 c0 56 00 00    	push   0x56c0
     470:	e8 cb 36 00 00       	call   3b40 <printf>
    exit();
     475:	e8 1c 35 00 00       	call   3996 <exit>
    printf(stdout, "open doesnotexist succeeded!\n");
     47a:	52                   	push   %edx
     47b:	52                   	push   %edx
     47c:	68 b2 3f 00 00       	push   $0x3fb2
     481:	50                   	push   %eax
     482:	e8 b9 36 00 00       	call   3b40 <printf>
    exit();
     487:	e8 0a 35 00 00       	call   3996 <exit>
...
00000490 <writetest>:
{
  ...
  printf(stdout, "small file test\n");
     ...
     49d:	ff 35 c0 56 00 00    	push   0x56c0
  ...
  fd = open("small", O_CREATE|O_RDWR);
    ...
    printf(stdout, "creat small succeeded; ok\n");
     4be:	a1 c0 56 00 00       	mov    0x56c0,%eax
  if(fd >= 0){
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     4d0:	68 f5 3f 00 00       	push   $0x3ff5
     4d5:	50                   	push   %eax
  ...
  printf(stdout, "writes ok\n");
     ...
     528:	ff 35 c0 56 00 00    	push   0x56c0
  ...
  i = read(fd, buf, 2000);
    ...
    printf(stdout, "read succeeded ok\n");
     581:	a1 c0 56 00 00       	mov    0x56c0,%eax
  if(i == 2000){
     586:	81 fa d0 07 00 00    	cmp    $0x7d0,%edx
     58c:	0f 85 8c 00 00 00    	jne    61e <writetest+0x18e>
    printf(stdout, "read succeeded ok\n");
     592:	83 ec 08             	sub    $0x8,%esp
     595:	68 81 40 00 00       	push   $0x4081
     59a:	50                   	push   %eax
     59b:	e8 a0 35 00 00       	call   3b40 <printf>
  close(fd);
     5a0:	89 1c 24             	mov    %ebx,(%esp)
     5a3:	e8 16 34 00 00       	call   39be <close>
  if(unlink("small") < 0){
     5a8:	c7 04 24 ef 3f 00 00 	movl   $0x3fef,(%esp)
     5af:	e8 32 34 00 00       	call   39e6 <unlink>
     5b4:	83 c4 10             	add    $0x10,%esp
     5b7:	89 c2                	mov    %eax,%edx
    printf(stdout, "unlink small failed\n");
     5b9:	a1 c0 56 00 00       	mov    0x56c0,%eax
  if(unlink("small") < 0){
     5be:	85 d2                	test   %edx,%edx
     5c0:	78 6e                	js     630 <writetest+0x1a0>
  printf(stdout, "small file test ok\n");
     5c2:	83 ec 08             	sub    $0x8,%esp
     5c5:	68 a9 40 00 00       	push   $0x40a9
     5ca:	50                   	push   %eax
     5cb:	e8 70 35 00 00       	call   3b40 <printf>
}
     ...
     5dd:	53                   	push   %ebx
     5de:	68 f4 4e 00 00       	push   $0x4ef4
     5e3:	ff 35 c0 56 00 00    	push   0x56c0
     5e9:	e8 52 35 00 00       	call   3b40 <printf>
      exit();
     5ee:	e8 a3 33 00 00       	call   3996 <exit>
      printf(stdout, "error: write bb %d new file failed\n", i);
     5f3:	83 ec 04             	sub    $0x4,%esp
     5f6:	53                   	push   %ebx
     5f7:	68 18 4f 00 00       	push   $0x4f18
     5fc:	ff 35 c0 56 00 00    	push   0x56c0
     602:	e8 39 35 00 00       	call   3b40 <printf>
      exit();
     607:	e8 8a 33 00 00       	call   3996 <exit>
    printf(stdout, "error: open small failed!\n");
     60c:	53                   	push   %ebx
     60d:	53                   	push   %ebx
     60e:	68 66 40 00 00       	push   $0x4066
     613:	50                   	push   %eax
    ...
    printf(stdout, "read failed\n");
     ...
     625:	50                   	push   %eax
     626:	e8 15 35 00 00       	call   3b40 <printf>
    exit();
     62b:	e8 66 33 00 00       	call   3996 <exit>
    printf(stdout, "unlink small failed\n");
     630:	52                   	push   %edx
     631:	52                   	push   %edx
     632:	68 94 40 00 00       	push   $0x4094
     637:	50                   	push   %eax
     638:	e8 03 35 00 00       	call   3b40 <printf>
    exit();
     63d:	e8 54 33 00 00       	call   3996 <exit>
    printf(stdout, "error: creat small failed!\n");
     642:	52                   	push   %edx
     643:	52                   	push   %edx
     644:	68 10 40 00 00       	push   $0x4010
     649:	50                   	push   %eax
     64a:	e8 f1 34 00 00       	call   3b40 <printf>
    exit();
     64f:	e8 42 33 00 00       	call   3996 <exit>
...
00000660 <writetest1>:
{
  ...
  printf(stdout, "big files test\n");
     ...
     668:	68 bd 40 00 00       	push   $0x40bd
     66d:	ff 35 c0 56 00 00    	push   0x56c0
     673:	e8 c8 34 00 00       	call   3b40 <printf>
  fd = open("big", O_CREATE|O_RDWR);
     678:	58                   	pop    %eax
     679:	5a                   	pop    %edx
     67a:	68 02 02 00 00       	push   $0x202
     67f:	68 37 41 00 00       	push   $0x4137
     684:	e8 4d 33 00 00       	call   39d6 <open>
  if(fd < 0){
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    ((int*)buf)[0] = i;
     6a3:	89 1d 00 7e 00 00    	mov    %ebx,0x7e00
    if(write(fd, buf, 512) != 512){
     6a9:	68 00 02 00 00       	push   $0x200
     6ae:	68 00 7e 00 00       	push   $0x7e00
     6b3:	56                   	push   %esi
     6b4:	e8 fd 32 00 00       	call   39b6 <write>
  ...
  close(fd);
     ...
     6d5:	56                   	push   %esi
     6d6:	e8 e3 32 00 00       	call   39be <close>
  fd = open("big", O_RDONLY);
     6db:	5e                   	pop    %esi
     6dc:	58                   	pop    %eax
     6dd:	6a 00                	push   $0x0
     6df:	68 37 41 00 00       	push   $0x4137
     6e4:	e8 ed 32 00 00       	call   39d6 <open>
  if(fd < 0){
  ...
  n = 0;
    ...
    if(((int*)buf)[0] != n){
     70b:	a1 00 7e 00 00       	mov    0x7e00,%eax
    ...
    i = read(fd, buf, 512);
     ...
     723:	68 00 7e 00 00       	push   $0x7e00
     728:	53                   	push   %ebx
     729:	e8 80 32 00 00       	call   39ae <read>
    if(i == 0){
  ...
  close(fd);
     ...
     744:	53                   	push   %ebx
     745:	e8 74 32 00 00       	call   39be <close>
  if(unlink("big") < 0){
     74a:	c7 04 24 37 41 00 00 	movl   $0x4137,(%esp)
     751:	e8 90 32 00 00       	call   39e6 <unlink>
     756:	83 c4 10             	add    $0x10,%esp
     759:	89 c2                	mov    %eax,%edx
    printf(stdout, "unlink big failed\n");
     75b:	a1 c0 56 00 00       	mov    0x56c0,%eax
  if(unlink("big") < 0){
     760:	85 d2                	test   %edx,%edx
     762:	0f 88 aa 00 00 00    	js     812 <writetest1+0x1b2>
  printf(stdout, "big files ok\n");
     768:	83 ec 08             	sub    $0x8,%esp
     76b:	68 5e 41 00 00       	push   $0x415e
     770:	50                   	push   %eax
     771:	e8 ca 33 00 00       	call   3b40 <printf>
}
     ...
     783:	53                   	push   %ebx
     784:	68 e7 40 00 00       	push   $0x40e7
     789:	ff 35 c0 56 00 00    	push   0x56c0
     78f:	e8 ac 33 00 00       	call   3b40 <printf>
      exit();
     794:	e8 fd 31 00 00       	call   3996 <exit>
      printf(stdout, "read content of block %d is %d\n",
     799:	50                   	push   %eax
     79a:	56                   	push   %esi
     79b:	68 3c 4f 00 00       	push   $0x4f3c
     7a0:	ff 35 c0 56 00 00    	push   0x56c0
     7a6:	e8 95 33 00 00       	call   3b40 <printf>
      exit();
     7ab:	e8 e6 31 00 00       	call   3996 <exit>
      printf(stdout, "read failed %d\n", i);
     7b0:	83 ec 04             	sub    $0x4,%esp
     7b3:	50                   	push   %eax
     7b4:	68 3b 41 00 00       	push   $0x413b
     7b9:	ff 35 c0 56 00 00    	push   0x56c0
     7bf:	e8 7c 33 00 00       	call   3b40 <printf>
      exit();
     7c4:	e8 cd 31 00 00       	call   3996 <exit>
        printf(stdout, "read only %d blocks from big", n);
     7c9:	51                   	push   %ecx
     7ca:	68 8b 00 00 00       	push   $0x8b
     7cf:	68 1e 41 00 00       	push   $0x411e
     7d4:	ff 35 c0 56 00 00    	push   0x56c0
     7da:	e8 61 33 00 00       	call   3b40 <printf>
        exit();
     7df:	e8 b2 31 00 00       	call   3996 <exit>
    printf(stdout, "error: open big failed!\n");
     7e4:	53                   	push   %ebx
     7e5:	53                   	push   %ebx
     7e6:	68 05 41 00 00       	push   $0x4105
     7eb:	ff 35 c0 56 00 00    	push   0x56c0
     7f1:	e8 4a 33 00 00       	call   3b40 <printf>
    exit();
     7f6:	e8 9b 31 00 00       	call   3996 <exit>
    printf(stdout, "error: creat big failed!\n");
     7fb:	50                   	push   %eax
     7fc:	50                   	push   %eax
     7fd:	68 cd 40 00 00       	push   $0x40cd
     802:	ff 35 c0 56 00 00    	push   0x56c0
     808:	e8 33 33 00 00       	call   3b40 <printf>
    exit();
     80d:	e8 84 31 00 00       	call   3996 <exit>
    printf(stdout, "unlink big failed\n");
     812:	52                   	push   %edx
     813:	52                   	push   %edx
     814:	68 4b 41 00 00       	push   $0x414b
     819:	50                   	push   %eax
     81a:	e8 21 33 00 00       	call   3b40 <printf>
    exit();
     81f:	e8 72 31 00 00       	call   3996 <exit>
     ...
     834:	bb 30 00 00 00       	mov    $0x30,%ebx
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     83c:	68 5c 4f 00 00       	push   $0x4f5c
     841:	ff 35 c0 56 00 00    	push   0x56c0
     847:	e8 f4 32 00 00       	call   3b40 <printf>
  name[0] = 'a';
     84c:	c6 05 f0 7d 00 00 61 	movb   $0x61,0x7df0
  name[2] = '\0';
     853:	83 c4 10             	add    $0x10,%esp
     856:	c6 05 f2 7d 00 00 00 	movb   $0x0,0x7df2
  for(i = 0; i < 52; i++){
     85d:	8d 76 00             	lea    0x0(%esi),%esi
    fd = open(name, O_CREATE|O_RDWR);
     860:	83 ec 08             	sub    $0x8,%esp
    name[1] = '0' + i;
     863:	88 1d f1 7d 00 00    	mov    %bl,0x7df1
  for(i = 0; i < 52; i++){
     869:	83 c3 01             	add    $0x1,%ebx
    fd = open(name, O_CREATE|O_RDWR);
     86c:	68 02 02 00 00       	push   $0x202
     871:	68 f0 7d 00 00       	push   $0x7df0
     876:	e8 5b 31 00 00       	call   39d6 <open>
    close(fd);
     87b:	89 04 24             	mov    %eax,(%esp)
     87e:	e8 3b 31 00 00       	call   39be <close>
  for(i = 0; i < 52; i++){
     883:	83 c4 10             	add    $0x10,%esp
     886:	80 fb 64             	cmp    $0x64,%bl
     889:	75 d5                	jne    860 <createtest+0x30>
  name[0] = 'a';
     88b:	c6 05 f0 7d 00 00 61 	movb   $0x61,0x7df0
  name[2] = '\0';
     892:	bb 30 00 00 00       	mov    $0x30,%ebx
     897:	c6 05 f2 7d 00 00 00 	movb   $0x0,0x7df2
  for(i = 0; i < 52; i++){
     89e:	66 90                	xchg   %ax,%ax
    unlink(name);
     8a0:	83 ec 0c             	sub    $0xc,%esp
    name[1] = '0' + i;
     8a3:	88 1d f1 7d 00 00    	mov    %bl,0x7df1
  for(i = 0; i < 52; i++){
     8a9:	83 c3 01             	add    $0x1,%ebx
    unlink(name);
     8ac:	68 f0 7d 00 00       	push   $0x7df0
     8b1:	e8 30 31 00 00       	call   39e6 <unlink>
  for(i = 0; i < 52; i++){
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     8c1:	68 88 4f 00 00       	push   $0x4f88
     8c6:	ff 35 c0 56 00 00    	push   0x56c0
     8cc:	e8 6f 32 00 00       	call   3b40 <printf>
}
...
000008e0 <dirtest>:
{
  ...
  printf(stdout, "mkdir test\n");
     8e6:	68 6c 41 00 00       	push   $0x416c
     8eb:	ff 35 c0 56 00 00    	push   0x56c0
     8f1:	e8 4a 32 00 00       	call   3b40 <printf>
  if(mkdir("dir0") < 0){
     8f6:	c7 04 24 78 41 00 00 	movl   $0x4178,(%esp)
     8fd:	e8 fc 30 00 00       	call   39fe <mkdir>
     902:	83 c4 10             	add    $0x10,%esp
     905:	85 c0                	test   %eax,%eax
     907:	78 5a                	js     963 <dirtest+0x83>
  if(chdir("dir0") < 0){
     909:	83 ec 0c             	sub    $0xc,%esp
     90c:	68 78 41 00 00       	push   $0x4178
     911:	e8 f0 30 00 00       	call   3a06 <chdir>
     916:	83 c4 10             	add    $0x10,%esp
     919:	85 c0                	test   %eax,%eax
     91b:	0f 88 82 00 00 00    	js     9a3 <dirtest+0xc3>
  if(chdir("..") < 0){
     921:	83 ec 0c             	sub    $0xc,%esp
     924:	68 1d 47 00 00       	push   $0x471d
     929:	e8 d8 30 00 00       	call   3a06 <chdir>
     92e:	83 c4 10             	add    $0x10,%esp
     931:	85 c0                	test   %eax,%eax
     933:	78 57                	js     98c <dirtest+0xac>
  if(unlink("dir0") < 0){
     935:	83 ec 0c             	sub    $0xc,%esp
     938:	68 78 41 00 00       	push   $0x4178
     93d:	e8 a4 30 00 00       	call   39e6 <unlink>
     942:	83 c4 10             	add    $0x10,%esp
     945:	89 c2                	mov    %eax,%edx
    printf(stdout, "unlink dir0 failed\n");
     947:	a1 c0 56 00 00       	mov    0x56c0,%eax
  if(unlink("dir0") < 0){
     94c:	85 d2                	test   %edx,%edx
     94e:	78 2a                	js     97a <dirtest+0x9a>
  printf(stdout, "mkdir test ok\n");
     950:	83 ec 08             	sub    $0x8,%esp
     953:	68 b5 41 00 00       	push   $0x41b5
     958:	50                   	push   %eax
     959:	e8 e2 31 00 00       	call   3b40 <printf>
}
    ...
    printf(stdout, "mkdir failed\n");
     963:	50                   	push   %eax
     964:	50                   	push   %eax
     965:	68 a8 3e 00 00       	push   $0x3ea8
     96a:	ff 35 c0 56 00 00    	push   0x56c0
     970:	e8 cb 31 00 00       	call   3b40 <printf>
    exit();
     975:	e8 1c 30 00 00       	call   3996 <exit>
    printf(stdout, "unlink dir0 failed\n");
     97a:	52                   	push   %edx
     97b:	52                   	push   %edx
     97c:	68 a1 41 00 00       	push   $0x41a1
     981:	50                   	push   %eax
     982:	e8 b9 31 00 00       	call   3b40 <printf>
    exit();
     987:	e8 0a 30 00 00       	call   3996 <exit>
    printf(stdout, "chdir .. failed\n");
     98c:	51                   	push   %ecx
     98d:	51                   	push   %ecx
     98e:	68 90 41 00 00       	push   $0x4190
     993:	ff 35 c0 56 00 00    	push   0x56c0
     999:	e8 a2 31 00 00       	call   3b40 <printf>
    exit();
     99e:	e8 f3 2f 00 00       	call   3996 <exit>
    printf(stdout, "chdir dir0 failed\n");
     9a3:	50                   	push   %eax
     9a4:	50                   	push   %eax
     9a5:	68 7d 41 00 00       	push   $0x417d
     9aa:	ff 35 c0 56 00 00    	push   0x56c0
     9b0:	e8 8b 31 00 00       	call   3b40 <printf>
    exit();
     9b5:	e8 dc 2f 00 00       	call   3996 <exit>
...
000009c0 <exectest>:
{
  ...
  printf(stdout, "exec test\n");
     9c6:	68 c4 41 00 00       	push   $0x41c4
     9cb:	ff 35 c0 56 00 00    	push   0x56c0
     9d1:	e8 6a 31 00 00       	call   3b40 <printf>
  if(exec("echo", echoargv) < 0){
     9d6:	5a                   	pop    %edx
     9d7:	59                   	pop    %ecx
     9d8:	68 c4 56 00 00       	push   $0x56c4
     9dd:	68 8d 3f 00 00       	push   $0x3f8d
     9e2:	e8 e7 2f 00 00       	call   39ce <exec>
    ...
    printf(stdout, "exec echo failed\n");
     9f0:	50                   	push   %eax
     9f1:	50                   	push   %eax
     9f2:	68 cf 41 00 00       	push   $0x41cf
     9f7:	ff 35 c0 56 00 00    	push   0x56c0
     9fd:	e8 3e 31 00 00       	call   3b40 <printf>
    exit();
     a02:	e8 8f 2f 00 00       	call   3996 <exit>
     ...
     a15:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  ...
  seq = 0;
    ...
    close(fds[1]);
     a4d:	e8 6c 2f 00 00       	call   39be <close>
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a5f:	56                   	push   %esi
     a60:	68 00 7e 00 00       	push   $0x7e00
     a65:	ff 75 e0             	push   -0x20(%ebp)
     a68:	e8 41 2f 00 00       	call   39ae <read>
     ...
     a85:	38 90 00 7e 00 00    	cmp    %dl,0x7e00(%eax)
     ...
     aa8:	68 fe 41 00 00       	push   $0x41fe
     aad:	6a 01                	push   $0x1
     aaf:	e8 8c 30 00 00       	call   3b40 <printf>
  ...
  seq = 0;
    ...
    close(fds[0]);
     ac7:	e8 f2 2e 00 00       	call   39be <close>
     ...
     ae3:	83 c0 01             	add    $0x1,%eax
        buf[i] = seq++;
     ae6:	88 90 ff 7d 00 00    	mov    %dl,0x7dff(%eax)
      for(i = 0; i < 1033; i++)
     ...
     b01:	68 00 7e 00 00       	push   $0x7e00
     b06:	ff 75 e4             	push   -0x1c(%ebp)
     b09:	e8 a8 2e 00 00       	call   39b6 <write>
    ...
    exit();
     b20:	e8 71 2e 00 00       	call   3996 <exit>
    if(total != 5 * 1033){
    ...
    close(fds[0]);
     ...
     b34:	e8 85 2e 00 00       	call   39be <close>
    wait();
     b39:	e8 60 2e 00 00       	call   399e <wait>
  printf(1, "pipe1 ok\n");
     b3e:	5a                   	pop    %edx
     b3f:	59                   	pop    %ecx
     b40:	68 23 42 00 00       	push   $0x4223
     b45:	6a 01                	push   $0x1
     b47:	e8 f4 2f 00 00       	call   3b40 <printf>
     b4c:	83 c4 10             	add    $0x10,%esp
     b4f:	e9 63 ff ff ff       	jmp    ab7 <pipe1+0xa7>
      printf(1, "pipe1 oops 3 total %d\n", total);
     b54:	53                   	push   %ebx
     b55:	ff 75 d4             	push   -0x2c(%ebp)
     b58:	68 0c 42 00 00       	push   $0x420c
     b5d:	6a 01                	push   $0x1
     b5f:	e8 dc 2f 00 00       	call   3b40 <printf>
      exit();
     b64:	e8 2d 2e 00 00       	call   3996 <exit>
    printf(1, "pipe() failed\n");
     b69:	57                   	push   %edi
     b6a:	57                   	push   %edi
     b6b:	68 e1 41 00 00       	push   $0x41e1
     b70:	6a 01                	push   $0x1
     b72:	e8 c9 2f 00 00       	call   3b40 <printf>
    exit();
     b77:	e8 1a 2e 00 00       	call   3996 <exit>
    printf(1, "fork() failed\n");
     b7c:	50                   	push   %eax
     b7d:	50                   	push   %eax
     b7e:	68 2d 42 00 00       	push   $0x422d
     b83:	6a 01                	push   $0x1
     b85:	e8 b6 2f 00 00       	call   3b40 <printf>
    exit();
     b8a:	e8 07 2e 00 00       	call   3996 <exit>
        printf(1, "pipe1 oops 1\n");
     b8f:	56                   	push   %esi
     b90:	56                   	push   %esi
     b91:	68 f0 41 00 00       	push   $0x41f0
     b96:	6a 01                	push   $0x1
     b98:	e8 a3 2f 00 00       	call   3b40 <printf>
        exit();
     b9d:	e8 f4 2d 00 00       	call   3996 <exit>
...
00000bb0 <preempt>:
{
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
     ...
     c5b:	68 00 7e 00 00       	push   $0x7e00
  ...
  printf(1, "preempt ok\n");
    ...
    printf(1, "preempt read error");
     ...
     cda:	68 5a 42 00 00       	push   $0x425a
     cdf:	6a 01                	push   $0x1
     ...
     cee:	68 46 42 00 00       	push   $0x4246
     cf3:	6a 01                	push   $0x1
     cf5:	e8 46 2e 00 00       	call   3b40 <printf>
...
00000d90 <mem>:
{
  ...
  printf(1, "mem test\n");
     ...
     d9a:	68 a8 42 00 00       	push   $0x42a8
     d9f:	6a 01                	push   $0x1
     da1:	e8 9a 2d 00 00       	call   3b40 <printf>
  ppid = getpid();
  ...
  if((pid = fork()) == 0){
    ...
    while(m1){
     ...
     de5:	8b 36                	mov    (%esi),%esi
      free(m1);
     de7:	50                   	push   %eax
     de8:	e8 33 2f 00 00       	call   3d20 <free>
    while(m1){
    ...
    free(m1);
     ...
     e0b:	50                   	push   %eax
     e0c:	e8 0f 2f 00 00       	call   3d20 <free>
    printf(1, "mem ok\n");
     e11:	58                   	pop    %eax
     e12:	5a                   	pop    %edx
...
00000e60 <sharedfd>:
{
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     eec:	68 dc 4f 00 00       	push   $0x4fdc
     ef1:	6a 01                	push   $0x1
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     ...
     fca:	68 b0 4f 00 00       	push   $0x4fb0
     fcf:	6a 01                	push   $0x1
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     ...
     fe4:	68 fc 4f 00 00       	push   $0x4ffc
     fe9:	6a 01                	push   $0x1
    ...
    1026:	31 db                	xor    %ebx,%ebx
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    102b:	c7 45 d8 0e 43 00 00 	movl   $0x430e,-0x28(%ebp)
    1032:	c7 45 dc 57 44 00 00 	movl   $0x4457,-0x24(%ebp)
    1039:	c7 45 e0 5b 44 00 00 	movl   $0x445b,-0x20(%ebp)
    1040:	c7 45 e4 11 43 00 00 	movl   $0x4311,-0x1c(%ebp)
  printf(1, "fourfiles test\n");
    1047:	68 14 43 00 00       	push   $0x4314
    104c:	6a 01                	push   $0x1
    104e:	e8 ed 2a 00 00       	call   3b40 <printf>
    ...
    105d:	56                   	push   %esi
    105e:	e8 83 29 00 00       	call   39e6 <unlink>
    pid = fork();
    1063:	e8 26 29 00 00       	call   398e <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    1081:	e8 18 29 00 00       	call   399e <wait>
    1086:	e8 13 29 00 00       	call   399e <wait>
    108b:	e8 0e 29 00 00       	call   399e <wait>
    1090:	e8 09 29 00 00       	call   399e <wait>
  for(i = 0; i < 2; i++){
    ...
    10ae:	6a 00                	push   $0x0
    10b0:	50                   	push   %eax
    10b1:	e8 20 29 00 00       	call   39d6 <open>
        if(buf[j] != '0'+i){
    ...
    10c8:	68 00 7e 00 00       	push   $0x7e00
    10cd:	57                   	push   %edi
    10ce:	e8 db 28 00 00       	call   39ae <read>
    ...
    10dc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        if(buf[j] != '0'+i){
    10e0:	0f be 8a 00 7e 00 00 	movsbl 0x7e00(%edx),%ecx
    ...
    10f9:	57                   	push   %edi
    10fa:	e8 bf 28 00 00       	call   39be <close>
    if(total != 12*500){
    ...
    1114:	e8 cd 28 00 00       	call   39e6 <unlink>
  for(i = 0; i < 2; i++){
  ...
  printf(1, "fourfiles ok\n");
    ...
    1135:	68 52 43 00 00       	push   $0x4352
    113a:	6a 01                	push   $0x1
    113c:	e8 ff 29 00 00       	call   3b40 <printf>
}
    ...
    114f:	68 35 43 00 00       	push   $0x4335
    1154:	6a 01                	push   $0x1
    1156:	e8 e5 29 00 00       	call   3b40 <printf>
          exit();
    115b:	e8 36 28 00 00       	call   3996 <exit>
      fd = open(fname, O_CREATE | O_RDWR);
    1160:	83 ec 08             	sub    $0x8,%esp
    1163:	68 02 02 00 00       	push   $0x202
    1168:	56                   	push   %esi
    1169:	e8 68 28 00 00       	call   39d6 <open>
      if(fd < 0){
    ...
    1188:	68 00 7e 00 00       	push   $0x7e00
    ...
    119d:	68 00 7e 00 00       	push   $0x7e00
    11a2:	56                   	push   %esi
    11a3:	e8 0e 28 00 00       	call   39b6 <write>
    ...
    11b5:	75 de                	jne    1195 <fourfiles+0x175>
      exit();
    11b7:	e8 da 27 00 00       	call   3996 <exit>
        printf(1, "create failed\n");
    11bc:	51                   	push   %ecx
    11bd:	51                   	push   %ecx
    11be:	68 af 45 00 00       	push   $0x45af
    11c3:	6a 01                	push   $0x1
    11c5:	e8 76 29 00 00       	call   3b40 <printf>
        exit();
    11ca:	e8 c7 27 00 00       	call   3996 <exit>
    11cf:	90                   	nop
      printf(1, "fork failed\n");
    11d0:	83 ec 08             	sub    $0x8,%esp
    11d3:	68 e9 4d 00 00       	push   $0x4de9
    11d8:	6a 01                	push   $0x1
    11da:	e8 61 29 00 00       	call   3b40 <printf>
      exit();
    11df:	e8 b2 27 00 00       	call   3996 <exit>
      printf(1, "wrong length %d\n", total);
    11e4:	50                   	push   %eax
    11e5:	53                   	push   %ebx
    11e6:	68 41 43 00 00       	push   $0x4341
    11eb:	6a 01                	push   $0x1
    11ed:	e8 4e 29 00 00       	call   3b40 <printf>
      exit();
    11f2:	e8 9f 27 00 00       	call   3996 <exit>
          printf(1, "write failed %d\n", n);
    11f7:	52                   	push   %edx
    11f8:	50                   	push   %eax
    11f9:	68 24 43 00 00       	push   $0x4324
    11fe:	6a 01                	push   $0x1
    1200:	e8 3b 29 00 00       	call   3b40 <printf>
          exit();
    1205:	e8 8c 27 00 00       	call   3996 <exit>
    ...
    1215:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "createdelete test\n");
    121b:	68 60 43 00 00       	push   $0x4360
    1220:	6a 01                	push   $0x1
    1222:	e8 19 29 00 00       	call   3b40 <printf>
    1227:	83 c4 10             	add    $0x10,%esp
    pid = fork();
    122a:	e8 5f 27 00 00       	call   398e <fork>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    1247:	e8 52 27 00 00       	call   399e <wait>
  for(i = 0; i < N; i++){
    124c:	31 ff                	xor    %edi,%edi
    124e:	8d 75 c8             	lea    -0x38(%ebp),%esi
    wait();
    1251:	e8 48 27 00 00       	call   399e <wait>
    1256:	e8 43 27 00 00       	call   399e <wait>
    125b:	e8 3e 27 00 00       	call   399e <wait>
  ...
  for(i = 0; i < N; i++){
    ...
    1298:	6a 00                	push   $0x0
    129a:	56                   	push   %esi
    129b:	e8 36 27 00 00       	call   39d6 <open>
      if((i == 0 || i >= N/2) && fd < 0){
    ...
    12b8:	50                   	push   %eax
    12b9:	e8 00 27 00 00       	call   39be <close>
  ...
  for(i = 0; i < N; i++){
    ...
    12f7:	88 45 c9             	mov    %al,-0x37(%ebp)
      unlink(name);
    12fa:	56                   	push   %esi
    12fb:	e8 e6 26 00 00       	call   39e6 <unlink>
    for(pi = 0; pi < 4; pi++){
  ...
  printf(1, "createdelete ok\n");
    ...
    1314:	68 73 43 00 00       	push   $0x4373
    1319:	6a 01                	push   $0x1
    131b:	e8 20 28 00 00       	call   3b40 <printf>
}
    ...
    1334:	50                   	push   %eax
    1335:	56                   	push   %esi
    1336:	68 4c 50 00 00       	push   $0x504c
    133b:	6a 01                	push   $0x1
    133d:	e8 fe 27 00 00       	call   3b40 <printf>
        exit();
    1342:	e8 4f 26 00 00       	call   3996 <exit>
    ...
    136e:	56                   	push   %esi
    136f:	e8 62 26 00 00       	call   39d6 <open>
        if(fd < 0){
    ...
    1382:	50                   	push   %eax
    1383:	e8 36 26 00 00       	call   39be <close>
        if(i > 0 && (i % 2 ) == 0){
    ...
    139a:	75 c4                	jne    1360 <createdelete+0x150>
      exit();
    139c:	e8 f5 25 00 00       	call   3996 <exit>
    ...
    13b9:	88 45 c9             	mov    %al,-0x37(%ebp)
          if(unlink(name) < 0){
    13bc:	56                   	push   %esi
    13bd:	e8 24 26 00 00       	call   39e6 <unlink>
    ...
    13d1:	56                   	push   %esi
    13d2:	68 28 50 00 00       	push   $0x5028
    13d7:	6a 01                	push   $0x1
    13d9:	e8 62 27 00 00       	call   3b40 <printf>
        exit();
    13de:	e8 b3 25 00 00       	call   3996 <exit>
      printf(1, "fork failed\n");
    13e3:	83 ec 08             	sub    $0x8,%esp
    13e6:	68 e9 4d 00 00       	push   $0x4de9
    13eb:	6a 01                	push   $0x1
    13ed:	e8 4e 27 00 00       	call   3b40 <printf>
      exit();
    13f2:	e8 9f 25 00 00       	call   3996 <exit>
            printf(1, "unlink failed\n");
    13f7:	52                   	push   %edx
    13f8:	52                   	push   %edx
    13f9:	68 61 3f 00 00       	push   $0x3f61
    13fe:	6a 01                	push   $0x1
    1400:	e8 3b 27 00 00       	call   3b40 <printf>
            exit();
    1405:	e8 8c 25 00 00       	call   3996 <exit>
          printf(1, "create failed\n");
    140a:	83 ec 08             	sub    $0x8,%esp
    140d:	68 af 45 00 00       	push   $0x45af
    1412:	6a 01                	push   $0x1
    1414:	e8 27 27 00 00       	call   3b40 <printf>
          exit();
...
00001420 <unlinkread>:
{
  ...
  printf(1, "unlinkread test\n");
    ...
    1428:	68 84 43 00 00       	push   $0x4384
    142d:	6a 01                	push   $0x1
    142f:	e8 0c 27 00 00       	call   3b40 <printf>
  fd = open("unlinkread", O_CREATE | O_RDWR);
    1434:	5b                   	pop    %ebx
    1435:	5e                   	pop    %esi
    1436:	68 02 02 00 00       	push   $0x202
    143b:	68 95 43 00 00       	push   $0x4395
    1440:	e8 91 25 00 00       	call   39d6 <open>
  if(fd < 0){
  ...
  write(fd, "hello", 5);
    ...
    1455:	6a 05                	push   $0x5
    1457:	68 ba 43 00 00       	push   $0x43ba
    145c:	50                   	push   %eax
    145d:	e8 54 25 00 00       	call   39b6 <write>
  close(fd);
    1462:	89 1c 24             	mov    %ebx,(%esp)
    1465:	e8 54 25 00 00       	call   39be <close>
  fd = open("unlinkread", O_RDWR);
    146a:	58                   	pop    %eax
    146b:	5a                   	pop    %edx
    146c:	6a 02                	push   $0x2
    146e:	68 95 43 00 00       	push   $0x4395
    1473:	e8 5e 25 00 00       	call   39d6 <open>
  if(fd < 0){
  ...
  if(unlink("unlinkread") != 0){
    ...
    1488:	68 95 43 00 00       	push   $0x4395
    148d:	e8 54 25 00 00       	call   39e6 <unlink>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    14a5:	68 95 43 00 00       	push   $0x4395
    14aa:	e8 27 25 00 00       	call   39d6 <open>
  write(fd1, "yyy", 3);
  ...
  write(fd1, "yyy", 3);
    14b6:	68 f2 43 00 00       	push   $0x43f2
    14bb:	50                   	push   %eax
    14bc:	e8 f5 24 00 00       	call   39b6 <write>
  close(fd1);
    14c1:	89 34 24             	mov    %esi,(%esp)
    14c4:	e8 f5 24 00 00       	call   39be <close>
  if(read(fd, buf, sizeof(buf)) != 5){
    14c9:	83 c4 0c             	add    $0xc,%esp
    14cc:	68 00 20 00 00       	push   $0x2000
    14d1:	68 00 7e 00 00       	push   $0x7e00
    14d6:	53                   	push   %ebx
    14d7:	e8 d2 24 00 00       	call   39ae <read>
    14dc:	83 c4 10             	add    $0x10,%esp
    14df:	83 f8 05             	cmp    $0x5,%eax
    14e2:	0f 85 87 00 00 00    	jne    156f <unlinkread+0x14f>
  if(buf[0] != 'h'){
    14e8:	80 3d 00 7e 00 00 68 	cmpb   $0x68,0x7e00
    14ef:	75 6b                	jne    155c <unlinkread+0x13c>
  if(write(fd, buf, 10) != 10){
    14f1:	83 ec 04             	sub    $0x4,%esp
    14f4:	6a 0a                	push   $0xa
    14f6:	68 00 7e 00 00       	push   $0x7e00
    14fb:	53                   	push   %ebx
    14fc:	e8 b5 24 00 00       	call   39b6 <write>
  ...
  close(fd);
    ...
    150c:	53                   	push   %ebx
    150d:	e8 ac 24 00 00       	call   39be <close>
  unlink("unlinkread");
    1512:	c7 04 24 95 43 00 00 	movl   $0x4395,(%esp)
    1519:	e8 c8 24 00 00       	call   39e6 <unlink>
  printf(1, "unlinkread ok\n");
    151e:	58                   	pop    %eax
    151f:	5a                   	pop    %edx
    1520:	68 3d 44 00 00       	push   $0x443d
    1525:	6a 01                	push   $0x1
    1527:	e8 14 26 00 00       	call   3b40 <printf>
}
    ...
    1536:	51                   	push   %ecx
    1537:	51                   	push   %ecx
    1538:	68 a0 43 00 00       	push   $0x43a0
    153d:	6a 01                	push   $0x1
    153f:	e8 fc 25 00 00       	call   3b40 <printf>
    exit();
    1544:	e8 4d 24 00 00       	call   3996 <exit>
    printf(1, "unlinkread write failed\n");
    1549:	51                   	push   %ecx
    154a:	51                   	push   %ecx
    154b:	68 24 44 00 00       	push   $0x4424
    1550:	6a 01                	push   $0x1
    1552:	e8 e9 25 00 00       	call   3b40 <printf>
    exit();
    1557:	e8 3a 24 00 00       	call   3996 <exit>
    printf(1, "unlinkread wrong data\n");
    155c:	53                   	push   %ebx
    155d:	53                   	push   %ebx
    155e:	68 0d 44 00 00       	push   $0x440d
    1563:	6a 01                	push   $0x1
    1565:	e8 d6 25 00 00       	call   3b40 <printf>
    exit();
    156a:	e8 27 24 00 00       	call   3996 <exit>
    printf(1, "unlinkread read failed");
    156f:	56                   	push   %esi
    1570:	56                   	push   %esi
    1571:	68 f6 43 00 00       	push   $0x43f6
    1576:	6a 01                	push   $0x1
    1578:	e8 c3 25 00 00       	call   3b40 <printf>
    exit();
    157d:	e8 14 24 00 00       	call   3996 <exit>
    printf(1, "unlink unlinkread failed\n");
    1582:	50                   	push   %eax
    1583:	50                   	push   %eax
    1584:	68 d8 43 00 00       	push   $0x43d8
    1589:	6a 01                	push   $0x1
    158b:	e8 b0 25 00 00       	call   3b40 <printf>
    exit();
    1590:	e8 01 24 00 00       	call   3996 <exit>
    printf(1, "open unlinkread failed\n");
    1595:	50                   	push   %eax
    1596:	50                   	push   %eax
    1597:	68 c0 43 00 00       	push   $0x43c0
    159c:	6a 01                	push   $0x1
    159e:	e8 9d 25 00 00       	call   3b40 <printf>
    exit();
    15a3:	e8 ee 23 00 00       	call   3996 <exit>
...
000015b0 <linktest>:
{
  ...
  printf(1, "linktest\n");
    15b7:	68 4c 44 00 00       	push   $0x444c
    15bc:	6a 01                	push   $0x1
    15be:	e8 7d 25 00 00       	call   3b40 <printf>
  unlink("lf1");
    15c3:	c7 04 24 56 44 00 00 	movl   $0x4456,(%esp)
    15ca:	e8 17 24 00 00       	call   39e6 <unlink>
  unlink("lf2");
    15cf:	c7 04 24 5a 44 00 00 	movl   $0x445a,(%esp)
    15d6:	e8 0b 24 00 00       	call   39e6 <unlink>
  fd = open("lf1", O_CREATE|O_RDWR);
    15db:	58                   	pop    %eax
    15dc:	5a                   	pop    %edx
    15dd:	68 02 02 00 00       	push   $0x202
    15e2:	68 56 44 00 00       	push   $0x4456
    15e7:	e8 ea 23 00 00       	call   39d6 <open>
  if(fd < 0){
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    15fc:	6a 05                	push   $0x5
    15fe:	68 ba 43 00 00       	push   $0x43ba
    1603:	50                   	push   %eax
    1604:	e8 ad 23 00 00       	call   39b6 <write>
  ...
  close(fd);
    ...
    1618:	53                   	push   %ebx
    1619:	e8 a0 23 00 00       	call   39be <close>
  if(link("lf1", "lf2") < 0){
    161e:	5b                   	pop    %ebx
    161f:	58                   	pop    %eax
    1620:	68 5a 44 00 00       	push   $0x445a
    1625:	68 56 44 00 00       	push   $0x4456
    162a:	e8 c7 23 00 00       	call   39f6 <link>
    162f:	83 c4 10             	add    $0x10,%esp
    1632:	85 c0                	test   %eax,%eax
    1634:	0f 88 60 01 00 00    	js     179a <linktest+0x1ea>
  unlink("lf1");
    163a:	83 ec 0c             	sub    $0xc,%esp
    163d:	68 56 44 00 00       	push   $0x4456
    1642:	e8 9f 23 00 00       	call   39e6 <unlink>
  if(open("lf1", 0) >= 0){
    1647:	58                   	pop    %eax
    1648:	5a                   	pop    %edx
    1649:	6a 00                	push   $0x0
    164b:	68 56 44 00 00       	push   $0x4456
    1650:	e8 81 23 00 00       	call   39d6 <open>
  ...
  fd = open("lf2", 0);
    ...
    1663:	6a 00                	push   $0x0
    1665:	68 5a 44 00 00       	push   $0x445a
    166a:	e8 67 23 00 00       	call   39d6 <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1684:	68 00 7e 00 00       	push   $0x7e00
    1689:	50                   	push   %eax
    168a:	e8 1f 23 00 00       	call   39ae <read>
  ...
  close(fd);
    ...
    169e:	53                   	push   %ebx
    169f:	e8 1a 23 00 00       	call   39be <close>
  if(link("lf2", "lf2") >= 0){
    16a4:	58                   	pop    %eax
    16a5:	5a                   	pop    %edx
    16a6:	68 5a 44 00 00       	push   $0x445a
    16ab:	68 5a 44 00 00       	push   $0x445a
    16b0:	e8 41 23 00 00       	call   39f6 <link>
    16b5:	83 c4 10             	add    $0x10,%esp
    16b8:	85 c0                	test   %eax,%eax
    16ba:	0f 89 8e 00 00 00    	jns    174e <linktest+0x19e>
  unlink("lf2");
    16c0:	83 ec 0c             	sub    $0xc,%esp
    16c3:	68 5a 44 00 00       	push   $0x445a
    16c8:	e8 19 23 00 00       	call   39e6 <unlink>
  if(link("lf2", "lf1") >= 0){
    16cd:	59                   	pop    %ecx
    16ce:	5b                   	pop    %ebx
    16cf:	68 56 44 00 00       	push   $0x4456
    16d4:	68 5a 44 00 00       	push   $0x445a
    16d9:	e8 18 23 00 00       	call   39f6 <link>
    16de:	83 c4 10             	add    $0x10,%esp
    16e1:	85 c0                	test   %eax,%eax
    16e3:	79 56                	jns    173b <linktest+0x18b>
  if(link(".", "lf1") >= 0){
    16e5:	83 ec 08             	sub    $0x8,%esp
    16e8:	68 56 44 00 00       	push   $0x4456
    16ed:	68 1e 47 00 00       	push   $0x471e
    16f2:	e8 ff 22 00 00       	call   39f6 <link>
    16f7:	83 c4 10             	add    $0x10,%esp
    16fa:	85 c0                	test   %eax,%eax
    16fc:	79 2a                	jns    1728 <linktest+0x178>
  printf(1, "linktest ok\n");
    16fe:	83 ec 08             	sub    $0x8,%esp
    1701:	68 f4 44 00 00       	push   $0x44f4
    1706:	6a 01                	push   $0x1
    1708:	e8 33 24 00 00       	call   3b40 <printf>
}
    ...
    1715:	50                   	push   %eax
    1716:	50                   	push   %eax
    1717:	68 5e 44 00 00       	push   $0x445e
    171c:	6a 01                	push   $0x1
    171e:	e8 1d 24 00 00       	call   3b40 <printf>
    exit();
    1723:	e8 6e 22 00 00       	call   3996 <exit>
    printf(1, "link . lf1 succeeded! oops\n");
    1728:	50                   	push   %eax
    1729:	50                   	push   %eax
    172a:	68 d8 44 00 00       	push   $0x44d8
    172f:	6a 01                	push   $0x1
    1731:	e8 0a 24 00 00       	call   3b40 <printf>
    exit();
    1736:	e8 5b 22 00 00       	call   3996 <exit>
    printf(1, "link non-existant succeeded! oops\n");
    173b:	52                   	push   %edx
    173c:	52                   	push   %edx
    173d:	68 94 50 00 00       	push   $0x5094
    1742:	6a 01                	push   $0x1
    1744:	e8 f7 23 00 00       	call   3b40 <printf>
    exit();
    1749:	e8 48 22 00 00       	call   3996 <exit>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    174e:	50                   	push   %eax
    174f:	50                   	push   %eax
    1750:	68 ba 44 00 00       	push   $0x44ba
    1755:	6a 01                	push   $0x1
    1757:	e8 e4 23 00 00       	call   3b40 <printf>
    exit();
    175c:	e8 35 22 00 00       	call   3996 <exit>
    printf(1, "read lf2 failed\n");
    1761:	51                   	push   %ecx
    1762:	51                   	push   %ecx
    1763:	68 a9 44 00 00       	push   $0x44a9
    1768:	6a 01                	push   $0x1
    176a:	e8 d1 23 00 00       	call   3b40 <printf>
    exit();
    176f:	e8 22 22 00 00       	call   3996 <exit>
    printf(1, "open lf2 failed\n");
    1774:	53                   	push   %ebx
    1775:	53                   	push   %ebx
    1776:	68 98 44 00 00       	push   $0x4498
    177b:	6a 01                	push   $0x1
    177d:	e8 be 23 00 00       	call   3b40 <printf>
    exit();
    1782:	e8 0f 22 00 00       	call   3996 <exit>
    printf(1, "unlinked lf1 but it is still there!\n");
    1787:	50                   	push   %eax
    1788:	50                   	push   %eax
    1789:	68 6c 50 00 00       	push   $0x506c
    178e:	6a 01                	push   $0x1
    1790:	e8 ab 23 00 00       	call   3b40 <printf>
    exit();
    1795:	e8 fc 21 00 00       	call   3996 <exit>
    printf(1, "link lf1 lf2 failed\n");
    179a:	51                   	push   %ecx
    179b:	51                   	push   %ecx
    179c:	68 83 44 00 00       	push   $0x4483
    17a1:	6a 01                	push   $0x1
    17a3:	e8 98 23 00 00       	call   3b40 <printf>
    exit();
    17a8:	e8 e9 21 00 00       	call   3996 <exit>
    printf(1, "write lf1 failed\n");
    17ad:	50                   	push   %eax
    17ae:	50                   	push   %eax
    17af:	68 71 44 00 00       	push   $0x4471
    17b4:	6a 01                	push   $0x1
    17b6:	e8 85 23 00 00       	call   3b40 <printf>
    exit();
    17bb:	e8 d6 21 00 00       	call   3996 <exit>
    ...
    17c5:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "concreate test\n");
    17ce:	68 01 45 00 00       	push   $0x4501
    17d3:	6a 01                	push   $0x1
    17d5:	e8 66 23 00 00       	call   3b40 <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    1809:	53                   	push   %ebx
    180a:	e8 c7 21 00 00       	call   39d6 <open>
      if(fd < 0){
  ...
  for(i = 0; i < 40; i++){
    1819:	83 c6 01             	add    $0x1,%esi
      close(fd);
    181c:	50                   	push   %eax
    181d:	e8 9c 21 00 00       	call   39be <close>
    1822:	83 c4 10             	add    $0x10,%esp
      wait();
    1825:	e8 74 21 00 00       	call   399e <wait>
  for(i = 0; i < 40; i++){
    ...
    unlink(file);
    183c:	53                   	push   %ebx
    183d:	e8 a4 21 00 00       	call   39e6 <unlink>
    pid = fork();
    1842:	e8 47 21 00 00       	call   398e <fork>
    if(pid && (i % 3) == 1){
    ...
    1868:	53                   	push   %ebx
    1869:	e8 68 21 00 00       	call   39d6 <open>
      if(fd < 0){
    ...
    187c:	53                   	push   %ebx
    187d:	68 14 45 00 00       	push   $0x4514
    1882:	6a 01                	push   $0x1
    1884:	e8 b7 22 00 00       	call   3b40 <printf>
        exit();
    1889:	e8 08 21 00 00       	call   3996 <exit>
  ...
  for(i = 0; i < 40; i++){
    1893:	83 c6 01             	add    $0x1,%esi
      link("C0", file);
    1896:	53                   	push   %ebx
    1897:	68 11 45 00 00       	push   $0x4511
    189c:	e8 55 21 00 00       	call   39f6 <link>
    18a1:	83 c4 10             	add    $0x10,%esp
      wait();
    18a4:	e8 f5 20 00 00       	call   399e <wait>
  for(i = 0; i < 40; i++){
  ...
  fd = open(".", 0);
    ...
    18c3:	5f                   	pop    %edi
    18c4:	6a 00                	push   $0x0
    18c6:	68 1e 47 00 00       	push   $0x471e
    18cb:	8d 7d b0             	lea    -0x50(%ebp),%edi
    18ce:	e8 03 21 00 00       	call   39d6 <open>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    18e5:	57                   	push   %edi
    18e6:	56                   	push   %esi
    18e7:	e8 c2 20 00 00       	call   39ae <read>
    ...
    1933:	53                   	push   %ebx
    1934:	68 11 45 00 00       	push   $0x4511
    1939:	e8 b8 20 00 00       	call   39f6 <link>
    193e:	83 c4 10             	add    $0x10,%esp
      exit();
    1941:	e8 50 20 00 00       	call   3996 <exit>
  ...
  close(fd);
    ...
    1953:	56                   	push   %esi
    1954:	e8 65 20 00 00       	call   39be <close>
  if(n != 40){
  ...
  for(i = 0; i < 40; i++){
    ...
    197c:	53                   	push   %ebx
    197d:	e8 64 20 00 00       	call   39e6 <unlink>
      unlink(file);
    1982:	89 1c 24             	mov    %ebx,(%esp)
    1985:	e8 5c 20 00 00       	call   39e6 <unlink>
      unlink(file);
    198a:	89 1c 24             	mov    %ebx,(%esp)
    198d:	e8 54 20 00 00       	call   39e6 <unlink>
      unlink(file);
    1992:	89 1c 24             	mov    %ebx,(%esp)
    1995:	e8 4c 20 00 00       	call   39e6 <unlink>
    199a:	83 c4 10             	add    $0x10,%esp
    if(pid == 0)
    199d:	85 ff                	test   %edi,%edi
    199f:	74 a0                	je     1941 <concreate+0x181>
      wait();
    19a1:	e8 f8 1f 00 00       	call   399e <wait>
  for(i = 0; i < 40; i++){
    ...
    pid = fork();
    19b8:	e8 d1 1f 00 00       	call   398e <fork>
    ...
    19e4:	6a 00                	push   $0x0
    19e6:	53                   	push   %ebx
    19e7:	e8 ea 1f 00 00       	call   39d6 <open>
    19ec:	89 04 24             	mov    %eax,(%esp)
    19ef:	e8 ca 1f 00 00       	call   39be <close>
      close(open(file, 0));
    19f4:	58                   	pop    %eax
    19f5:	5a                   	pop    %edx
    19f6:	6a 00                	push   $0x0
    19f8:	53                   	push   %ebx
    19f9:	e8 d8 1f 00 00       	call   39d6 <open>
    19fe:	89 04 24             	mov    %eax,(%esp)
    1a01:	e8 b8 1f 00 00       	call   39be <close>
      close(open(file, 0));
    1a06:	59                   	pop    %ecx
    1a07:	58                   	pop    %eax
    1a08:	6a 00                	push   $0x0
  ...
  printf(1, "concreate ok\n");
    ...
    1a3b:	68 66 45 00 00       	push   $0x4566
    1a40:	6a 01                	push   $0x1
    1a42:	e8 f9 20 00 00       	call   3b40 <printf>
}
    ...
    1a52:	68 e9 4d 00 00       	push   $0x4de9
    1a57:	6a 01                	push   $0x1
    1a59:	e8 e2 20 00 00       	call   3b40 <printf>
      exit();
    1a5e:	e8 33 1f 00 00       	call   3996 <exit>
      close(fd);
    1a63:	83 ec 0c             	sub    $0xc,%esp
    1a66:	50                   	push   %eax
    1a67:	e8 52 1f 00 00       	call   39be <close>
    ...
    1a7a:	50                   	push   %eax
    1a7b:	68 30 45 00 00       	push   $0x4530
    1a80:	6a 01                	push   $0x1
    1a82:	e8 b9 20 00 00       	call   3b40 <printf>
        exit();
    1a87:	e8 0a 1f 00 00       	call   3996 <exit>
    printf(1, "concreate not enough files in directory listing\n");
    1a8c:	51                   	push   %ecx
    1a8d:	51                   	push   %ecx
    1a8e:	68 b8 50 00 00       	push   $0x50b8
    1a93:	6a 01                	push   $0x1
    1a95:	e8 a6 20 00 00       	call   3b40 <printf>
    exit();
    1a9a:	e8 f7 1e 00 00       	call   3996 <exit>
        printf(1, "concreate duplicate file %s\n", de.name);
    1a9f:	83 ec 04             	sub    $0x4,%esp
    1aa2:	8d 45 b2             	lea    -0x4e(%ebp),%eax
    1aa5:	50                   	push   %eax
    1aa6:	68 49 45 00 00       	push   $0x4549
    1aab:	6a 01                	push   $0x1
    1aad:	e8 8e 20 00 00       	call   3b40 <printf>
        exit();
    1ab2:	e8 df 1e 00 00       	call   3996 <exit>
...
00001ac0 <linkunlink>:
{
  ...
  printf(1, "linkunlink test\n");
    1ac9:	68 74 45 00 00       	push   $0x4574
    1ace:	6a 01                	push   $0x1
    1ad0:	e8 6b 20 00 00       	call   3b40 <printf>
  unlink("x");
    1ad5:	c7 04 24 01 48 00 00 	movl   $0x4801,(%esp)
    1adc:	e8 05 1f 00 00       	call   39e6 <unlink>
  pid = fork();
    1ae1:	e8 a8 1e 00 00       	call   398e <fork>
  if(pid < 0){
  ...
  for(i = 0; i < 100; i++){
    ...
    1b18:	68 01 48 00 00       	push   $0x4801
    1b1d:	e8 c4 1e 00 00       	call   39e6 <unlink>
  ...
  for(i = 0; i < 100; i++){
    ...
    1b51:	68 01 48 00 00       	push   $0x4801
    1b56:	e8 7b 1e 00 00       	call   39d6 <open>
    1b5b:	89 04 24             	mov    %eax,(%esp)
    1b5e:	e8 5b 1e 00 00       	call   39be <close>
  ...
  if(pid)
    ...
    wait();
    1b72:	e8 27 1e 00 00       	call   399e <wait>
  printf(1, "linkunlink ok\n");
    1b77:	83 ec 08             	sub    $0x8,%esp
    1b7a:	68 89 45 00 00       	push   $0x4589
    1b7f:	6a 01                	push   $0x1
    1b81:	e8 ba 1f 00 00       	call   3b40 <printf>
}
    ...
    1b93:	68 01 48 00 00       	push   $0x4801
    1b98:	68 85 45 00 00       	push   $0x4585
    1b9d:	e8 54 1e 00 00       	call   39f6 <link>
    1ba2:	83 c4 10             	add    $0x10,%esp
    1ba5:	e9 7b ff ff ff       	jmp    1b25 <linkunlink+0x65>
    printf(1, "fork failed\n");
    1baa:	52                   	push   %edx
    1bab:	52                   	push   %edx
    1bac:	68 e9 4d 00 00       	push   $0x4de9
    1bb1:	6a 01                	push   $0x1
    1bb3:	e8 88 1f 00 00       	call   3b40 <printf>
    exit();
    1bb8:	e8 d9 1d 00 00       	call   3996 <exit>
    exit();
    1bbd:	e8 d4 1d 00 00       	call   3996 <exit>
...
00001bd0 <bigdir>:
{
  ...
  printf(1, "bigdir test\n");
    1bd9:	68 98 45 00 00       	push   $0x4598
    1bde:	6a 01                	push   $0x1
    1be0:	e8 5b 1f 00 00       	call   3b40 <printf>
  unlink("bd");
    1be5:	c7 04 24 a5 45 00 00 	movl   $0x45a5,(%esp)
    1bec:	e8 f5 1d 00 00       	call   39e6 <unlink>
  fd = open("bd", O_CREATE);
    1bf1:	5a                   	pop    %edx
    1bf2:	59                   	pop    %ecx
    1bf3:	68 00 02 00 00       	push   $0x200
    1bf8:	68 a5 45 00 00       	push   $0x45a5
    1bfd:	e8 d4 1d 00 00       	call   39d6 <open>
  if(fd < 0){
  ...
  close(fd);
    1c15:	50                   	push   %eax
    1c16:	e8 a3 1d 00 00       	call   39be <close>
    ...
    if(link("bd", name) != 0){
    1c41:	57                   	push   %edi
    1c42:	68 a5 45 00 00       	push   $0x45a5
    1c47:	e8 aa 1d 00 00       	call   39f6 <link>
  ...
  unlink("bd");
    ...
    1c63:	68 a5 45 00 00       	push   $0x45a5
    1c68:	e8 79 1d 00 00       	call   39e6 <unlink>
    ...
    if(unlink(name) != 0){
    1c91:	57                   	push   %edi
    1c92:	e8 4f 1d 00 00       	call   39e6 <unlink>
  ...
  printf(1, "bigdir ok\n");
    ...
    1cac:	68 e7 45 00 00       	push   $0x45e7
    1cb1:	6a 01                	push   $0x1
    1cb3:	e8 88 1e 00 00       	call   3b40 <printf>
    ...
    1cc6:	68 be 45 00 00       	push   $0x45be
    1ccb:	6a 01                	push   $0x1
    1ccd:	e8 6e 1e 00 00       	call   3b40 <printf>
      exit();
    1cd2:	e8 bf 1c 00 00       	call   3996 <exit>
      printf(1, "bigdir unlink failed");
    1cd7:	83 ec 08             	sub    $0x8,%esp
    1cda:	68 d2 45 00 00       	push   $0x45d2
    1cdf:	6a 01                	push   $0x1
    1ce1:	e8 5a 1e 00 00       	call   3b40 <printf>
      exit();
    1ce6:	e8 ab 1c 00 00       	call   3996 <exit>
    printf(1, "bigdir create failed\n");
    1ceb:	50                   	push   %eax
    1cec:	50                   	push   %eax
    1ced:	68 a8 45 00 00       	push   $0x45a8
    1cf2:	6a 01                	push   $0x1
    1cf4:	e8 47 1e 00 00       	call   3b40 <printf>
    exit();
    1cf9:	e8 98 1c 00 00       	call   3996 <exit>
...
00001d00 <subdir>:
{
  ...
  printf(1, "subdir test\n");
    1d07:	68 f2 45 00 00       	push   $0x45f2
    1d0c:	6a 01                	push   $0x1
    1d0e:	e8 2d 1e 00 00       	call   3b40 <printf>
  unlink("ff");
    1d13:	c7 04 24 7b 46 00 00 	movl   $0x467b,(%esp)
    1d1a:	e8 c7 1c 00 00       	call   39e6 <unlink>
  if(mkdir("dd") != 0){
    1d1f:	c7 04 24 18 47 00 00 	movl   $0x4718,(%esp)
    1d26:	e8 d3 1c 00 00       	call   39fe <mkdir>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d3e:	68 51 46 00 00       	push   $0x4651
    1d43:	e8 8e 1c 00 00       	call   39d6 <open>
  if(fd < 0){
  ...
  write(fd, "ff", 2);
    ...
    1d58:	6a 02                	push   $0x2
    1d5a:	68 7b 46 00 00       	push   $0x467b
    1d5f:	50                   	push   %eax
    1d60:	e8 51 1c 00 00       	call   39b6 <write>
  close(fd);
    1d65:	89 1c 24             	mov    %ebx,(%esp)
    1d68:	e8 51 1c 00 00       	call   39be <close>
  if(unlink("dd") >= 0){
    1d6d:	c7 04 24 18 47 00 00 	movl   $0x4718,(%esp)
    1d74:	e8 6d 1c 00 00       	call   39e6 <unlink>
    1d79:	83 c4 10             	add    $0x10,%esp
    1d7c:	85 c0                	test   %eax,%eax
    1d7e:	0f 89 3f 05 00 00    	jns    22c3 <subdir+0x5c3>
  if(mkdir("/dd/dd") != 0){
    1d84:	83 ec 0c             	sub    $0xc,%esp
    1d87:	68 2c 46 00 00       	push   $0x462c
    1d8c:	e8 6d 1c 00 00       	call   39fe <mkdir>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1da4:	68 4e 46 00 00       	push   $0x464e
    1da9:	e8 28 1c 00 00       	call   39d6 <open>
  if(fd < 0){
  ...
  write(fd, "FF", 2);
    ...
    1dbe:	6a 02                	push   $0x2
    1dc0:	68 6f 46 00 00       	push   $0x466f
    1dc5:	50                   	push   %eax
    1dc6:	e8 eb 1b 00 00       	call   39b6 <write>
  close(fd);
    1dcb:	89 1c 24             	mov    %ebx,(%esp)
    1dce:	e8 eb 1b 00 00       	call   39be <close>
  fd = open("dd/dd/../ff", 0);
    1dd3:	58                   	pop    %eax
    1dd4:	5a                   	pop    %edx
    1dd5:	6a 00                	push   $0x0
    1dd7:	68 72 46 00 00       	push   $0x4672
    1ddc:	e8 f5 1b 00 00       	call   39d6 <open>
  if(fd < 0){
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1df6:	68 00 7e 00 00       	push   $0x7e00
    1dfb:	50                   	push   %eax
    1dfc:	e8 ad 1b 00 00       	call   39ae <read>
  if(cc != 2 || buf[0] != 'f'){
    1e01:	83 c4 10             	add    $0x10,%esp
    1e04:	83 f8 02             	cmp    $0x2,%eax
    1e07:	0f 85 3a 03 00 00    	jne    2147 <subdir+0x447>
    1e0d:	80 3d 00 7e 00 00 66 	cmpb   $0x66,0x7e00
    1e14:	0f 85 2d 03 00 00    	jne    2147 <subdir+0x447>
  close(fd);
    1e1a:	83 ec 0c             	sub    $0xc,%esp
    1e1d:	53                   	push   %ebx
    1e1e:	e8 9b 1b 00 00       	call   39be <close>
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    1e23:	59                   	pop    %ecx
    1e24:	5b                   	pop    %ebx
    1e25:	68 b2 46 00 00       	push   $0x46b2
    1e2a:	68 4e 46 00 00       	push   $0x464e
    1e2f:	e8 c2 1b 00 00       	call   39f6 <link>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    1e42:	68 4e 46 00 00       	push   $0x464e
    1e47:	e8 9a 1b 00 00       	call   39e6 <unlink>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1ed4:	6a 00                	push   $0x0
    1ed6:	68 b2 46 00 00       	push   $0x46b2
    1edb:	e8 f6 1a 00 00       	call   39d6 <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    1ef5:	68 00 7e 00 00       	push   $0x7e00
    1efa:	50                   	push   %eax
    1efb:	e8 ae 1a 00 00       	call   39ae <read>
  ...
  close(fd);
    ...
    1f0f:	53                   	push   %ebx
    1f10:	e8 a9 1a 00 00       	call   39be <close>
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    1f15:	58                   	pop    %eax
    1f16:	5a                   	pop    %edx
    1f17:	6a 00                	push   $0x0
    1f19:	68 4e 46 00 00       	push   $0x464e
    1f1e:	e8 b3 1a 00 00       	call   39d6 <open>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f36:	68 66 47 00 00       	push   $0x4766
    1f3b:	e8 96 1a 00 00       	call   39d6 <open>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f53:	68 8b 47 00 00       	push   $0x478b
    1f58:	e8 79 1a 00 00       	call   39d6 <open>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    1f70:	68 18 47 00 00       	push   $0x4718
    1f75:	e8 5c 1a 00 00       	call   39d6 <open>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    1f88:	6a 02                	push   $0x2
    1f8a:	68 18 47 00 00       	push   $0x4718
    1f8f:	e8 42 1a 00 00       	call   39d6 <open>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    1fa2:	6a 01                	push   $0x1
    1fa4:	68 18 47 00 00       	push   $0x4718
    1fa9:	e8 28 1a 00 00       	call   39d6 <open>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    1fbc:	68 fa 47 00 00       	push   $0x47fa
    1fc1:	68 66 47 00 00       	push   $0x4766
    1fc6:	e8 2b 1a 00 00       	call   39f6 <link>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    1fd9:	68 fa 47 00 00       	push   $0x47fa
    1fde:	68 8b 47 00 00       	push   $0x478b
    1fe3:	e8 0e 1a 00 00       	call   39f6 <link>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    2043:	68 b2 46 00 00       	push   $0x46b2
    2048:	e8 b1 19 00 00       	call   39fe <mkdir>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    205b:	68 8b 47 00 00       	push   $0x478b
    2060:	e8 81 19 00 00       	call   39e6 <unlink>
  ...
  printf(1, "subdir ok\n");
    ...
    2147:	50                   	push   %eax
    2148:	50                   	push   %eax
    2149:	68 97 46 00 00       	push   $0x4697
    214e:	6a 01                	push   $0x1
    2150:	e8 eb 19 00 00       	call   3b40 <printf>
    exit();
    2155:	e8 3c 18 00 00       	call   3996 <exit>
    printf(1, "chdir dd/../../dd failed\n");
    215a:	50                   	push   %eax
    215b:	50                   	push   %eax
    215c:	68 f2 46 00 00       	push   $0x46f2
    2161:	6a 01                	push   $0x1
    2163:	e8 d8 19 00 00       	call   3b40 <printf>
    exit();
    2168:	e8 29 18 00 00       	call   3996 <exit>
    printf(1, "unlink dd/dd/ff failed\n");
    216d:	50                   	push   %eax
    216e:	50                   	push   %eax
    216f:	68 bd 46 00 00       	push   $0x46bd
    2174:	6a 01                	push   $0x1
    2176:	e8 c5 19 00 00       	call   3b40 <printf>
    exit();
    217b:	e8 16 18 00 00       	call   3996 <exit>
    printf(1, "create dd/ff/ff succeeded!\n");
    2180:	51                   	push   %ecx
    2181:	51                   	push   %ecx
    2182:	68 6f 47 00 00       	push   $0x476f
    2187:	6a 01                	push   $0x1
    2189:	e8 b2 19 00 00       	call   3b40 <printf>
    exit();
    218e:	e8 03 18 00 00       	call   3996 <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded!\n");
    2193:	53                   	push   %ebx
    2194:	53                   	push   %ebx
    2195:	68 5c 51 00 00       	push   $0x515c
    219a:	6a 01                	push   $0x1
    219c:	e8 9f 19 00 00       	call   3b40 <printf>
    exit();
    21a1:	e8 f0 17 00 00       	call   3996 <exit>
    printf(1, "mkdir dd/ff/ff succeeded!\n");
    21a6:	51                   	push   %ecx
    21a7:	51                   	push   %ecx
    21a8:	68 03 48 00 00       	push   $0x4803
    21ad:	6a 01                	push   $0x1
    21af:	e8 8c 19 00 00       	call   3b40 <printf>
    exit();
    21b4:	e8 dd 17 00 00       	call   3996 <exit>
    printf(1, "link dd/ff dd/dd/ffff succeeded!\n");
    21b9:	53                   	push   %ebx
    21ba:	53                   	push   %ebx
    21bb:	68 cc 51 00 00       	push   $0x51cc
    21c0:	6a 01                	push   $0x1
    21c2:	e8 79 19 00 00       	call   3b40 <printf>
    exit();
    21c7:	e8 ca 17 00 00       	call   3996 <exit>
    printf(1, "open dd/dd/../ff failed\n");
    21cc:	50                   	push   %eax
    21cd:	50                   	push   %eax
    21ce:	68 7e 46 00 00       	push   $0x467e
    21d3:	6a 01                	push   $0x1
    21d5:	e8 66 19 00 00       	call   3b40 <printf>
    exit();
    21da:	e8 b7 17 00 00       	call   3996 <exit>
    printf(1, "create dd/dd/ff failed\n");
    21df:	51                   	push   %ecx
    21e0:	51                   	push   %ecx
    21e1:	68 57 46 00 00       	push   $0x4657
    21e6:	6a 01                	push   $0x1
    21e8:	e8 53 19 00 00       	call   3b40 <printf>
    exit();
    21ed:	e8 a4 17 00 00       	call   3996 <exit>
    printf(1, "chdir ./.. failed\n");
    21f2:	50                   	push   %eax
    21f3:	50                   	push   %eax
    21f4:	68 20 47 00 00       	push   $0x4720
    21f9:	6a 01                	push   $0x1
    21fb:	e8 40 19 00 00       	call   3b40 <printf>
    exit();
    2200:	e8 91 17 00 00       	call   3996 <exit>
    printf(1, "link dd/dd/ff dd/dd/ffff failed\n");
    2205:	52                   	push   %edx
    2206:	52                   	push   %edx
    2207:	68 14 51 00 00       	push   $0x5114
    220c:	6a 01                	push   $0x1
    220e:	e8 2d 19 00 00       	call   3b40 <printf>
    exit();
    2213:	e8 7e 17 00 00       	call   3996 <exit>
    printf(1, "link dd/xx/ff dd/dd/xx succeeded!\n");
    2218:	50                   	push   %eax
    2219:	50                   	push   %eax
    221a:	68 a8 51 00 00       	push   $0x51a8
    221f:	6a 01                	push   $0x1
    2221:	e8 1a 19 00 00       	call   3b40 <printf>
    exit();
    2226:	e8 6b 17 00 00       	call   3996 <exit>
    printf(1, "link dd/ff/ff dd/dd/xx succeeded!\n");
    222b:	50                   	push   %eax
    222c:	50                   	push   %eax
    222d:	68 84 51 00 00       	push   $0x5184
    2232:	6a 01                	push   $0x1
    2234:	e8 07 19 00 00       	call   3b40 <printf>
    exit();
    2239:	e8 58 17 00 00       	call   3996 <exit>
    printf(1, "open dd wronly succeeded!\n");
    223e:	50                   	push   %eax
    223f:	50                   	push   %eax
    2240:	68 df 47 00 00       	push   $0x47df
    2245:	6a 01                	push   $0x1
    2247:	e8 f4 18 00 00       	call   3b40 <printf>
    exit();
    224c:	e8 45 17 00 00       	call   3996 <exit>
    printf(1, "open dd rdwr succeeded!\n");
    2251:	50                   	push   %eax
    2252:	50                   	push   %eax
    2253:	68 c6 47 00 00       	push   $0x47c6
    2258:	6a 01                	push   $0x1
    225a:	e8 e1 18 00 00       	call   3b40 <printf>
    exit();
    225f:	e8 32 17 00 00       	call   3996 <exit>
    printf(1, "create dd succeeded!\n");
    2264:	50                   	push   %eax
    2265:	50                   	push   %eax
    2266:	68 b0 47 00 00       	push   $0x47b0
    226b:	6a 01                	push   $0x1
    226d:	e8 ce 18 00 00       	call   3b40 <printf>
    exit();
    2272:	e8 1f 17 00 00       	call   3996 <exit>
    printf(1, "create dd/xx/ff succeeded!\n");
    2277:	52                   	push   %edx
    2278:	52                   	push   %edx
    2279:	68 94 47 00 00       	push   $0x4794
    227e:	6a 01                	push   $0x1
    2280:	e8 bb 18 00 00       	call   3b40 <printf>
    exit();
    2285:	e8 0c 17 00 00       	call   3996 <exit>
    printf(1, "chdir dd failed\n");
    228a:	50                   	push   %eax
    228b:	50                   	push   %eax
    228c:	68 d5 46 00 00       	push   $0x46d5
    2291:	6a 01                	push   $0x1
    2293:	e8 a8 18 00 00       	call   3b40 <printf>
    exit();
    2298:	e8 f9 16 00 00       	call   3996 <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded\n");
    229d:	50                   	push   %eax
    229e:	50                   	push   %eax
    229f:	68 38 51 00 00       	push   $0x5138
    22a4:	6a 01                	push   $0x1
    22a6:	e8 95 18 00 00       	call   3b40 <printf>
    exit();
    22ab:	e8 e6 16 00 00       	call   3996 <exit>
    printf(1, "subdir mkdir dd/dd failed\n");
    22b0:	53                   	push   %ebx
    22b1:	53                   	push   %ebx
    22b2:	68 33 46 00 00       	push   $0x4633
    22b7:	6a 01                	push   $0x1
    22b9:	e8 82 18 00 00       	call   3b40 <printf>
    exit();
    22be:	e8 d3 16 00 00       	call   3996 <exit>
    printf(1, "unlink dd (non-empty dir) succeeded!\n");
    22c3:	50                   	push   %eax
    22c4:	50                   	push   %eax
    22c5:	68 ec 50 00 00       	push   $0x50ec
    22ca:	6a 01                	push   $0x1
    22cc:	e8 6f 18 00 00       	call   3b40 <printf>
    exit();
    22d1:	e8 c0 16 00 00       	call   3996 <exit>
    printf(1, "create dd/ff failed\n");
    22d6:	50                   	push   %eax
    22d7:	50                   	push   %eax
    22d8:	68 17 46 00 00       	push   $0x4617
    22dd:	6a 01                	push   $0x1
    22df:	e8 5c 18 00 00       	call   3b40 <printf>
    exit();
    22e4:	e8 ad 16 00 00       	call   3996 <exit>
    printf(1, "subdir mkdir dd failed\n");
    22e9:	50                   	push   %eax
    22ea:	50                   	push   %eax
    22eb:	68 ff 45 00 00       	push   $0x45ff
    22f0:	6a 01                	push   $0x1
    22f2:	e8 49 18 00 00       	call   3b40 <printf>
    exit();
    22f7:	e8 9a 16 00 00       	call   3996 <exit>
    printf(1, "unlink dd failed\n");
    22fc:	50                   	push   %eax
    22fd:	50                   	push   %eax
    22fe:	68 e8 48 00 00       	push   $0x48e8
    2303:	6a 01                	push   $0x1
    2305:	e8 36 18 00 00       	call   3b40 <printf>
    exit();
    230a:	e8 87 16 00 00       	call   3996 <exit>
    printf(1, "unlink dd/dd failed\n");
    230f:	52                   	push   %edx
    2310:	52                   	push   %edx
    2311:	68 d3 48 00 00       	push   $0x48d3
    2316:	6a 01                	push   $0x1
    2318:	e8 23 18 00 00       	call   3b40 <printf>
    exit();
    231d:	e8 74 16 00 00       	call   3996 <exit>
    printf(1, "unlink non-empty dd succeeded!\n");
    2322:	51                   	push   %ecx
    2323:	51                   	push   %ecx
    2324:	68 f0 51 00 00       	push   $0x51f0
    2329:	6a 01                	push   $0x1
    232b:	e8 10 18 00 00       	call   3b40 <printf>
    exit();
    2330:	e8 61 16 00 00       	call   3996 <exit>
    printf(1, "unlink dd/ff failed\n");
    2335:	53                   	push   %ebx
    2336:	53                   	push   %ebx
    2337:	68 be 48 00 00       	push   $0x48be
    233c:	6a 01                	push   $0x1
    233e:	e8 fd 17 00 00       	call   3b40 <printf>
    exit();
    2343:	e8 4e 16 00 00       	call   3996 <exit>
    printf(1, "chdir dd/xx succeeded!\n");
    2348:	50                   	push   %eax
    2349:	50                   	push   %eax
    234a:	68 a6 48 00 00       	push   $0x48a6
    234f:	6a 01                	push   $0x1
    2351:	e8 ea 17 00 00       	call   3b40 <printf>
    exit();
    2356:	e8 3b 16 00 00       	call   3996 <exit>
    printf(1, "chdir dd/ff succeeded!\n");
    235b:	50                   	push   %eax
    235c:	50                   	push   %eax
    235d:	68 8e 48 00 00       	push   $0x488e
    2362:	6a 01                	push   $0x1
    2364:	e8 d7 17 00 00       	call   3b40 <printf>
    exit();
    2369:	e8 28 16 00 00       	call   3996 <exit>
    printf(1, "unlink dd/ff/ff succeeded!\n");
    236e:	50                   	push   %eax
    236f:	50                   	push   %eax
    2370:	68 72 48 00 00       	push   $0x4872
    2375:	6a 01                	push   $0x1
    2377:	e8 c4 17 00 00       	call   3b40 <printf>
    exit();
    237c:	e8 15 16 00 00       	call   3996 <exit>
    printf(1, "unlink dd/xx/ff succeeded!\n");
    2381:	50                   	push   %eax
    2382:	50                   	push   %eax
    2383:	68 56 48 00 00       	push   $0x4856
    2388:	6a 01                	push   $0x1
    238a:	e8 b1 17 00 00       	call   3b40 <printf>
    exit();
    238f:	e8 02 16 00 00       	call   3996 <exit>
    printf(1, "mkdir dd/dd/ffff succeeded!\n");
    2394:	50                   	push   %eax
    2395:	50                   	push   %eax
    2396:	68 39 48 00 00       	push   $0x4839
    239b:	6a 01                	push   $0x1
    239d:	e8 9e 17 00 00       	call   3b40 <printf>
    exit();
    23a2:	e8 ef 15 00 00       	call   3996 <exit>
    printf(1, "mkdir dd/xx/ff succeeded!\n");
    23a7:	52                   	push   %edx
    23a8:	52                   	push   %edx
    23a9:	68 1e 48 00 00       	push   $0x481e
    23ae:	6a 01                	push   $0x1
    23b0:	e8 8b 17 00 00       	call   3b40 <printf>
    exit();
    23b5:	e8 dc 15 00 00       	call   3996 <exit>
    printf(1, "read dd/dd/ffff wrong len\n");
    23ba:	51                   	push   %ecx
    23bb:	51                   	push   %ecx
    23bc:	68 4b 47 00 00       	push   $0x474b
    23c1:	6a 01                	push   $0x1
    23c3:	e8 78 17 00 00       	call   3b40 <printf>
    exit();
    23c8:	e8 c9 15 00 00       	call   3996 <exit>
    printf(1, "open dd/dd/ffff failed\n");
    23cd:	53                   	push   %ebx
    23ce:	53                   	push   %ebx
    23cf:	68 33 47 00 00       	push   $0x4733
    23d4:	6a 01                	push   $0x1
    23d6:	e8 65 17 00 00       	call   3b40 <printf>
    exit();
    23db:	e8 b6 15 00 00       	call   3996 <exit>
...
000023e0 <bigwrite>:
{
  ...
  printf(1, "bigwrite test\n");
    ...
    23ed:	68 05 49 00 00       	push   $0x4905
    23f2:	6a 01                	push   $0x1
    23f4:	e8 47 17 00 00       	call   3b40 <printf>
  unlink("bigwrite");
    23f9:	c7 04 24 14 49 00 00 	movl   $0x4914,(%esp)
    2400:	e8 e1 15 00 00       	call   39e6 <unlink>
    ...
    2418:	68 14 49 00 00       	push   $0x4914
    241d:	e8 b4 15 00 00       	call   39d6 <open>
    if(fd < 0){
    ...
    242e:	53                   	push   %ebx
    242f:	68 00 7e 00 00       	push   $0x7e00
    2434:	50                   	push   %eax
    2435:	e8 7c 15 00 00       	call   39b6 <write>
      if(cc != sz){
    ...
    2444:	53                   	push   %ebx
    2445:	68 00 7e 00 00       	push   $0x7e00
    244a:	56                   	push   %esi
    244b:	e8 66 15 00 00       	call   39b6 <write>
      if(cc != sz){
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    close(fd);
    2460:	56                   	push   %esi
    2461:	e8 58 15 00 00       	call   39be <close>
    unlink("bigwrite");
    2466:	c7 04 24 14 49 00 00 	movl   $0x4914,(%esp)
    246d:	e8 74 15 00 00       	call   39e6 <unlink>
  for(sz = 499; sz < 12*512; sz += 471){
  ...
  printf(1, "bigwrite ok\n");
    ...
    2480:	68 47 49 00 00       	push   $0x4947
    2485:	6a 01                	push   $0x1
    2487:	e8 b4 16 00 00       	call   3b40 <printf>
}
    ...
    2496:	50                   	push   %eax
    2497:	53                   	push   %ebx
    2498:	68 35 49 00 00       	push   $0x4935
    249d:	6a 01                	push   $0x1
    249f:	e8 9c 16 00 00       	call   3b40 <printf>
        exit();
    24a4:	e8 ed 14 00 00       	call   3996 <exit>
      printf(1, "cannot create bigwrite\n");
    24a9:	83 ec 08             	sub    $0x8,%esp
    24ac:	68 1d 49 00 00       	push   $0x491d
    24b1:	6a 01                	push   $0x1
    24b3:	e8 88 16 00 00       	call   3b40 <printf>
      exit();
    24b8:	e8 d9 14 00 00       	call   3996 <exit>
...
000024c0 <bigfile>:
{
  ...
  printf(1, "bigfile test\n");
    24c9:	68 54 49 00 00       	push   $0x4954
    24ce:	6a 01                	push   $0x1
    24d0:	e8 6b 16 00 00       	call   3b40 <printf>
  unlink("bigfile");
    24d5:	c7 04 24 70 49 00 00 	movl   $0x4970,(%esp)
    24dc:	e8 05 15 00 00       	call   39e6 <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    24e1:	58                   	pop    %eax
    24e2:	5a                   	pop    %edx
    24e3:	68 02 02 00 00       	push   $0x202
    24e8:	68 70 49 00 00       	push   $0x4970
    24ed:	e8 e4 14 00 00       	call   39d6 <open>
  if(fd < 0){
  ...
  for(i = 0; i < 20; i++){
    ...
    2518:	53                   	push   %ebx
    2519:	68 00 7e 00 00       	push   $0x7e00
    251e:	e8 4d 12 00 00       	call   3770 <memset>
    if(write(fd, buf, 600) != 600){
    2523:	83 c4 0c             	add    $0xc,%esp
    2526:	68 58 02 00 00       	push   $0x258
    252b:	68 00 7e 00 00       	push   $0x7e00
    2530:	56                   	push   %esi
    2531:	e8 80 14 00 00       	call   39b6 <write>
  ...
  close(fd);
    ...
    254f:	56                   	push   %esi
    2550:	e8 69 14 00 00       	call   39be <close>
  fd = open("bigfile", 0);
    2555:	5e                   	pop    %esi
    2556:	5f                   	pop    %edi
    2557:	6a 00                	push   $0x0
    2559:	68 70 49 00 00       	push   $0x4970
    255e:	e8 73 14 00 00       	call   39d6 <open>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    258d:	0f be 05 00 7e 00 00 	movsbl 0x7e00,%eax
    2594:	d1 fa                	sar    $1,%edx
    2596:	39 d0                	cmp    %edx,%eax
    2598:	75 6e                	jne    2608 <bigfile+0x148>
    259a:	0f be 15 2b 7f 00 00 	movsbl 0x7f2b,%edx
  ...
  for(i = 0; ; i++){
    ...
    25b6:	68 00 7e 00 00       	push   $0x7e00
    25bb:	56                   	push   %esi
    25bc:	e8 ed 13 00 00       	call   39ae <read>
    if(cc < 0){
  ...
  close(fd);
    ...
    25cd:	56                   	push   %esi
    25ce:	e8 eb 13 00 00       	call   39be <close>
  if(total != 20*600){
  ...
  unlink("bigfile");
    ...
    25e5:	68 70 49 00 00       	push   $0x4970
    25ea:	e8 f7 13 00 00       	call   39e6 <unlink>
  printf(1, "bigfile test ok\n");
    25ef:	58                   	pop    %eax
    25f0:	5a                   	pop    %edx
    25f1:	68 ff 49 00 00       	push   $0x49ff
    25f6:	6a 01                	push   $0x1
    ...
    260b:	68 cc 49 00 00       	push   $0x49cc
    2610:	6a 01                	push   $0x1
    2612:	e8 29 15 00 00       	call   3b40 <printf>
      exit();
    2617:	e8 7a 13 00 00       	call   3996 <exit>
      printf(1, "short read bigfile\n");
    261c:	83 ec 08             	sub    $0x8,%esp
    261f:	68 b8 49 00 00       	push   $0x49b8
    2624:	6a 01                	push   $0x1
    2626:	e8 15 15 00 00       	call   3b40 <printf>
      exit();
    262b:	e8 66 13 00 00       	call   3996 <exit>
      printf(1, "read bigfile failed\n");
    2630:	83 ec 08             	sub    $0x8,%esp
    2633:	68 a3 49 00 00       	push   $0x49a3
    2638:	6a 01                	push   $0x1
    263a:	e8 01 15 00 00       	call   3b40 <printf>
      exit();
    263f:	e8 52 13 00 00       	call   3996 <exit>
      printf(1, "write bigfile failed\n");
    2644:	83 ec 08             	sub    $0x8,%esp
    2647:	68 78 49 00 00       	push   $0x4978
    264c:	6a 01                	push   $0x1
    264e:	e8 ed 14 00 00       	call   3b40 <printf>
      exit();
    2653:	e8 3e 13 00 00       	call   3996 <exit>
    printf(1, "cannot open bigfile\n");
    2658:	53                   	push   %ebx
    2659:	53                   	push   %ebx
    265a:	68 8e 49 00 00       	push   $0x498e
    265f:	6a 01                	push   $0x1
    2661:	e8 da 14 00 00       	call   3b40 <printf>
    exit();
    2666:	e8 2b 13 00 00       	call   3996 <exit>
    printf(1, "cannot create bigfile");
    266b:	50                   	push   %eax
    266c:	50                   	push   %eax
    266d:	68 62 49 00 00       	push   $0x4962
    2672:	6a 01                	push   $0x1
    2674:	e8 c7 14 00 00       	call   3b40 <printf>
    exit();
    2679:	e8 18 13 00 00       	call   3996 <exit>
    printf(1, "read bigfile wrong total\n");
    267e:	51                   	push   %ecx
    267f:	51                   	push   %ecx
    2680:	68 e5 49 00 00       	push   $0x49e5
    2685:	6a 01                	push   $0x1
    2687:	e8 b4 14 00 00       	call   3b40 <printf>
    exit();
    268c:	e8 05 13 00 00       	call   3996 <exit>
...
000026a0 <fourteen>:
{
  ...
  printf(1, "fourteen test\n");
    26a6:	68 10 4a 00 00       	push   $0x4a10
    26ab:	6a 01                	push   $0x1
    26ad:	e8 8e 14 00 00       	call   3b40 <printf>
  if(mkdir("12345678901234") != 0){
    26b2:	c7 04 24 4b 4a 00 00 	movl   $0x4a4b,(%esp)
    26b9:	e8 40 13 00 00       	call   39fe <mkdir>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    26cc:	68 10 52 00 00       	push   $0x5210
    26d1:	e8 28 13 00 00       	call   39fe <mkdir>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    26e9:	68 60 52 00 00       	push   $0x5260
    26ee:	e8 e3 12 00 00       	call   39d6 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    2701:	50                   	push   %eax
    2702:	e8 b7 12 00 00       	call   39be <close>
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    2707:	58                   	pop    %eax
    2708:	5a                   	pop    %edx
    2709:	6a 00                	push   $0x0
    270b:	68 d0 52 00 00       	push   $0x52d0
    2710:	e8 c1 12 00 00       	call   39d6 <open>
  if(fd < 0){
  ...
  printf(1, "fourteen ok\n");
    ...
    2760:	50                   	push   %eax
    2761:	50                   	push   %eax
    2762:	68 1f 4a 00 00       	push   $0x4a1f
    2767:	6a 01                	push   $0x1
    2769:	e8 d2 13 00 00       	call   3b40 <printf>
    exit();
    276e:	e8 23 12 00 00       	call   3996 <exit>
    printf(1, "mkdir 12345678901234/123456789012345 succeeded!\n");
    2773:	50                   	push   %eax
    2774:	50                   	push   %eax
    2775:	68 8c 53 00 00       	push   $0x538c
    277a:	6a 01                	push   $0x1
    277c:	e8 bf 13 00 00       	call   3b40 <printf>
    exit();
    2781:	e8 10 12 00 00       	call   3996 <exit>
    printf(1, "mkdir 12345678901234/12345678901234 succeeded!\n");
    2786:	52                   	push   %edx
    2787:	52                   	push   %edx
    2788:	68 3c 53 00 00       	push   $0x533c
    278d:	6a 01                	push   $0x1
    278f:	e8 ac 13 00 00       	call   3b40 <printf>
    exit();
    2794:	e8 fd 11 00 00       	call   3996 <exit>
    printf(1, "open 12345678901234/12345678901234/12345678901234 failed\n");
    2799:	51                   	push   %ecx
    279a:	51                   	push   %ecx
    279b:	68 00 53 00 00       	push   $0x5300
    27a0:	6a 01                	push   $0x1
    27a2:	e8 99 13 00 00       	call   3b40 <printf>
    exit();
    27a7:	e8 ea 11 00 00       	call   3996 <exit>
    printf(1, "create 123456789012345/123456789012345/123456789012345 failed\n");
    27ac:	51                   	push   %ecx
    27ad:	51                   	push   %ecx
    27ae:	68 90 52 00 00       	push   $0x5290
    27b3:	6a 01                	push   $0x1
    27b5:	e8 86 13 00 00       	call   3b40 <printf>
    exit();
    27ba:	e8 d7 11 00 00       	call   3996 <exit>
    printf(1, "mkdir 12345678901234/123456789012345 failed\n");
    27bf:	50                   	push   %eax
    27c0:	50                   	push   %eax
    27c1:	68 30 52 00 00       	push   $0x5230
    27c6:	6a 01                	push   $0x1
    27c8:	e8 73 13 00 00       	call   3b40 <printf>
    exit();
    27cd:	e8 c4 11 00 00       	call   3996 <exit>
...
000027e0 <rmdot>:
{
  ...
  printf(1, "rmdot ok\n");
    ...
    28b9:	50                   	push   %eax
    28ba:	50                   	push   %eax
    28bb:	68 78 4a 00 00       	push   $0x4a78
    28c0:	6a 01                	push   $0x1
    28c2:	e8 79 12 00 00       	call   3b40 <printf>
    exit();
    28c7:	e8 ca 10 00 00       	call   3996 <exit>
    printf(1, "unlink dots failed!\n");
    28cc:	50                   	push   %eax
    28cd:	50                   	push   %eax
    28ce:	68 f9 4a 00 00       	push   $0x4af9
    28d3:	6a 01                	push   $0x1
    28d5:	e8 66 12 00 00       	call   3b40 <printf>
    exit();
    28da:	e8 b7 10 00 00       	call   3996 <exit>
    printf(1, "unlink dots/.. worked!\n");
    28df:	52                   	push   %edx
    28e0:	52                   	push   %edx
    28e1:	68 e1 4a 00 00       	push   $0x4ae1
    28e6:	6a 01                	push   $0x1
    28e8:	e8 53 12 00 00       	call   3b40 <printf>
    exit();
    28ed:	e8 a4 10 00 00       	call   3996 <exit>
    printf(1, "unlink dots/. worked!\n");
    28f2:	51                   	push   %ecx
    28f3:	51                   	push   %ecx
    28f4:	68 c2 4a 00 00       	push   $0x4ac2
    28f9:	6a 01                	push   $0x1
    28fb:	e8 40 12 00 00       	call   3b40 <printf>
    exit();
    2900:	e8 91 10 00 00       	call   3996 <exit>
    printf(1, "chdir / failed\n");
    2905:	50                   	push   %eax
    2906:	50                   	push   %eax
    2907:	68 f3 3e 00 00       	push   $0x3ef3
    290c:	6a 01                	push   $0x1
    290e:	e8 2d 12 00 00       	call   3b40 <printf>
    exit();
    2913:	e8 7e 10 00 00       	call   3996 <exit>
    printf(1, "rm .. worked!\n");
    2918:	50                   	push   %eax
    2919:	50                   	push   %eax
    291a:	68 ac 4a 00 00       	push   $0x4aac
    291f:	6a 01                	push   $0x1
    2921:	e8 1a 12 00 00       	call   3b40 <printf>
    exit();
    2926:	e8 6b 10 00 00       	call   3996 <exit>
    printf(1, "rm . worked!\n");
    292b:	50                   	push   %eax
    292c:	50                   	push   %eax
    292d:	68 9e 4a 00 00       	push   $0x4a9e
    2932:	6a 01                	push   $0x1
    2934:	e8 07 12 00 00       	call   3b40 <printf>
    exit();
    2939:	e8 58 10 00 00       	call   3996 <exit>
    printf(1, "chdir dots failed\n");
    293e:	50                   	push   %eax
    293f:	50                   	push   %eax
    2940:	68 8b 4a 00 00       	push   $0x4a8b
    2945:	6a 01                	push   $0x1
    2947:	e8 f4 11 00 00       	call   3b40 <printf>
    exit();
    294c:	e8 45 10 00 00       	call   3996 <exit>
...
00002960 <dirfile>:
{
  ...
  printf(1, "dir vs file\n");
    2967:	68 18 4b 00 00       	push   $0x4b18
    296c:	6a 01                	push   $0x1
  ...
  fd = open("dirfile", O_CREATE);
    ...
    297a:	68 25 4b 00 00       	push   $0x4b25
    297f:	e8 52 10 00 00       	call   39d6 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    2992:	50                   	push   %eax
    2993:	e8 26 10 00 00       	call   39be <close>
  if(chdir("dirfile") == 0){
    2998:	c7 04 24 25 4b 00 00 	movl   $0x4b25,(%esp)
    299f:	e8 62 10 00 00       	call   3a06 <chdir>
  ...
  fd = open("dirfile/xx", 0);
    ...
    29b2:	6a 00                	push   $0x0
    29b4:	68 5e 4b 00 00       	push   $0x4b5e
    29b9:	e8 18 10 00 00       	call   39d6 <open>
  if(fd >= 0){
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    29d6:	e8 fb 0f 00 00       	call   39d6 <open>
  if(fd >= 0){
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    29e9:	68 5e 4b 00 00       	push   $0x4b5e
    29ee:	e8 0b 10 00 00       	call   39fe <mkdir>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    2a01:	68 5e 4b 00 00       	push   $0x4b5e
    2a06:	e8 db 0f 00 00       	call   39e6 <unlink>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2a19:	68 5e 4b 00 00       	push   $0x4b5e
    2a1e:	68 c2 4b 00 00       	push   $0x4bc2
    2a23:	e8 ce 0f 00 00       	call   39f6 <link>
    2a28:	83 c4 10             	add    $0x10,%esp
    2a2b:	85 c0                	test   %eax,%eax
    2a2d:	0f 84 eb 00 00 00    	je     2b1e <dirfile+0x1be>
  if(unlink("dirfile") != 0){
    2a33:	83 ec 0c             	sub    $0xc,%esp
    2a36:	68 25 4b 00 00       	push   $0x4b25
    2a3b:	e8 a6 0f 00 00       	call   39e6 <unlink>
  ...
  fd = open(".", O_RDWR);
    ...
    2a4e:	6a 02                	push   $0x2
    2a50:	68 1e 47 00 00       	push   $0x471e
    2a55:	e8 7c 0f 00 00       	call   39d6 <open>
  if(fd >= 0){
  ...
  fd = open(".", 0);
    ...
    2a68:	6a 00                	push   $0x0
    2a6a:	68 1e 47 00 00       	push   $0x471e
    2a6f:	e8 62 0f 00 00       	call   39d6 <open>
  if(write(fd, "x", 1) > 0){
  ...
  if(write(fd, "x", 1) > 0){
    2a7b:	68 01 48 00 00       	push   $0x4801
    2a80:	50                   	push   %eax
    2a81:	e8 30 0f 00 00       	call   39b6 <write>
  ...
  close(fd);
    ...
    2a90:	53                   	push   %ebx
    2a91:	e8 28 0f 00 00       	call   39be <close>
  printf(1, "dir vs file OK\n");
    2a96:	58                   	pop    %eax
    2a97:	5a                   	pop    %edx
    2a98:	68 f5 4b 00 00       	push   $0x4bf5
    2a9d:	6a 01                	push   $0x1
    ...
    2aac:	50                   	push   %eax
    2aad:	50                   	push   %eax
    2aae:	68 69 4b 00 00       	push   $0x4b69
    2ab3:	6a 01                	push   $0x1
    2ab5:	e8 86 10 00 00       	call   3b40 <printf>
    exit();
    2aba:	e8 d7 0e 00 00       	call   3996 <exit>
    printf(1, "chdir dirfile succeeded!\n");
    2abf:	52                   	push   %edx
    2ac0:	52                   	push   %edx
    2ac1:	68 44 4b 00 00       	push   $0x4b44
    2ac6:	6a 01                	push   $0x1
    2ac8:	e8 73 10 00 00       	call   3b40 <printf>
    exit();
    2acd:	e8 c4 0e 00 00       	call   3996 <exit>
    printf(1, "create dirfile failed\n");
    2ad2:	51                   	push   %ecx
    2ad3:	51                   	push   %ecx
    2ad4:	68 2d 4b 00 00       	push   $0x4b2d
    2ad9:	6a 01                	push   $0x1
    2adb:	e8 60 10 00 00       	call   3b40 <printf>
    exit();
    2ae0:	e8 b1 0e 00 00       	call   3996 <exit>
    printf(1, "write . succeeded!\n");
    2ae5:	51                   	push   %ecx
    2ae6:	51                   	push   %ecx
    2ae7:	68 e1 4b 00 00       	push   $0x4be1
    2aec:	6a 01                	push   $0x1
    2aee:	e8 4d 10 00 00       	call   3b40 <printf>
    exit();
    2af3:	e8 9e 0e 00 00       	call   3996 <exit>
    printf(1, "open . for writing succeeded!\n");
    2af8:	53                   	push   %ebx
    2af9:	53                   	push   %ebx
    2afa:	68 e0 53 00 00       	push   $0x53e0
    2aff:	6a 01                	push   $0x1
    2b01:	e8 3a 10 00 00       	call   3b40 <printf>
    exit();
    2b06:	e8 8b 0e 00 00       	call   3996 <exit>
    printf(1, "unlink dirfile failed!\n");
    2b0b:	50                   	push   %eax
    2b0c:	50                   	push   %eax
    2b0d:	68 c9 4b 00 00       	push   $0x4bc9
    2b12:	6a 01                	push   $0x1
    2b14:	e8 27 10 00 00       	call   3b40 <printf>
    exit();
    2b19:	e8 78 0e 00 00       	call   3996 <exit>
    printf(1, "link to dirfile/xx succeeded!\n");
    2b1e:	50                   	push   %eax
    2b1f:	50                   	push   %eax
    2b20:	68 c0 53 00 00       	push   $0x53c0
    2b25:	6a 01                	push   $0x1
    2b27:	e8 14 10 00 00       	call   3b40 <printf>
    exit();
    2b2c:	e8 65 0e 00 00       	call   3996 <exit>
    printf(1, "unlink dirfile/xx succeeded!\n");
    2b31:	50                   	push   %eax
    2b32:	50                   	push   %eax
    2b33:	68 a4 4b 00 00       	push   $0x4ba4
    2b38:	6a 01                	push   $0x1
    2b3a:	e8 01 10 00 00       	call   3b40 <printf>
    exit();
    2b3f:	e8 52 0e 00 00       	call   3996 <exit>
    printf(1, "mkdir dirfile/xx succeeded!\n");
    2b44:	50                   	push   %eax
    2b45:	50                   	push   %eax
    2b46:	68 87 4b 00 00       	push   $0x4b87
    2b4b:	6a 01                	push   $0x1
    2b4d:	e8 ee 0f 00 00       	call   3b40 <printf>
    exit();
    2b52:	e8 3f 0e 00 00       	call   3996 <exit>
    ...
    2b64:	bb 33 00 00 00       	mov    $0x33,%ebx
{
  ...
  printf(1, "empty file name\n");
    2b6c:	68 05 4c 00 00       	push   $0x4c05
    2b71:	6a 01                	push   $0x1
    ...
    2b83:	68 16 4c 00 00       	push   $0x4c16
    2b88:	e8 71 0e 00 00       	call   39fe <mkdir>
    2b8d:	83 c4 10             	add    $0x10,%esp
    2b90:	85 c0                	test   %eax,%eax
    2b92:	0f 85 bb 00 00 00    	jne    2c53 <iref+0xf3>
    if(chdir("irefd") != 0){
    2b98:	83 ec 0c             	sub    $0xc,%esp
    2b9b:	68 16 4c 00 00       	push   $0x4c16
    2ba0:	e8 61 0e 00 00       	call   3a06 <chdir>
    2ba5:	83 c4 10             	add    $0x10,%esp
    2ba8:	85 c0                	test   %eax,%eax
    2baa:	0f 85 b7 00 00 00    	jne    2c67 <iref+0x107>
    mkdir("");
    2bb0:	83 ec 0c             	sub    $0xc,%esp
    2bb3:	68 cb 42 00 00       	push   $0x42cb
    2bb8:	e8 41 0e 00 00       	call   39fe <mkdir>
    link("README", "");
    2bbd:	59                   	pop    %ecx
    2bbe:	58                   	pop    %eax
    2bbf:	68 cb 42 00 00       	push   $0x42cb
    2bc4:	68 c2 4b 00 00       	push   $0x4bc2
    2bc9:	e8 28 0e 00 00       	call   39f6 <link>
    fd = open("", O_CREATE);
    2bce:	58                   	pop    %eax
    2bcf:	5a                   	pop    %edx
    2bd0:	68 00 02 00 00       	push   $0x200
    2bd5:	68 cb 42 00 00       	push   $0x42cb
    2bda:	e8 f7 0d 00 00       	call   39d6 <open>
    if(fd >= 0)
    ...
    2be9:	50                   	push   %eax
    2bea:	e8 cf 0d 00 00       	call   39be <close>
    2bef:	83 c4 10             	add    $0x10,%esp
    fd = open("xx", O_CREATE);
    2bf2:	83 ec 08             	sub    $0x8,%esp
    2bf5:	68 00 02 00 00       	push   $0x200
    2bfa:	68 00 48 00 00       	push   $0x4800
    2bff:	e8 d2 0d 00 00       	call   39d6 <open>
    if(fd >= 0)
    ...
    2c0e:	50                   	push   %eax
    2c0f:	e8 aa 0d 00 00       	call   39be <close>
    2c14:	83 c4 10             	add    $0x10,%esp
    unlink("xx");
    2c17:	83 ec 0c             	sub    $0xc,%esp
    2c1a:	68 00 48 00 00       	push   $0x4800
    2c1f:	e8 c2 0d 00 00       	call   39e6 <unlink>
  for(i = 0; i < 50 + 1; i++){
  ...
  chdir("/");
    ...
    2c33:	68 f1 3e 00 00       	push   $0x3ef1
    2c38:	e8 c9 0d 00 00       	call   3a06 <chdir>
  printf(1, "empty file name OK\n");
    2c3d:	58                   	pop    %eax
    2c3e:	5a                   	pop    %edx
    2c3f:	68 44 4c 00 00       	push   $0x4c44
    2c44:	6a 01                	push   $0x1
    ...
    2c56:	68 1c 4c 00 00       	push   $0x4c1c
    2c5b:	6a 01                	push   $0x1
    2c5d:	e8 de 0e 00 00       	call   3b40 <printf>
      exit();
    2c62:	e8 2f 0d 00 00       	call   3996 <exit>
      printf(1, "chdir irefd failed\n");
    2c67:	83 ec 08             	sub    $0x8,%esp
    2c6a:	68 30 4c 00 00       	push   $0x4c30
    2c6f:	6a 01                	push   $0x1
    2c71:	e8 ca 0e 00 00       	call   3b40 <printf>
      exit();
    2c76:	e8 1b 0d 00 00       	call   3996 <exit>
    ...
    2c84:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fork test\n");
    2c89:	68 58 4c 00 00       	push   $0x4c58
    2c8e:	6a 01                	push   $0x1
  ...
  for(n=0; n<1000; n++){
    ...
    pid = fork();
    2cad:	e8 dc 0c 00 00       	call   398e <fork>
    if(pid < 0)
  ...
  for(; n > 0; n--){
    ...
    if(wait() < 0){
    2cc0:	e8 d9 0c 00 00       	call   399e <wait>
  ...
  printf(1, "fork test OK\n");
    ...
    2ceb:	c3                   	ret
      exit();
    2cec:	e8 a5 0c 00 00       	call   3996 <exit>
      printf(1, "wait stopped early\n");
    2cf1:	83 ec 08             	sub    $0x8,%esp
    2cf4:	68 63 4c 00 00       	push   $0x4c63
    2cf9:	6a 01                	push   $0x1
    2cfb:	e8 40 0e 00 00       	call   3b40 <printf>
      exit();
    2d00:	e8 91 0c 00 00       	call   3996 <exit>
    printf(1, "wait got too many\n");
    2d05:	52                   	push   %edx
    2d06:	52                   	push   %edx
    2d07:	68 77 4c 00 00       	push   $0x4c77
    2d0c:	6a 01                	push   $0x1
    2d0e:	e8 2d 0e 00 00       	call   3b40 <printf>
    exit();
    2d13:	e8 7e 0c 00 00       	call   3996 <exit>
    printf(1, "fork claimed to work 1000 times!\n");
    2d18:	50                   	push   %eax
    2d19:	50                   	push   %eax
    2d1a:	68 00 54 00 00       	push   $0x5400
    2d1f:	6a 01                	push   $0x1
    2d21:	e8 1a 0e 00 00       	call   3b40 <printf>
    exit();
    2d26:	e8 6b 0c 00 00       	call   3996 <exit>
    ...
    2d34:	31 ff                	xor    %edi,%edi
{
  ...
  for(i = 0; i < 5000; i++){
    ...
    2d75:	6a 01                	push   $0x1
    2d77:	e8 a2 0c 00 00       	call   3a1e <sbrk>
    if(b != a){
  ...
  pid = fork();
    2d98:	e8 f1 0b 00 00       	call   398e <fork>
  ...
  c = sbrk(1);
    2dad:	6a 01                	push   $0x1
    2daf:	e8 6a 0c 00 00       	call   3a1e <sbrk>
  c = sbrk(1);
    2db4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2dbb:	e8 5e 0c 00 00       	call   3a1e <sbrk>
  if(c != a + 1){
  ...
  wait();
    2dd3:	e8 c6 0b 00 00       	call   399e <wait>
  a = sbrk(0);
    2dd8:	83 ec 0c             	sub    $0xc,%esp
    2ddb:	6a 00                	push   $0x0
    2ddd:	e8 3c 0c 00 00       	call   3a1e <sbrk>
  ...
  p = sbrk(amt);
    ...
    2dee:	e8 2b 0c 00 00       	call   3a1e <sbrk>
  if (p != a) {
  ...
  *lastaddr = 99;
  ...
  a = sbrk(0);
    2e08:	6a 00                	push   $0x0
    2e0a:	e8 0f 0c 00 00       	call   3a1e <sbrk>
  c = sbrk(-4096);
    2e0f:	c7 04 24 00 f0 ff ff 	movl   $0xfffff000,(%esp)
  a = sbrk(0);
    2e16:	89 c3                	mov    %eax,%ebx
  c = sbrk(-4096);
    2e18:	e8 01 0c 00 00       	call   3a1e <sbrk>
  ...
  c = sbrk(0);
    ...
    2e2c:	6a 00                	push   $0x0
    2e2e:	e8 eb 0b 00 00       	call   3a1e <sbrk>
  if(c != a - 4096){
  ...
  a = sbrk(0);
    ...
    2e47:	6a 00                	push   $0x0
    2e49:	e8 d0 0b 00 00       	call   3a1e <sbrk>
  c = sbrk(4096);
    2e4e:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
  a = sbrk(0);
    2e55:	89 c3                	mov    %eax,%ebx
  c = sbrk(4096);
    2e57:	e8 c2 0b 00 00       	call   3a1e <sbrk>
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    2e6c:	6a 00                	push   $0x0
    2e6e:	e8 ab 0b 00 00       	call   3a1e <sbrk>
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2ecf:	00 
    ppid = getpid();
    2ed0:	e8 41 0b 00 00       	call   3a16 <getpid>
    2ed5:	89 c7                	mov    %eax,%edi
    pid = fork();
    2ed7:	e8 b2 0a 00 00       	call   398e <fork>
    if(pid < 0){
    ...
    wait();
    2eea:	e8 af 0a 00 00       	call   399e <wait>
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
  ...
  if(pipe(fds) != 0){
    ...
    2f03:	50                   	push   %eax
    2f04:	e8 9d 0a 00 00       	call   39a6 <pipe>
  ...
  if(pipe(fds) != 0){
    ...
    if((pids[i] = fork()) == 0){
    2f20:	e8 69 0a 00 00       	call   398e <fork>
    ...
    2f3d:	e8 6c 0a 00 00       	call   39ae <read>
  ...
  c = sbrk(4096);
    ...
    2f57:	e8 c2 0a 00 00       	call   3a1e <sbrk>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    2f7a:	50                   	push   %eax
    2f7b:	e8 46 0a 00 00       	call   39c6 <kill>
    wait();
    2f80:	e8 19 0a 00 00       	call   399e <wait>
  ...
  if(sbrk(0) > oldbrk)
    ...
    2f9e:	6a 00                	push   $0x0
    2fa0:	e8 79 0a 00 00       	call   3a1e <sbrk>
    2fa5:	83 c4 10             	add    $0x10,%esp
    2fa8:	39 45 a4             	cmp    %eax,-0x5c(%ebp)
    2fab:	72 65                	jb     3012 <sbrktest+0x2e2>
  printf(stdout, "sbrk test OK\n");
    2fad:	83 ec 08             	sub    $0x8,%esp
    2fb0:	68 40 4d 00 00       	push   $0x4d40
    2fb5:	ff 35 c0 56 00 00    	push   0x56c0
    2fbb:	e8 80 0b 00 00       	call   3b40 <printf>
}
    ...
    3024:	e8 f5 09 00 00       	call   3a1e <sbrk>
    ...
    3035:	53                   	push   %ebx
    3036:	57                   	push   %edi
    3037:	68 a3 4c 00 00       	push   $0x4ca3
    303c:	ff 35 c0 56 00 00    	push   0x56c0
    3042:	e8 f9 0a 00 00       	call   3b40 <printf>
      exit();
    3047:	83 c4 20             	add    $0x20,%esp
    304a:	e8 47 09 00 00       	call   3996 <exit>
      printf(stdout, "fork failed\n");
    304f:	83 ec 08             	sub    $0x8,%esp
    3052:	68 e9 4d 00 00       	push   $0x4de9
    3057:	ff 35 c0 56 00 00    	push   0x56c0
    305d:	e8 de 0a 00 00       	call   3b40 <printf>
      exit();
    3062:	e8 2f 09 00 00       	call   3996 <exit>
      printf(stdout, "oops could read %x = %x\n", a, *a);
    3067:	0f be 03             	movsbl (%ebx),%eax
    306a:	50                   	push   %eax
    306b:	53                   	push   %ebx
    306c:	68 0c 4d 00 00       	push   $0x4d0c
    3071:	ff 35 c0 56 00 00    	push   0x56c0
    3077:	e8 c4 0a 00 00       	call   3b40 <printf>
      kill(ppid);
    307c:	89 3c 24             	mov    %edi,(%esp)
    307f:	e8 42 09 00 00       	call   39c6 <kill>
      exit();
    3084:	e8 0d 09 00 00       	call   3996 <exit>
    printf(stdout, "sbrk downsize failed, a %x c %x\n", a, c);
    3089:	50                   	push   %eax
    308a:	53                   	push   %ebx
    308b:	68 f4 54 00 00       	push   $0x54f4
    3090:	ff 35 c0 56 00 00    	push   0x56c0
    3096:	e8 a5 0a 00 00       	call   3b40 <printf>
    exit();
    309b:	e8 f6 08 00 00       	call   3996 <exit>
    printf(stdout, "sbrk test failed to grow big address space; enough phys mem?\n");
    30a0:	56                   	push   %esi
    30a1:	56                   	push   %esi
    30a2:	68 24 54 00 00       	push   $0x5424
    30a7:	ff 35 c0 56 00 00    	push   0x56c0
    30ad:	e8 8e 0a 00 00       	call   3b40 <printf>
    exit();
    30b2:	e8 df 08 00 00       	call   3996 <exit>
    printf(stdout, "sbrk test fork failed\n");
    30b7:	50                   	push   %eax
    30b8:	50                   	push   %eax
    30b9:	68 be 4c 00 00       	push   $0x4cbe
    30be:	ff 35 c0 56 00 00    	push   0x56c0
    30c4:	e8 77 0a 00 00       	call   3b40 <printf>
    exit();
    30c9:	e8 c8 08 00 00       	call   3996 <exit>
    printf(stdout, "sbrk de-allocation didn't really deallocate\n");
    30ce:	51                   	push   %ecx
    30cf:	51                   	push   %ecx
    30d0:	68 c4 54 00 00       	push   $0x54c4
    30d5:	ff 35 c0 56 00 00    	push   0x56c0
    30db:	e8 60 0a 00 00       	call   3b40 <printf>
    exit();
    30e0:	e8 b1 08 00 00       	call   3996 <exit>
    printf(stdout, "failed sbrk leaked memory\n");
    30e5:	50                   	push   %eax
    30e6:	50                   	push   %eax
    30e7:	68 25 4d 00 00       	push   $0x4d25
    30ec:	ff 35 c0 56 00 00    	push   0x56c0
    30f2:	e8 49 0a 00 00       	call   3b40 <printf>
    exit();
    30f7:	e8 9a 08 00 00       	call   3996 <exit>
    printf(1, "pipe() failed\n");
    30fc:	52                   	push   %edx
    30fd:	52                   	push   %edx
    30fe:	68 e1 41 00 00       	push   $0x41e1
    3103:	6a 01                	push   $0x1
    3105:	e8 36 0a 00 00       	call   3b40 <printf>
    exit();
    310a:	e8 87 08 00 00       	call   3996 <exit>
    exit();
    310f:	e8 82 08 00 00       	call   3996 <exit>
    printf(stdout, "sbrk test failed post-fork\n");
    3114:	57                   	push   %edi
    3115:	57                   	push   %edi
    3116:	68 d5 4c 00 00       	push   $0x4cd5
    311b:	ff 35 c0 56 00 00    	push   0x56c0
    3121:	e8 1a 0a 00 00       	call   3b40 <printf>
    exit();
    3126:	e8 6b 08 00 00       	call   3996 <exit>
    printf(stdout, "sbrk re-allocation failed, a %x c %x\n", a, c);
    312b:	57                   	push   %edi
    312c:	53                   	push   %ebx
    312d:	68 9c 54 00 00       	push   $0x549c
    3132:	ff 35 c0 56 00 00    	push   0x56c0
    3138:	e8 03 0a 00 00       	call   3b40 <printf>
    exit();
    313d:	e8 54 08 00 00       	call   3996 <exit>
    printf(stdout, "sbrk deallocation produced wrong address, a %x c %x\n", a, c);
    3142:	50                   	push   %eax
    3143:	53                   	push   %ebx
    3144:	68 64 54 00 00       	push   $0x5464
    3149:	ff 35 c0 56 00 00    	push   0x56c0
    314f:	e8 ec 09 00 00       	call   3b40 <printf>
    exit();
    3154:	e8 3d 08 00 00       	call   3996 <exit>
    printf(stdout, "sbrk could not deallocate\n");
    3159:	53                   	push   %ebx
    315a:	53                   	push   %ebx
    315b:	68 f1 4c 00 00       	push   $0x4cf1
    3160:	ff 35 c0 56 00 00    	push   0x56c0
    3166:	e8 d5 09 00 00       	call   3b40 <printf>
    exit();
    316b:	e8 26 08 00 00       	call   3996 <exit>
    ...
    3184:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "validate test\n");
    ...
    318a:	68 4e 4d 00 00       	push   $0x4d4e
    318f:	ff 35 c0 56 00 00    	push   0x56c0
    3195:	e8 a6 09 00 00       	call   3b40 <printf>
    319a:	83 c4 10             	add    $0x10,%esp
    319d:	8d 76 00             	lea    0x0(%esi),%esi
    if((pid = fork()) == 0){
    31a0:	e8 e9 07 00 00       	call   398e <fork>
    ...
    31ae:	6a 00                	push   $0x0
    31b0:	e8 71 08 00 00       	call   3a26 <sleep>
    sleep(0);
    31b5:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    31bc:	e8 65 08 00 00       	call   3a26 <sleep>
    kill(pid);
    31c1:	89 1c 24             	mov    %ebx,(%esp)
    31c4:	e8 fd 07 00 00       	call   39c6 <kill>
    wait();
    31c9:	e8 d0 07 00 00       	call   399e <wait>
    if(link("nosuchfile", (char*)p) != -1){
    31ce:	58                   	pop    %eax
    31cf:	5a                   	pop    %edx
    31d0:	56                   	push   %esi
    31d1:	68 5d 4d 00 00       	push   $0x4d5d
    31d6:	e8 1b 08 00 00       	call   39f6 <link>
  ...
  printf(stdout, "validate ok\n");
    ...
    31f4:	68 81 4d 00 00       	push   $0x4d81
    31f9:	ff 35 c0 56 00 00    	push   0x56c0
    ...
    320d:	c3                   	ret
      exit();
    320e:	e8 83 07 00 00       	call   3996 <exit>
      printf(stdout, "link should not succeed\n");
    3213:	83 ec 08             	sub    $0x8,%esp
    3216:	68 68 4d 00 00       	push   $0x4d68
    321b:	ff 35 c0 56 00 00    	push   0x56c0
    3221:	e8 1a 09 00 00       	call   3b40 <printf>
      exit();
    3226:	e8 6b 07 00 00       	call   3996 <exit>
...
00003230 <bsstest>:
{
  ...
  printf(stdout, "bss test\n");
    3236:	68 8e 4d 00 00       	push   $0x4d8e
    323b:	ff 35 c0 56 00 00    	push   0x56c0
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    if(uninit[i] != '\0'){
    3260:	80 b8 e0 56 00 00 00 	cmpb   $0x0,0x56e0(%eax)
  ...
  printf(stdout, "bss test ok\n");
    ...
    3276:	68 a9 4d 00 00       	push   $0x4da9
    327b:	ff 35 c0 56 00 00    	push   0x56c0
    3281:	e8 ba 08 00 00       	call   3b40 <printf>
}
    ...
    328e:	68 98 4d 00 00       	push   $0x4d98
    3293:	ff 35 c0 56 00 00    	push   0x56c0
    3299:	e8 a2 08 00 00       	call   3b40 <printf>
      exit();
...
000032b0 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    32b6:	68 b6 4d 00 00       	push   $0x4db6
  ...
  fd = open("bigarg-ok", 0);
    ...
    32da:	6a 00                	push   $0x0
    32dc:	68 b6 4d 00 00       	push   $0x4db6
  ...
  unlink("bigarg-ok");
    32fa:	c7 04 24 b6 4d 00 00 	movl   $0x4db6,(%esp)
    ...
    330b:	c7 04 85 00 9e 00 00 	movl   $0x5518,0x9e00(,%eax,4)
    3312:	18 55 00 00 
    for(i = 0; i < MAXARG-1; i++)
    3316:	b8 01 00 00 00       	mov    $0x1,%eax
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    331b:	c7 04 85 00 9e 00 00 	movl   $0x5518,0x9e00(,%eax,4)
    3322:	18 55 00 00 
    3326:	c7 04 85 04 9e 00 00 	movl   $0x5518,0x9e04(,%eax,4)
    332d:	18 55 00 00 
    for(i = 0; i < MAXARG-1; i++)
    ...
    printf(stdout, "bigarg test\n");
    333c:	50                   	push   %eax
    333d:	68 c0 4d 00 00       	push   $0x4dc0
    3342:	ff 35 c0 56 00 00    	push   0x56c0
    args[MAXARG-1] = 0;
    3348:	89 0d 7c 9e 00 00    	mov    %ecx,0x9e7c
    printf(stdout, "bigarg test\n");
    334e:	e8 ed 07 00 00       	call   3b40 <printf>
    exec("echo", args);
    3353:	58                   	pop    %eax
    3354:	5a                   	pop    %edx
    3355:	68 00 9e 00 00       	push   $0x9e00
    335a:	68 8d 3f 00 00       	push   $0x3f8d
    335f:	e8 6a 06 00 00       	call   39ce <exec>
    printf(stdout, "bigarg test ok\n");
    3364:	59                   	pop    %ecx
    3365:	58                   	pop    %eax
    3366:	68 cd 4d 00 00       	push   $0x4dcd
    336b:	ff 35 c0 56 00 00    	push   0x56c0
    3371:	e8 ca 07 00 00       	call   3b40 <printf>
    fd = open("bigarg-ok", O_CREATE);
    3376:	58                   	pop    %eax
    3377:	5a                   	pop    %edx
    3378:	68 00 02 00 00       	push   $0x200
    337d:	68 b6 4d 00 00       	push   $0x4db6
    3382:	e8 4f 06 00 00       	call   39d6 <open>
    close(fd);
    3387:	89 04 24             	mov    %eax,(%esp)
    338a:	e8 2f 06 00 00       	call   39be <close>
    exit();
    338f:	e8 02 06 00 00       	call   3996 <exit>
    printf(stdout, "bigarg test failed!\n");
    3394:	50                   	push   %eax
    3395:	50                   	push   %eax
    3396:	68 f6 4d 00 00       	push   $0x4df6
    339b:	ff 35 c0 56 00 00    	push   0x56c0
    33a1:	e8 9a 07 00 00       	call   3b40 <printf>
    exit();
    33a6:	e8 eb 05 00 00       	call   3996 <exit>
    printf(stdout, "bigargtest: fork failed\n");
    33ab:	52                   	push   %edx
    33ac:	52                   	push   %edx
    33ad:	68 dd 4d 00 00       	push   $0x4ddd
    33b2:	ff 35 c0 56 00 00    	push   0x56c0
    33b8:	e8 83 07 00 00       	call   3b40 <printf>
    exit();
    33bd:	e8 d4 05 00 00       	call   3996 <exit>
    ...
    33d9:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fsfull test\n");
    33de:	68 0b 4e 00 00       	push   $0x4e0b
    33e3:	6a 01                	push   $0x1
    33e5:	e8 56 07 00 00       	call   3b40 <printf>
    ...
    printf(1, "writing %s\n", name);
    345b:	57                   	push   %edi
    345c:	68 18 4e 00 00       	push   $0x4e18
    3461:	6a 01                	push   $0x1
    3463:	e8 d8 06 00 00       	call   3b40 <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    3468:	58                   	pop    %eax
    3469:	5a                   	pop    %edx
    346a:	68 02 02 00 00       	push   $0x202
    346f:	57                   	push   %edi
    3470:	e8 61 05 00 00       	call   39d6 <open>
    if(fd < 0){
    ...
    3483:	57                   	push   %edi
    3484:	68 24 4e 00 00       	push   $0x4e24
    3489:	6a 01                	push   $0x1
    348b:	e8 b0 06 00 00       	call   3b40 <printf>
      break;
    ...
    unlink(name);
    350b:	57                   	push   %edi
    350c:	e8 d5 04 00 00       	call   39e6 <unlink>
  while(nfiles >= 0){
  ...
  printf(1, "fsfull test finished\n");
    ...
    351c:	68 44 4e 00 00       	push   $0x4e44
    3521:	6a 01                	push   $0x1
    3523:	e8 18 06 00 00       	call   3b40 <printf>
}
    ...
    3552:	68 00 7e 00 00       	push   $0x7e00
    3557:	53                   	push   %ebx
    3558:	e8 59 04 00 00       	call   39b6 <write>
      if(cc < 512)
    ...
    3570:	56                   	push   %esi
    3571:	68 34 4e 00 00       	push   $0x4e34
    3576:	6a 01                	push   $0x1
    3578:	e8 c3 05 00 00       	call   3b40 <printf>
    close(fd);
    357d:	8b 4d a0             	mov    -0x60(%ebp),%ecx
    3580:	89 0c 24             	mov    %ecx,(%esp)
    3583:	e8 36 04 00 00       	call   39be <close>
    if(total == 0)
...
000035a0 <uio>:
{
  ...
  printf(1, "uio test\n");
    35a6:	68 5a 4e 00 00       	push   $0x4e5a
    35ab:	6a 01                	push   $0x1
    35ad:	e8 8e 05 00 00       	call   3b40 <printf>
  pid = fork();
    35b2:	e8 d7 03 00 00       	call   398e <fork>
  if(pid == 0){
  ...
  wait();
    35c0:	e8 d9 03 00 00       	call   399e <wait>
  printf(1, "uio test done\n");
    35c5:	83 ec 08             	sub    $0x8,%esp
    35c8:	68 64 4e 00 00       	push   $0x4e64
    35cd:	6a 01                	push   $0x1
    35cf:	e8 6c 05 00 00       	call   3b40 <printf>
}
    ...
    35ea:	52                   	push   %edx
    35eb:	52                   	push   %edx
    35ec:	68 f8 55 00 00       	push   $0x55f8
    35f1:	6a 01                	push   $0x1
    35f3:	e8 48 05 00 00       	call   3b40 <printf>
    exit();
    35f8:	e8 99 03 00 00       	call   3996 <exit>
    printf (1, "fork failed\n");
    35fd:	50                   	push   %eax
    35fe:	50                   	push   %eax
    35ff:	68 e9 4d 00 00       	push   $0x4de9
    3604:	6a 01                	push   $0x1
    3606:	e8 35 05 00 00       	call   3b40 <printf>
    exit();
    360b:	e8 86 03 00 00       	call   3996 <exit>
...
00003610 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    3617:	6a 00                	push   $0x0
    3619:	68 73 4e 00 00       	push   $0x4e73
    361e:	e8 b3 03 00 00       	call   39d6 <open>
  if (fd < 0) {
  ...
  read(fd, sbrk(0) - 1, -1);
    ...
    362f:	6a 00                	push   $0x0
    3631:	e8 e8 03 00 00       	call   3a1e <sbrk>
    3636:	83 c4 0c             	add    $0xc,%esp
    3639:	83 e8 01             	sub    $0x1,%eax
    363c:	6a ff                	push   $0xffffffff
    363e:	50                   	push   %eax
    363f:	53                   	push   %ebx
    3640:	e8 69 03 00 00       	call   39ae <read>
  close(fd);
    3645:	89 1c 24             	mov    %ebx,(%esp)
    3648:	e8 71 03 00 00       	call   39be <close>
  printf(1, "arg test passed\n");
    364d:	58                   	pop    %eax
    364e:	5a                   	pop    %edx
    364f:	68 85 4e 00 00       	push   $0x4e85
    3654:	6a 01                	push   $0x1
    3656:	e8 e5 04 00 00       	call   3b40 <printf>
}
    ...
    3663:	51                   	push   %ecx
    3664:	51                   	push   %ecx
    3665:	68 78 4e 00 00       	push   $0x4e78
    366a:	6a 02                	push   $0x2
    366c:	e8 cf 04 00 00       	call   3b40 <printf>
    exit();
    3671:	e8 20 03 00 00       	call   3996 <exit>
...
00003680 <rand>:
  randstate = randstate * 1664525 + 1013904223;
    3680:	69 05 bc 56 00 00 0d 	imul   $0x19660d,0x56bc,%eax
    3687:	66 19 00 
    368a:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    368f:	a3 bc 56 00 00       	mov    %eax,0x56bc
}
    3694:	c3                   	ret
    ...
    37d9:	31 db                	xor    %ebx,%ebx
{
  ...
  for(i=0; i+1 < max; ){
    ...
    37e5:	56                   	push   %esi
    37e6:	6a 00                	push   $0x0
    37e8:	e8 c1 01 00 00       	call   39ae <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
    ...
    383d:	e8 94 01 00 00       	call   39d6 <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
    ...
    3851:	50                   	push   %eax
    3852:	e8 97 01 00 00       	call   39ee <fstat>
  close(fd);
    3857:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
    385a:	89 c6                	mov    %eax,%esi
  close(fd);
    385c:	e8 5d 01 00 00       	call   39be <close>
  return r;
...
float sqrt(int num) {
    ...
    38f3:	56                   	push   %esi
    38f4:	53                   	push   %ebx
    38f5:	83 ec 04             	sub    $0x4,%esp
    38f8:	8b 5d 08             	mov    0x8(%ebp),%ebx
  int end = num;
  int middle;
  ...
  while (start <= end) {
    ...
    38fd:	0f 88 87 00 00 00    	js     398a <sqrt+0x9a>
  int end = num;
    3903:	89 d9                	mov    %ebx,%ecx
  float solution = 0.0;
    3905:	d9 ee                	fldz
  int start = 0;
    3907:	31 d2                	xor    %edx,%edx
    3909:	eb 14                	jmp    391f <sqrt+0x2f>
    390b:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
    3910:	dd d8                	fstp   %st(0)
    ...
    if (middle * middle < num) {
      solution = start;
    3912:	89 55 f4             	mov    %edx,-0xc(%ebp)
      start = middle + 1;
    3915:	8d 50 01             	lea    0x1(%eax),%edx
      solution = start;
    3918:	db 45 f4             	fildl  -0xc(%ebp)
  while (start <= end) {
    391b:	39 ca                	cmp    %ecx,%edx
    391d:	7f 1e                	jg     393d <sqrt+0x4d>
    middle = (start + end) / 2;
    391f:	8d 34 0a             	lea    (%edx,%ecx,1),%esi
    3922:	89 f0                	mov    %esi,%eax
    3924:	c1 e8 1f             	shr    $0x1f,%eax
    3927:	01 f0                	add    %esi,%eax
    3929:	d1 f8                	sar    $1,%eax
    if (middle * middle == num) {
    392b:	89 c6                	mov    %eax,%esi
    392d:	0f af f0             	imul   %eax,%esi
    3930:	39 de                	cmp    %ebx,%esi
    3932:	74 4c                	je     3980 <sqrt+0x90>
    if (middle * middle < num) {
    3934:	7c da                	jl     3910 <sqrt+0x20>
    }
    else {
      end = middle - 1;
    3936:	8d 48 ff             	lea    -0x1(%eax),%ecx
  while (start <= end) {
    3939:	39 ca                	cmp    %ecx,%edx
    393b:	7e e2                	jle    391f <sqrt+0x2f>
  ...
  for (i = 0; i < 5; i++) {
    ...
    393d:	89 5d f4             	mov    %ebx,-0xc(%ebp)
    3940:	b8 05 00 00 00       	mov    $0x5,%eax
    3945:	db 45 f4             	fildl  -0xc(%ebp)
    3948:	d9 05 48 56 00 00    	flds   0x5648
    394e:	eb 02                	jmp    3952 <sqrt+0x62>
      solution += eps;
    3950:	dc c2                	fadd   %st,%st(2)
    while (solution * solution <= num) {
    3952:	d9 c2                	fld    %st(2)
    3954:	d8 cb                	fmul   %st(3),%st
    3956:	d9 ca                	fxch   %st(2)
    3958:	db f2                	fcomi  %st(2),%st
    395a:	dd da                	fstp   %st(2)
    395c:	73 f2                	jae    3950 <sqrt+0x60>
    }
    solution = solution - eps;
    395e:	dc ea                	fsubr  %st,%st(2)
    eps = eps / 10;
    3960:	d8 35 4c 56 00 00    	fdivs  0x564c
  for (i = 0; i < 5; i++) {
    3966:	83 e8 01             	sub    $0x1,%eax
    3969:	75 e7                	jne    3952 <sqrt+0x62>
    396b:	dd d8                	fstp   %st(0)
    396d:	dd d8                	fstp   %st(0)
  }
  return solution;

}
    396f:	83 c4 04             	add    $0x4,%esp
    3972:	5b                   	pop    %ebx
    3973:	5e                   	pop    %esi
    3974:	5d                   	pop    %ebp
    3975:	c3                   	ret
    3976:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
    397d:	00 
    397e:	66 90                	xchg   %ax,%ax
    3980:	dd d8                	fstp   %st(0)
      solution = middle;
    3982:	89 45 f4             	mov    %eax,-0xc(%ebp)
    3985:	db 45 f4             	fildl  -0xc(%ebp)
      break;
    3988:	eb b3                	jmp    393d <sqrt+0x4d>
  float solution = 0.0;
    398a:	d9 ee                	fldz
    398c:	eb af                	jmp    393d <sqrt+0x4d>
...
00003a46 <setpgid>:
SYSCALL(setpgid)
    3a46:	b8 18 00 00 00       	mov    $0x18,%eax
    3a4b:	cd 40                	int    $0x40
    3a4d:	c3                   	ret

00003a4e <getppid>:
SYSCALL(getppid)
    3a4e:	b8 19 00 00 00       	mov    $0x19,%eax
    3a53:	cd 40                	int    $0x40
    3a55:	c3                   	ret

00003a56 <uptime_ms>:
SYSCALL(uptime_ms)
    3a56:	b8 1a 00 00 00       	mov    $0x1a,%eax
    3a5b:	cd 40                	int    $0x40
    3a5d:	c3                   	ret

00003a5e <setpriority>:
    3a5e:	b8 1b 00 00 00       	mov    $0x1b,%eax
    3a63:	cd 40                	int    $0x40
    3a65:	c3                   	ret
    ...
    3a70:	66 90                	xchg   %ax,%ax
    3a72:	66 90                	xchg   %ax,%ax
    3a74:	66 90                	xchg   %ax,%ax
    3a76:	66 90                	xchg   %ax,%ax
    3a78:	66 90                	xchg   %ax,%ax
    3a7a:	66 90                	xchg   %ax,%ax
    3a7c:	66 90                	xchg   %ax,%ax
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  if(sgn && xx < 0){
    neg = 1;
    x = -xx;
    3a88:	89 d1                	mov    %edx,%ecx
{
    3a8a:	83 ec 3c             	sub    $0x3c,%esp
    3a8d:	89 45 c4             	mov    %eax,-0x3c(%ebp)
  if(sgn && xx < 0){
    3a90:	85 d2                	test   %edx,%edx
    3a92:	0f 89 98 00 00 00    	jns    3b30 <printint+0xb0>
    3a98:	f6 45 08 01          	testb  $0x1,0x8(%ebp)
    3a9c:	0f 84 8e 00 00 00    	je     3b30 <printint+0xb0>
    x = -xx;
    3aa2:	f7 d9                	neg    %ecx
    neg = 1;
    3aa4:	b8 01 00 00 00       	mov    $0x1,%eax
  } else {
    x = xx;
  }

  i = 0;
    3aa9:	89 45 c0             	mov    %eax,-0x40(%ebp)
    3aac:	31 f6                	xor    %esi,%esi
    3aae:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
    3ab5:	00 
    3ab6:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
    3abd:	00 
  ...
  do{
    ...
    3ac4:	89 f7                	mov    %esi,%edi
    3ac6:	f7 f3                	div    %ebx
    3ac8:	8d 76 01             	lea    0x1(%esi),%esi
    3acb:	0f b6 92 a8 56 00 00 	movzbl 0x56a8(%edx),%edx
    3ad2:	88 54 35 d7          	mov    %dl,-0x29(%ebp,%esi,1)
  }while((x /= base) != 0);
    3ad6:	89 ca                	mov    %ecx,%edx
    3ad8:	89 c1                	mov    %eax,%ecx
    3ada:	39 da                	cmp    %ebx,%edx
    3adc:	73 e2                	jae    3ac0 <printint+0x40>
  if(neg)
    3ade:	8b 45 c0             	mov    -0x40(%ebp),%eax
    3ae1:	85 c0                	test   %eax,%eax
    3ae3:	74 07                	je     3aec <printint+0x6c>
    buf[i++] = '-';
    3ae5:	c6 44 35 d8 2d       	movb   $0x2d,-0x28(%ebp,%esi,1)
    3aea:	89 f7                	mov    %esi,%edi

  while(--i >= 0)
    3aec:	8d 5d d8             	lea    -0x28(%ebp),%ebx
    3aef:	8b 75 c4             	mov    -0x3c(%ebp),%esi
    3af2:	01 df                	add    %ebx,%edi
    3af4:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
    3afb:	00 
    3afc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    putc(fd, buf[i]);
    3b00:	0f b6 07             	movzbl (%edi),%eax
  write(fd, &c, 1);
    3b03:	83 ec 04             	sub    $0x4,%esp
    3b06:	88 45 d7             	mov    %al,-0x29(%ebp)
    3b09:	8d 45 d7             	lea    -0x29(%ebp),%eax
    3b0c:	6a 01                	push   $0x1
    3b0e:	50                   	push   %eax
    3b0f:	56                   	push   %esi
    3b10:	e8 a1 fe ff ff       	call   39b6 <write>
  while(--i >= 0)
    3b15:	89 f8                	mov    %edi,%eax
    3b17:	83 c4 10             	add    $0x10,%esp
    3b1a:	83 ef 01             	sub    $0x1,%edi
    3b1d:	39 d8                	cmp    %ebx,%eax
    3b1f:	75 df                	jne    3b00 <printint+0x80>
}
    3b21:	8d 65 f4             	lea    -0xc(%ebp),%esp
    3b24:	5b                   	pop    %ebx
    3b25:	5e                   	pop    %esi
    3b26:	5f                   	pop    %edi
    3b27:	5d                   	pop    %ebp
  ...
  neg = 0;
    ...
    3b32:	e9 72 ff ff ff       	jmp    3aa9 <printint+0x29>
    3b37:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
    3b3e:	00 
    3b3f:	90                   	nop
...
printf(int fd, const char *fmt, ...)
{
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    3b49:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
    3b4c:	8b 75 08             	mov    0x8(%ebp),%esi
  for(i = 0; fmt[i]; i++){
    3b4f:	0f b6 13             	movzbl (%ebx),%edx
    3b52:	83 c3 01             	add    $0x1,%ebx
    3b55:	84 d2                	test   %dl,%dl
    3b57:	0f 84 a0 00 00 00    	je     3bfd <printf+0xbd>
    3b5d:	8d 45 10             	lea    0x10(%ebp),%eax
    3b60:	89 45 d4             	mov    %eax,-0x2c(%ebp)
    c = fmt[i] & 0xff;
    3b63:	8b 7d d4             	mov    -0x2c(%ebp),%edi
    3b66:	0f b6 c2             	movzbl %dl,%eax
    if(state == 0){
    3b69:	eb 28                	jmp    3b93 <printf+0x53>
    3b6b:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
  write(fd, &c, 1);
    3b70:	83 ec 04             	sub    $0x4,%esp
    3b73:	8d 45 e7             	lea    -0x19(%ebp),%eax
    3b76:	88 55 e7             	mov    %dl,-0x19(%ebp)
  for(i = 0; fmt[i]; i++){
    3b79:	83 c3 01             	add    $0x1,%ebx
  write(fd, &c, 1);
    3b7c:	6a 01                	push   $0x1
    3b7e:	50                   	push   %eax
    3b7f:	56                   	push   %esi
    3b80:	e8 31 fe ff ff       	call   39b6 <write>
  for(i = 0; fmt[i]; i++){
    3b85:	0f b6 53 ff          	movzbl -0x1(%ebx),%edx
    3b89:	83 c4 10             	add    $0x10,%esp
    3b8c:	84 d2                	test   %dl,%dl
    3b8e:	74 6d                	je     3bfd <printf+0xbd>
    c = fmt[i] & 0xff;
    3b90:	0f b6 c2             	movzbl %dl,%eax
      if(c == '%'){
    3b93:	83 f8 25             	cmp    $0x25,%eax
    3b96:	75 d8                	jne    3b70 <printf+0x30>
  for(i = 0; fmt[i]; i++){
    3b98:	0f b6 13             	movzbl (%ebx),%edx
    3b9b:	84 d2                	test   %dl,%dl
    3b9d:	74 5e                	je     3bfd <printf+0xbd>
    c = fmt[i] & 0xff;
    3b9f:	0f b6 c2             	movzbl %dl,%eax
        state = '%';
      } else {
        putc(fd, c);
      }
      ...
      if(c == 'd'){
    3ba2:	80 fa 25             	cmp    $0x25,%dl
    3ba5:	0f 84 1d 01 00 00    	je     3cc8 <printf+0x188>
    3bab:	83 e8 63             	sub    $0x63,%eax
    3bae:	83 f8 15             	cmp    $0x15,%eax
    3bb1:	77 0d                	ja     3bc0 <printf+0x80>
    3bb3:	ff 24 85 50 56 00 00 	jmp    *0x5650(,%eax,4)
    3bba:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  write(fd, &c, 1);
    3bc0:	83 ec 04             	sub    $0x4,%esp
    3bc3:	8d 4d e7             	lea    -0x19(%ebp),%ecx
    3bc6:	88 55 d0             	mov    %dl,-0x30(%ebp)
        ap++;
      } else if(c == '%'){
        putc(fd, c);
      } else {
        ...
        putc(fd, '%');
    3bc9:	c6 45 e7 25          	movb   $0x25,-0x19(%ebp)
  write(fd, &c, 1);
    3bcd:	6a 01                	push   $0x1
    3bcf:	51                   	push   %ecx
    3bd0:	89 4d d4             	mov    %ecx,-0x2c(%ebp)
    3bd3:	56                   	push   %esi
    3bd4:	e8 dd fd ff ff       	call   39b6 <write>
        putc(fd, c);
    3bd9:	0f b6 55 d0          	movzbl -0x30(%ebp),%edx
  write(fd, &c, 1);
    3bdd:	83 c4 0c             	add    $0xc,%esp
    3be0:	88 55 e7             	mov    %dl,-0x19(%ebp)
    3be3:	6a 01                	push   $0x1
    3be5:	8b 4d d4             	mov    -0x2c(%ebp),%ecx
    3be8:	51                   	push   %ecx
    3be9:	56                   	push   %esi
    3bea:	e8 c7 fd ff ff       	call   39b6 <write>
  for(i = 0; fmt[i]; i++){
    3bef:	0f b6 53 01          	movzbl 0x1(%ebx),%edx
    3bf3:	83 c3 02             	add    $0x2,%ebx
    3bf6:	83 c4 10             	add    $0x10,%esp
    3bf9:	84 d2                	test   %dl,%dl
    3bfb:	75 93                	jne    3b90 <printf+0x50>
      }
      state = 0;
    }
  }
}
    3bfd:	8d 65 f4             	lea    -0xc(%ebp),%esp
    3c00:	5b                   	pop    %ebx
    3c01:	5e                   	pop    %esi
    3c02:	5f                   	pop    %edi
    3c03:	5d                   	pop    %ebp
    3c04:	c3                   	ret
    3c05:	8d 76 00             	lea    0x0(%esi),%esi
        printint(fd, *ap, 16, 0);
    3c08:	83 ec 0c             	sub    $0xc,%esp
    3c0b:	8b 17                	mov    (%edi),%edx
    3c0d:	b9 10 00 00 00       	mov    $0x10,%ecx
    3c12:	89 f0                	mov    %esi,%eax
    3c14:	6a 00                	push   $0x0
        ap++;
    3c16:	83 c7 04             	add    $0x4,%edi
        printint(fd, *ap, 16, 0);
    3c19:	e8 62 fe ff ff       	call   3a80 <printint>
  for(i = 0; fmt[i]; i++){
    3c1e:	eb cf                	jmp    3bef <printf+0xaf>
        s = (char*)*ap;
    3c20:	8b 07                	mov    (%edi),%eax
        ap++;
    3c22:	83 c7 04             	add    $0x4,%edi
        if(s == 0)
    3c25:	85 c0                	test   %eax,%eax
    3c27:	0f 84 b3 00 00 00    	je     3ce0 <printf+0x1a0>
        while(*s != 0){
    3c2d:	0f b6 10             	movzbl (%eax),%edx
    3c30:	84 d2                	test   %dl,%dl
    3c32:	0f 84 ba 00 00 00    	je     3cf2 <printf+0x1b2>
    3c38:	89 7d d4             	mov    %edi,-0x2c(%ebp)
    3c3b:	89 c7                	mov    %eax,%edi
    3c3d:	89 d0                	mov    %edx,%eax
    3c3f:	8d 4d e7             	lea    -0x19(%ebp),%ecx
    3c42:	89 5d d0             	mov    %ebx,-0x30(%ebp)
    3c45:	89 fb                	mov    %edi,%ebx
    3c47:	89 cf                	mov    %ecx,%edi
    3c49:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  write(fd, &c, 1);
    3c50:	83 ec 04             	sub    $0x4,%esp
    3c53:	88 45 e7             	mov    %al,-0x19(%ebp)
          s++;
    3c56:	83 c3 01             	add    $0x1,%ebx
  write(fd, &c, 1);
    3c59:	6a 01                	push   $0x1
    3c5b:	57                   	push   %edi
    3c5c:	56                   	push   %esi
    3c5d:	e8 54 fd ff ff       	call   39b6 <write>
        while(*s != 0){
    3c62:	0f b6 03             	movzbl (%ebx),%eax
    3c65:	83 c4 10             	add    $0x10,%esp
    3c68:	84 c0                	test   %al,%al
    3c6a:	75 e4                	jne    3c50 <printf+0x110>
    3c6c:	8b 5d d0             	mov    -0x30(%ebp),%ebx
  for(i = 0; fmt[i]; i++){
    3c6f:	0f b6 53 01          	movzbl 0x1(%ebx),%edx
    3c73:	83 c3 02             	add    $0x2,%ebx
    3c76:	84 d2                	test   %dl,%dl
    3c78:	0f 85 e5 fe ff ff    	jne    3b63 <printf+0x23>
    3c7e:	e9 7a ff ff ff       	jmp    3bfd <printf+0xbd>
    3c83:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
        printint(fd, *ap, 10, 1);
    3c88:	83 ec 0c             	sub    $0xc,%esp
    3c8b:	8b 17                	mov    (%edi),%edx
    3c8d:	b9 0a 00 00 00       	mov    $0xa,%ecx
    3c92:	89 f0                	mov    %esi,%eax
    3c94:	6a 01                	push   $0x1
        ap++;
    3c96:	83 c7 04             	add    $0x4,%edi
        printint(fd, *ap, 10, 1);
    3c99:	e8 e2 fd ff ff       	call   3a80 <printint>
  for(i = 0; fmt[i]; i++){
    3c9e:	e9 4c ff ff ff       	jmp    3bef <printf+0xaf>
    3ca3:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
        putc(fd, *ap);
    3ca8:	8b 07                	mov    (%edi),%eax
  write(fd, &c, 1);
    3caa:	83 ec 04             	sub    $0x4,%esp
    3cad:	8d 4d e7             	lea    -0x19(%ebp),%ecx
        ap++;
    3cb0:	83 c7 04             	add    $0x4,%edi
        putc(fd, *ap);
    3cb3:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
    3cb6:	6a 01                	push   $0x1
    3cb8:	51                   	push   %ecx
    3cb9:	56                   	push   %esi
    3cba:	e8 f7 fc ff ff       	call   39b6 <write>
  for(i = 0; fmt[i]; i++){
    3cbf:	e9 2b ff ff ff       	jmp    3bef <printf+0xaf>
    3cc4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  write(fd, &c, 1);
    3cc8:	83 ec 04             	sub    $0x4,%esp
    3ccb:	88 55 e7             	mov    %dl,-0x19(%ebp)
    3cce:	8d 4d e7             	lea    -0x19(%ebp),%ecx
    3cd1:	6a 01                	push   $0x1
    3cd3:	e9 10 ff ff ff       	jmp    3be8 <printf+0xa8>
    3cd8:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
    3cdf:	00 
          s = "(null)";
    3ce0:	89 7d d4             	mov    %edi,-0x2c(%ebp)
    3ce3:	b8 28 00 00 00       	mov    $0x28,%eax
    3ce8:	bf c9 4e 00 00       	mov    $0x4ec9,%edi
    3ced:	e9 4d ff ff ff       	jmp    3c3f <printf+0xff>
  for(i = 0; fmt[i]; i++){
    3cf2:	0f b6 53 01          	movzbl 0x1(%ebx),%edx
    3cf6:	83 c3 02             	add    $0x2,%ebx
    3cf9:	84 d2                	test   %dl,%dl
    3cfb:	0f 85 8f fe ff ff    	jne    3b90 <printf+0x50>
    3d01:	e9 f7 fe ff ff       	jmp    3bfd <printf+0xbd>
    3d06:	66 90                	xchg   %ax,%ax
    3d08:	66 90                	xchg   %ax,%ax
    3d0a:	66 90                	xchg   %ax,%ax
    3d0c:	66 90                	xchg   %ax,%ax
    3d0e:	66 90                	xchg   %ax,%ax
    3d10:	66 90                	xchg   %ax,%ax
    3d12:	66 90                	xchg   %ax,%ax
    3d14:	66 90                	xchg   %ax,%ax
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3d21:	a1 80 9e 00 00       	mov    0x9e80,%eax
{
    3d26:	89 e5                	mov    %esp,%ebp
    3d28:	57                   	push   %edi
    3d29:	56                   	push   %esi
    3d2a:	53                   	push   %ebx
    3d2b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  bp = (Header*)ap - 1;
    3d2e:	8d 4b f8             	lea    -0x8(%ebx),%ecx
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3d31:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
    3d38:	00 
    3d39:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    3d40:	89 c2                	mov    %eax,%edx
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    3d42:	8b 00                	mov    (%eax),%eax
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3d44:	39 ca                	cmp    %ecx,%edx
    3d46:	73 30                	jae    3d78 <free+0x58>
    3d48:	39 c1                	cmp    %eax,%ecx
    3d4a:	72 04                	jb     3d50 <free+0x30>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    3d4c:	39 c2                	cmp    %eax,%edx
    3d4e:	72 f0                	jb     3d40 <free+0x20>
      break;
  if(bp + bp->s.size == p->s.ptr){
    3d50:	8b 73 fc             	mov    -0x4(%ebx),%esi
    3d53:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
    3d56:	39 f8                	cmp    %edi,%eax
    3d58:	74 36                	je     3d90 <free+0x70>
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
    3d5a:	89 43 f8             	mov    %eax,-0x8(%ebx)
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    3d5d:	8b 42 04             	mov    0x4(%edx),%eax
    3d60:	8d 34 c2             	lea    (%edx,%eax,8),%esi
    3d63:	39 f1                	cmp    %esi,%ecx
    3d65:	74 40                	je     3da7 <free+0x87>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
    3d67:	89 0a                	mov    %ecx,(%edx)
  } else
    p->s.ptr = bp;
  freep = p;
}
    3d69:	5b                   	pop    %ebx
  freep = p;
    3d6a:	89 15 80 9e 00 00    	mov    %edx,0x9e80
}
    3d70:	5e                   	pop    %esi
    3d71:	5f                   	pop    %edi
    3d72:	5d                   	pop    %ebp
    ...
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    3d78:	39 c2                	cmp    %eax,%edx
    3d7a:	72 c4                	jb     3d40 <free+0x20>
    3d7c:	39 c1                	cmp    %eax,%ecx
    3d7e:	73 c0                	jae    3d40 <free+0x20>
  if(bp + bp->s.size == p->s.ptr){
    3d80:	8b 73 fc             	mov    -0x4(%ebx),%esi
    3d83:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
    3d86:	39 f8                	cmp    %edi,%eax
    3d88:	75 d0                	jne    3d5a <free+0x3a>
    3d8a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    bp->s.size += p->s.ptr->s.size;
    3d90:	03 70 04             	add    0x4(%eax),%esi
    3d93:	89 73 fc             	mov    %esi,-0x4(%ebx)
    bp->s.ptr = p->s.ptr->s.ptr;
    3d96:	8b 02                	mov    (%edx),%eax
    3d98:	8b 00                	mov    (%eax),%eax
    3d9a:	89 43 f8             	mov    %eax,-0x8(%ebx)
  if(p + p->s.size == bp){
    3d9d:	8b 42 04             	mov    0x4(%edx),%eax
    3da0:	8d 34 c2             	lea    (%edx,%eax,8),%esi
    3da3:	39 f1                	cmp    %esi,%ecx
    3da5:	75 c0                	jne    3d67 <free+0x47>
    p->s.size += bp->s.size;
    3da7:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
    3daa:	89 15 80 9e 00 00    	mov    %edx,0x9e80
    p->s.size += bp->s.size;
    3db0:	89 42 04             	mov    %eax,0x4(%edx)
    p->s.ptr = bp->s.ptr;
    3db3:	8b 4b f8             	mov    -0x8(%ebx),%ecx
    3db6:	89 0a                	mov    %ecx,(%edx)
}
    3db8:	5b                   	pop    %ebx
    3db9:	5e                   	pop    %esi
    3dba:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    3dcc:	8b 15 80 9e 00 00    	mov    0x9e80,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    3dd2:	8d 78 07             	lea    0x7(%eax),%edi
    3dd5:	c1 ef 03             	shr    $0x3,%edi
    3dd8:	83 c7 01             	add    $0x1,%edi
  if((prevp = freep) == 0){
    3ddb:	85 d2                	test   %edx,%edx
    3ddd:	0f 84 8d 00 00 00    	je     3e70 <malloc+0xb0>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3de3:	8b 02                	mov    (%edx),%eax
    if(p->s.size >= nunits){
    3de5:	8b 48 04             	mov    0x4(%eax),%ecx
    3de8:	39 f9                	cmp    %edi,%ecx
    3dea:	73 64                	jae    3e50 <malloc+0x90>
  if(nu < 4096)
    3dec:	bb 00 10 00 00       	mov    $0x1000,%ebx
    3df1:	39 df                	cmp    %ebx,%edi
    3df3:	0f 43 df             	cmovae %edi,%ebx
  p = sbrk(nu * sizeof(Header));
    3df6:	8d 34 dd 00 00 00 00 	lea    0x0(,%ebx,8),%esi
    3dfd:	eb 0a                	jmp    3e09 <malloc+0x49>
    3dff:	90                   	nop
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3e00:	8b 02                	mov    (%edx),%eax
    if(p->s.size >= nunits){
    3e02:	8b 48 04             	mov    0x4(%eax),%ecx
    3e05:	39 f9                	cmp    %edi,%ecx
    3e07:	73 47                	jae    3e50 <malloc+0x90>
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    3e09:	89 c2                	mov    %eax,%edx
    3e0b:	39 05 80 9e 00 00    	cmp    %eax,0x9e80
    3e11:	75 ed                	jne    3e00 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
    3e13:	83 ec 0c             	sub    $0xc,%esp
    3e16:	56                   	push   %esi
    3e17:	e8 02 fc ff ff       	call   3a1e <sbrk>
  if(p == (char*)-1)
    3e1c:	83 c4 10             	add    $0x10,%esp
    3e1f:	83 f8 ff             	cmp    $0xffffffff,%eax
    3e22:	74 1c                	je     3e40 <malloc+0x80>
  hp->s.size = nu;
    3e24:	89 58 04             	mov    %ebx,0x4(%eax)
  free((void*)(hp + 1));
    3e27:	83 ec 0c             	sub    $0xc,%esp
    3e2a:	83 c0 08             	add    $0x8,%eax
    3e2d:	50                   	push   %eax
    3e2e:	e8 ed fe ff ff       	call   3d20 <free>
  return freep;
    3e33:	8b 15 80 9e 00 00    	mov    0x9e80,%edx
      if((p = morecore(nunits)) == 0)
    3e39:	83 c4 10             	add    $0x10,%esp
    3e3c:	85 d2                	test   %edx,%edx
    3e3e:	75 c0                	jne    3e00 <malloc+0x40>
        return 0;
  }
}
    3e40:	8d 65 f4             	lea    -0xc(%ebp),%esp
        return 0;
    ...
    3e4a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      if(p->s.size == nunits)
    3e50:	39 cf                	cmp    %ecx,%edi
    3e52:	74 4c                	je     3ea0 <malloc+0xe0>
        p->s.size -= nunits;
    3e54:	29 f9                	sub    %edi,%ecx
    3e56:	89 48 04             	mov    %ecx,0x4(%eax)
        p += p->s.size;
    3e59:	8d 04 c8             	lea    (%eax,%ecx,8),%eax
        p->s.size = nunits;
    3e5c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    3e5f:	89 15 80 9e 00 00    	mov    %edx,0x9e80
}
    3e65:	8d 65 f4             	lea    -0xc(%ebp),%esp
      return (void*)(p + 1);
    3e68:	83 c0 08             	add    $0x8,%eax
}
    3e6b:	5b                   	pop    %ebx
    3e6c:	5e                   	pop    %esi
    3e6d:	5f                   	pop    %edi
    ...
    3e6f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
    3e70:	c7 05 80 9e 00 00 84 	movl   $0x9e84,0x9e80
    3e77:	9e 00 00 
    base.s.size = 0;
    3e7a:	b8 84 9e 00 00       	mov    $0x9e84,%eax
    base.s.ptr = freep = prevp = &base;
    3e7f:	c7 05 84 9e 00 00 84 	movl   $0x9e84,0x9e84
    3e86:	9e 00 00 
    base.s.size = 0;
    3e89:	c7 05 88 9e 00 00 00 	movl   $0x0,0x9e88
    3e90:	00 00 00 
    if(p->s.size >= nunits){
    3e93:	e9 54 ff ff ff       	jmp    3dec <malloc+0x2c>
    3e98:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
    3e9f:	00 
        prevp->s.ptr = p->s.ptr;
    3ea0:	8b 08                	mov    (%eax),%ecx
    3ea2:	89 0a                	mov    %ecx,(%edx)
    3ea4:	eb b9                	jmp    3e5f <malloc+0x9f>
