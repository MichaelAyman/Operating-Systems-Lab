...
float sqrt(int num) {
 ...
 328:	d9 05 c4 08 00 00    	flds   0x8c4
 ...
 33e:	dc ea                	fsubr  %st,%st(2)
    eps = eps / 10;
 340:	d8 35 c8 08 00 00    	fdivs  0x8c8
  for (i = 0; i < 5; i++) {
 ...
 468:	89 d1                	mov    %edx,%ecx
{
 ...
 4ab:	0f b6 92 24 09 00 00 	movzbl 0x924(%edx),%edx
 ...
 529:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 593:	ff 24 85 cc 08 00 00 	jmp    *0x8cc(,%eax,4)
 ...
 6c8:	bf bb 08 00 00       	mov    $0x8bb,%edi
...
free(void *ap)
{
 ...
 701:	a1 38 09 00 00       	mov    0x938,%eax
{
 ...
 749:	5b                   	pop    %ebx
  freep = p;
 74a:	89 15 38 09 00 00    	mov    %edx,0x938
}
 750:	5e                   	pop    %esi
 751:	5f                   	pop    %edi
 752:	5d                   	pop    %ebp
 ...
 787:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 78a:	89 15 38 09 00 00    	mov    %edx,0x938
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7ac:	8b 15 38 09 00 00    	mov    0x938,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7eb:	39 05 38 09 00 00    	cmp    %eax,0x938
 ...
 80e:	e8 ed fe ff ff       	call   700 <free>
  return freep;
 813:	8b 15 38 09 00 00    	mov    0x938,%edx
 ...
 83c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 83f:	89 15 38 09 00 00    	mov    %edx,0x938
}
 ...
 84f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 850:	c7 05 38 09 00 00 3c 	movl   $0x93c,0x938
 857:	09 00 00 
    base.s.size = 0;
 85a:	b8 3c 09 00 00       	mov    $0x93c,%eax
    base.s.ptr = freep = prevp = &base;
 85f:	c7 05 3c 09 00 00 3c 	movl   $0x93c,0x93c
 866:	09 00 00 
    base.s.size = 0;
 869:	c7 05 40 09 00 00 00 	movl   $0x0,0x940
 870:	00 00 00 
    if(p->s.size >= nunits){
