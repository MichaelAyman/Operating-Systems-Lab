...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	push   (%ebx)
  35:	e8 aa 03 00 00       	call   3e4 <mkdir>
  ...
  exit();
  4b:	e8 2c 03 00 00       	call   37c <exit>
      printf(2, "mkdir: %s failed to create\n", argv[i]);
  50:	50                   	push   %eax
  51:	ff 33                	push   (%ebx)
  ...
  6d:	e8 8e 04 00 00       	call   500 <printf>
    exit();
  72:	e8 05 03 00 00       	call   37c <exit>
  77:	66 90                	xchg   %ax,%ax
  79:	66 90                	xchg   %ax,%ax
  7b:	66 90                	xchg   %ax,%ax
  7d:	66 90                	xchg   %ax,%ax
...
float sqrt(int num) {
 ...
 333:	d9 05 5c 08 00 00    	flds   0x85c
 ...
 34e:	dc ea                	fsubr  %st,%st(2)
    eps = eps / 10;
 350:	d8 35 60 08 00 00    	fdivs  0x860
  for (i = 0; i < 5; i++) {
 ...
 45c:	89 d1                	mov    %edx,%ecx
{
 ...
 489:	0f b6 92 c4 08 00 00 	movzbl 0x8c4(%edx),%edx
 ...
 509:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 579:	ff 24 85 6c 08 00 00 	jmp    *0x86c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 687:	90                   	nop
          s = "(null)";
 688:	ba 64 08 00 00       	mov    $0x864,%edx
        while(*s != 0){
