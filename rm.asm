...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	push   (%ebx)
  35:	e8 92 03 00 00       	call   3cc <unlink>
...
float sqrt(int num) {
 ...
 333:	d9 05 68 08 00 00    	flds   0x868
 ...
 34e:	dc ea                	fsubr  %st,%st(2)
    eps = eps / 10;
 350:	d8 35 6c 08 00 00    	fdivs  0x86c
  for (i = 0; i < 5; i++) {
...
free(void *ap)
{
 ...
 6b1:	a1 b4 0b 00 00       	mov    0xbb4,%eax
{
 ...
 6f1:	5b                   	pop    %ebx
  freep = p;
 6f2:	89 15 b4 0b 00 00    	mov    %edx,0xbb4
}
 6f8:	5e                   	pop    %esi
 6f9:	5f                   	pop    %edi
 6fa:	5d                   	pop    %ebp
 ...
 729:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 72c:	89 15 b4 0b 00 00    	mov    %edx,0xbb4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 749:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 74c:	8b 3d b4 0b 00 00    	mov    0xbb4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 78f:	73 4f                	jae    7e0 <malloc+0xa0>
    ...
    if(p == freep)
 791:	8b 3d b4 0b 00 00    	mov    0xbb4,%edi
 ...
 7ba:	e8 f1 fe ff ff       	call   6b0 <free>
  return freep;
 7bf:	8b 15 b4 0b 00 00    	mov    0xbb4,%edx
 ...
 7ec:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7ef:	89 15 b4 0b 00 00    	mov    %edx,0xbb4
}
