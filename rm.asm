...
float sqrt(int num) {
 ...
 328:	d9 05 bc 08 00 00    	flds   0x8bc
 ...
 33e:	dc ea                	fsubr  %st,%st(2)
    eps = eps / 10;
 340:	d8 35 c0 08 00 00    	fdivs  0x8c0
  for (i = 0; i < 5; i++) {
 ...
 468:	89 d1                	mov    %edx,%ecx
{
 ...
 4ab:	0f b6 92 1c 09 00 00 	movzbl 0x91c(%edx),%edx
 ...
 529:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 593:	ff 24 85 c4 08 00 00 	jmp    *0x8c4(,%eax,4)
 ...
 6c8:	bf b5 08 00 00       	mov    $0x8b5,%edi
...
free(void *ap)
{
 ...
 701:	a1 30 09 00 00       	mov    0x930,%eax
{
 ...
 749:	5b                   	pop    %ebx
  freep = p;
 74a:	89 15 30 09 00 00    	mov    %edx,0x930
}
 750:	5e                   	pop    %esi
 751:	5f                   	pop    %edi
 752:	5d                   	pop    %ebp
 ...
 787:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 78a:	89 15 30 09 00 00    	mov    %edx,0x930
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7ac:	8b 15 30 09 00 00    	mov    0x930,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7eb:	39 05 30 09 00 00    	cmp    %eax,0x930
 ...
 80e:	e8 ed fe ff ff       	call   700 <free>
  return freep;
 813:	8b 15 30 09 00 00    	mov    0x930,%edx
 ...
 83c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 83f:	89 15 30 09 00 00    	mov    %edx,0x930
}
 ...
 84f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 850:	c7 05 30 09 00 00 34 	movl   $0x934,0x930
 857:	09 00 00 
    base.s.size = 0;
 85a:	b8 34 09 00 00       	mov    $0x934,%eax
    base.s.ptr = freep = prevp = &base;
 85f:	c7 05 34 09 00 00 34 	movl   $0x934,0x934
 866:	09 00 00 
    base.s.size = 0;
 869:	c7 05 38 09 00 00 00 	movl   $0x0,0x938
 870:	00 00 00 
    if(p->s.size >= nunits){
