...
80100172:	e8 39 46 00 00       	call   801047b0 <release>
      acquiresleep(&b->lock);
80100177:	8d 43 0c             	lea    0xc(%ebx),%eax
8010017a:	89 04 24             	mov    %eax,(%esp)
8010017d:	e8 8e 43 00 00       	call   80104510 <acquiresleep>
      return b;
...
801001ce:	e8 dd 43 00 00       	call   801045b0 <holdingsleep>
...
8010020f:	e8 9c 43 00 00       	call   801045b0 <holdingsleep>
...
8010021f:	e8 4c 43 00 00       	call   80104570 <releasesleep>

  acquire(&bcache.lock);
80100224:	c7 04 24 20 a5 10 80 	movl   $0x8010a520,(%esp)
8010022b:	e8 e0 45 00 00       	call   80104810 <acquire>
  b->refcnt--;
...
80100278:	5d                   	pop    %ebp
  release(&bcache.lock);
80100279:	e9 32 45 00 00       	jmp    801047b0 <release>
    panic("brelse");
...
801002c0:	e8 4b 45 00 00       	call   80104810 <acquire>
  while(n > 0){
...
80100307:	8b 48 28             	mov    0x28(%eax),%ecx
...
80100316:	e8 95 44 00 00       	call   801047b0 <release>
        ilock(ip);
8010031b:	5a                   	pop    %edx
...
8010036c:	e8 3f 44 00 00       	call   801047b0 <release>
  ilock(ip);
80100371:	58                   	pop    %eax
...
801003e4:	e8 37 42 00 00       	call   80104620 <getcallerpcs>
  for(i=0; i<10; i++)
...
80100581:	e8 4a 44 00 00       	call   801049d0 <memmove>
    memset(crt+pos, 0, sizeof(crt[0])*(24*80 - pos));
...
80100596:	e8 a5 43 00 00       	call   80104940 <memset>
  outb(CRTPORT+1, pos);
...
801005eb:	e8 20 42 00 00       	call   80104810 <acquire>
  for(i = 0; i < n; i++)
...
80100627:	e8 84 41 00 00       	call   801047b0 <release>
  ilock(ip);
8010062c:	58                   	pop    %eax
...
801007f8:	e8 13 40 00 00       	call   80104810 <acquire>
  if (fmt == 0)
...
8010081b:	e8 90 3f 00 00       	call   801047b0 <release>
...
801008d3:	e8 38 3f 00 00       	call   80104810 <acquire>
  while((c = getc()) >= 0){
...
8010090d:	e8 9e 3e 00 00       	call   801047b0 <release>
  if(doprocdump) {
...
80100ab0:	e8 4b 3b 00 00       	call   80104600 <initlock>
...
80100d0a:	e8 31 3e 00 00       	call   80104b40 <strlen>
...
80100d18:	83 e3 fc             	and    $0xfffffffc,%ebx
    if(copyout(pgdir, sp, argv[argc], strlen(argv[argc]) + 1) < 0)
80100d1b:	e8 20 3e 00 00       	call   80104b40 <strlen>
...
80100ddb:	8d 46 70             	lea    0x70(%esi),%eax
80100dde:	50                   	push   %eax
80100ddf:	e8 1c 3d 00 00       	call   80104b00 <safestrcpy>
  curproc->pgdir = pgdir;
...
80100dfc:	8b 40 1c             	mov    0x1c(%eax),%eax
80100dff:	89 50 38             	mov    %edx,0x38(%eax)
  curproc->tf->esp = sp;
80100e02:	8b 41 1c             	mov    0x1c(%ecx),%eax
...
80100e90:	e8 6b 37 00 00       	call   80104600 <initlock>
}
...
80100eb1:	e8 5a 39 00 00       	call   80104810 <acquire>
...
80100ee1:	e8 ca 38 00 00       	call   801047b0 <release>
      return f;
    }
  }
  release(&ftable.lock);
...
80100efa:	e8 b1 38 00 00       	call   801047b0 <release>
}
...
80100f1f:	e8 ec 38 00 00       	call   80104810 <acquire>
  if(f->ref < 1)
...
80100f71:	e8 9a 38 00 00       	call   80104810 <acquire>
  if(f->ref < 1)
...
80100fac:	e8 ff 37 00 00       	call   801047b0 <release>
...
80100fdd:	5d                   	pop    %ebp
    release(&ftable.lock);
80100fde:	e9 cd 37 00 00       	jmp    801047b0 <release>
...
8010131d:	e8 1e 36 00 00       	call   80104940 <memset>
  log_write(bp);
...
801013cf:	e8 dc 33 00 00       	call   801047b0 <release>
...
801013fd:	e8 ae 33 00 00       	call   801047b0 <release>
      return ip;
...
801015b1:	e8 1a 34 00 00       	call   801049d0 <memmove>
  brelse(bp);
...
801015e6:	e8 15 30 00 00       	call   80104600 <initlock>
  for(i = 0; i < NINODE; i++) {
...
8010162c:	e8 9f 33 00 00       	call   801049d0 <memmove>
  brelse(bp);
...
801016fe:	e8 3d 32 00 00       	call   80104940 <memset>
      dip->type = type;
...
801017a1:	e8 2a 32 00 00       	call   801049d0 <memmove>
  log_write(bp);
...
801017cf:	e8 3c 30 00 00       	call   80104810 <acquire>
  ip->ref++;
...
80101888:	e8 43 31 00 00       	call   801049d0 <memmove>
    brelse(bp);
...
80101956:	e8 b5 2e 00 00       	call   80104810 <acquire>
  ip->ref--;
...
80101980:	e8 8b 2e 00 00       	call   80104810 <acquire>
    int r = ip->ref;
...
80101ba7:	e8 24 2e 00 00       	call   801049d0 <memmove>
    brelse(bp);
...
80101ca5:	e8 26 2d 00 00       	call   801049d0 <memmove>
    log_write(bp);
...
80101d2e:	e8 0d 2d 00 00       	call   80104a40 <strncmp>
}
80101d33:	c9                   	leave
80101d34:	c3                   	ret
...
80101d95:	e8 a6 2c 00 00       	call   80104a40 <strncmp>
      continue;
...
80101e1f:	83 ec 0c             	sub    $0xc,%esp
    ip = idup(myproc()->cwd);
80101e22:	8b 70 6c             	mov    0x6c(%eax),%esi
  acquire(&icache.lock);
80101e25:	68 60 f9 10 80       	push   $0x8010f960
80101e2a:	e8 e1 29 00 00       	call   80104810 <acquire>
  ip->ref++;
...
80101ea7:	e8 24 2b 00 00       	call   801049d0 <memmove>
...
80101f14:	e8 97 26 00 00       	call   801045b0 <holdingsleep>
...
80101f36:	e8 35 26 00 00       	call   80104570 <releasesleep>
  iput(ip);
...
80101f63:	e8 68 2a 00 00       	call   801049d0 <memmove>
    name[len] = 0;
...
80101fa5:	e8 06 26 00 00       	call   801045b0 <holdingsleep>
...
80101fbc:	e8 af 25 00 00       	call   80104570 <releasesleep>
  iput(ip);
...
80101ff5:	e8 b6 25 00 00       	call   801045b0 <holdingsleep>
...
8010200c:	e8 5f 25 00 00       	call   80104570 <releasesleep>
}
...
8010209d:	e8 ee 29 00 00       	call   80104a90 <strncpy>
  de.inum = inum;
...
80102230:	e8 cb 23 00 00       	call   80104600 <initlock>
...
801022ae:	e8 5d 25 00 00       	call   80104810 <acquire>
...
8010232b:	e8 80 24 00 00       	call   801047b0 <release>
...
8010234e:	e8 5d 22 00 00       	call   801045b0 <holdingsleep>
...
801023e5:	c9                   	leave
  release(&idelock);
801023e6:	e9 c5 23 00 00       	jmp    801047b0 <release>
...
80102572:	e8 c9 23 00 00       	call   80104940 <memset>
...
801025a8:	e8 63 22 00 00       	call   80104810 <acquire>
...
801026b5:	e8 46 1f 00 00       	call   80104600 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
80102748:	e8 c3 20 00 00       	call   80104810 <acquire>
  r = kmem.freelist;
...
80102773:	e8 38 20 00 00       	call   801047b0 <release>
}
...
80102bb2:	e8 c9 1d 00 00       	call   80104980 <memcmp>
...
80102ce4:	e8 e7 1c 00 00       	call   801049d0 <memmove>
...
80102da4:	e8 57 18 00 00       	call   80104600 <initlock>
  readsb(dev, &sb);
80102da9:	58                   	pop    %eax
...
80102e4b:	e8 c0 19 00 00       	call   80104810 <acquire>
...
80102e9c:	e8 0f 19 00 00       	call   801047b0 <release>
      break;
    }
  }
}
...
80102ebe:	e8 4d 19 00 00       	call   80104810 <acquire>
  log.outstanding -= 1;
...
80102efc:	e8 af 18 00 00       	call   801047b0 <release>
}
...
80102f16:	e8 f5 18 00 00       	call   80104810 <acquire>
    log.committing = 0;
...
80102f38:	e8 73 18 00 00       	call   801047b0 <release>
...
80102f94:	e8 37 1a 00 00       	call   801049d0 <memmove>
...
80102ff4:	e8 b7 17 00 00       	call   801047b0 <release>
...
80103052:	e8 b9 17 00 00       	call   80104810 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80103098:	c9                   	leave
  release(&log.lock);
80103099:	e9 12 17 00 00       	jmp    801047b0 <release>
...
801031a4:	e8 27 18 00 00       	call   801049d0 <memmove>
...
80103294:	e8 e7 16 00 00       	call   80104980 <memcmp>
...
8010334f:	e8 2c 16 00 00       	call   80104980 <memcmp>
...
80103488:	e8 f3 14 00 00       	call   80104980 <memcmp>
...
80103579:	e8 82 10 00 00       	call   80104600 <initlock>
  (*f0)->type = FD_PIPE;
...
801035ff:	e8 0c 12 00 00       	call   80104810 <acquire>
  if(writable){
...
80103643:	5d                   	pop    %ebp
    release(&p->lock);
80103644:	e9 67 11 00 00       	jmp    801047b0 <release>
...
80103674:	e8 37 11 00 00       	call   801047b0 <release>
    kfree((char*)p);
...
801036a0:	e8 6b 11 00 00       	call   80104810 <acquire>
  for(i = 0; i < n; i++){
...
801036f5:	8b 48 28             	mov    0x28(%eax),%ecx
...
80103734:	e8 77 10 00 00       	call   801047b0 <release>
        return -1;
...
80103790:	e8 1b 10 00 00       	call   801047b0 <release>
  return n;
...
801037c6:	e8 45 10 00 00       	call   80104810 <acquire>
...
801037e5:	8b 40 28             	mov    0x28(%eax),%eax
...
8010387e:	e8 2d 0f 00 00       	call   801047b0 <release>
  return i;
...
80103899:	e8 12 0f 00 00       	call   801047b0 <release>
      return -1;
...
801038d1:	e8 3a 0f 00 00       	call   80104810 <acquire>
...
80103901:	c7 43 0c 01 00 00 00 	movl   $0x1,0xc(%ebx)
  p->pid = nextpid++;
80103908:	89 43 10             	mov    %eax,0x10(%ebx)
8010390b:	8d 50 01             	lea    0x1(%eax),%edx
  release(&ptable.lock);
8010390e:	68 20 1d 11 80       	push   $0x80111d20
  p->pid = nextpid++;
80103913:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
80103919:	e8 92 0e 00 00       	call   801047b0 <release>

  // Allocate kernel stack.
  if((p->kstack = kalloc()) == 0){
8010391e:	e8 ed ed ff ff       	call   80102710 <kalloc>
80103923:	83 c4 10             	add    $0x10,%esp
80103926:	89 43 08             	mov    %eax,0x8(%ebx)
80103929:	85 c0                	test   %eax,%eax
8010392b:	74 6c                	je     80103999 <allocproc+0xd9>
    return 0;
  }
  ...
  sp -= sizeof *p->tf;
8010392d:	8d 90 b4 0f 00 00    	lea    0xfb4(%eax),%edx
  sp -= 4;
...
80103933:	83 ec 04             	sub    $0x4,%esp
  sp -= sizeof *p->context;
80103936:	05 9c 0f 00 00       	add    $0xf9c,%eax
  sp -= sizeof *p->tf;
8010393b:	89 53 1c             	mov    %edx,0x1c(%ebx)
  *(uint*)sp = (uint)trapret;
8010393e:	c7 40 14 3f 5c 10 80 	movl   $0x80105c3f,0x14(%eax)
  p->context = (struct context*)sp;
80103945:	89 43 20             	mov    %eax,0x20(%ebx)
  memset(p->context, 0, sizeof *p->context);
80103948:	6a 14                	push   $0x14
8010394a:	6a 00                	push   $0x0
8010394c:	50                   	push   %eax
8010394d:	e8 ee 0f 00 00       	call   80104940 <memset>
  p->context->eip = (uint)forkret;
80103952:	8b 43 20             	mov    0x20(%ebx),%eax
  p->pgid = p->pid;
  p->pr = 50;
  return p;
80103955:	83 c4 10             	add    $0x10,%esp
  p->context->eip = (uint)forkret;
80103958:	c7 40 10 b0 39 10 80 	movl   $0x801039b0,0x10(%eax)
  p->pgid = p->pid;
8010395f:	8b 43 10             	mov    0x10(%ebx),%eax
  p->pr = 50;
80103962:	c7 83 80 00 00 00 32 	movl   $0x32,0x80(%ebx)
80103969:	00 00 00 
  p->pgid = p->pid;
8010396c:	89 43 14             	mov    %eax,0x14(%ebx)
}
8010396f:	89 d8                	mov    %ebx,%eax
80103971:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80103974:	c9                   	leave
80103975:	c3                   	ret
...
8010398a:	e8 21 0e 00 00       	call   801047b0 <release>
  return 0;
...
801039bb:	e8 f0 0d 00 00       	call   801047b0 <release>
...
80103a10:	e8 eb 0b 00 00       	call   80104600 <initlock>
}
...
80103aa4:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103aa7:	e8 14 0c 00 00       	call   801046c0 <pushcli>
  c = mycpu();
80103aac:	e8 6f ff ff ff       	call   80103a20 <mycpu>
  p = c->proc;
80103ab1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103ab7:	e8 54 0c 00 00       	call   80104710 <popcli>
}
...
80103b13:	ff 73 1c             	push   0x1c(%ebx)
80103b16:	e8 25 0e 00 00       	call   80104940 <memset>
  p->tf->cs = (SEG_UCODE << 3) | DPL_USER;
80103b1b:	8b 43 1c             	mov    0x1c(%ebx),%eax
...
80103bc5:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103bc8:	e8 f3 0a 00 00       	call   801046c0 <pushcli>
  c = mycpu();
80103bcd:	e8 4e fe ff ff       	call   80103a20 <mycpu>
  p = c->proc;
80103bd2:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103bd8:	e8 33 0b 00 00       	call   80104710 <popcli>
  sz = curproc->sz;
...
80103c85:	0f 84 aa 00 00 00    	je     80103d35 <fork+0xf5>
  np->sz = curproc->sz;
80103c8b:	8b 03                	mov    (%ebx),%eax
80103c8d:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80103c90:	89 01                	mov    %eax,(%ecx)
  *np->tf = *curproc->tf;
80103c92:	8b 79 1c             	mov    0x1c(%ecx),%edi
  np->parent = curproc;
80103c95:	89 59 18             	mov    %ebx,0x18(%ecx)
  np->pgid = curproc->pgid;
80103c98:	8b 43 14             	mov    0x14(%ebx),%eax
80103c9b:	89 41 14             	mov    %eax,0x14(%ecx)
  *np->tf = *curproc->tf;
80103c9e:	89 c8                	mov    %ecx,%eax
80103ca0:	8b 73 1c             	mov    0x1c(%ebx),%esi
80103ca3:	b9 13 00 00 00       	mov    $0x13,%ecx
80103ca8:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  for(i = 0; i < NOFILE; i++)
80103caa:	31 f6                	xor    %esi,%esi
  np->tf->eax = 0;
80103cac:	8b 40 1c             	mov    0x1c(%eax),%eax
...
80103d3e:	e8 fd e7 ff ff       	call   80102540 <kfree>
    np->kstack = 0;
...
80103d59:	eb d0                	jmp    80103d2b <fork+0xeb>
...
80103dbb:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103dc2:	e8 94 0d 00 00       	call   80104b5b <swtch>
      switchkvm();
...
80103def:	e8 bc 09 00 00       	call   801047b0 <release>
    sti();
...
80103e2c:	74 4f                	je     80103e7d <sched+0x7d>
  if(mycpu()->ncli != 1)
80103e2e:	e8 ed fb ff ff       	call   80103a20 <mycpu>
...
80103e47:	75 41                	jne    80103e8a <sched+0x8a>
  intena = mycpu()->intena;
80103e49:	e8 d2 fb ff ff       	call   80103a20 <mycpu>
  swtch(&p->context, mycpu()->scheduler);
80103e4e:	83 c3 20             	add    $0x20,%ebx
  intena = mycpu()->intena;
80103e51:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103e57:	e8 c4 fb ff ff       	call   80103a20 <mycpu>
80103e5c:	83 ec 08             	sub    $0x8,%esp
80103e5f:	ff 70 04             	push   0x4(%eax)
80103e62:	53                   	push   %ebx
80103e63:	e8 f3 0c 00 00       	call   80104b5b <swtch>
  mycpu()->intena = intena;
80103e68:	e8 b3 fb ff ff       	call   80103a20 <mycpu>
}
...
80103e80:	68 51 78 10 80       	push   $0x80107851
80103e85:	e8 16 c5 ff ff       	call   801003a0 <panic>
    panic("sched interruptible");
80103e8a:	83 ec 0c             	sub    $0xc,%esp
80103e8d:	68 7d 78 10 80       	push   $0x8010787d
80103e92:	e8 09 c5 ff ff       	call   801003a0 <panic>
    panic("sched running");
80103e97:	83 ec 0c             	sub    $0xc,%esp
80103e9a:	68 6f 78 10 80       	push   $0x8010786f
80103e9f:	e8 fc c4 ff ff       	call   801003a0 <panic>
    panic("sched locks");
80103ea4:	83 ec 0c             	sub    $0xc,%esp
80103ea7:	68 63 78 10 80       	push   $0x80107863
80103eac:	e8 ef c4 ff ff       	call   801003a0 <panic>
...
80103f0d:	75 e1                	jne    80103ef0 <exit+0x30>
  begin_op();
80103f0f:	e8 2c ef ff ff       	call   80102e40 <begin_op>
  iput(curproc->cwd);
80103f14:	83 ec 0c             	sub    $0xc,%esp
80103f17:	ff 73 6c             	push   0x6c(%ebx)
80103f1a:	e8 01 da ff ff       	call   80101920 <iput>
  end_op();
80103f1f:	e8 8c ef ff ff       	call   80102eb0 <end_op>
  curproc->cwd = 0;
80103f24:	c7 43 6c 00 00 00 00 	movl   $0x0,0x6c(%ebx)
  acquire(&ptable.lock);
80103f2b:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80103f32:	e8 d9 08 00 00       	call   80104810 <acquire>
  wakeup1(curproc->parent);
80103f37:	8b 53 18             	mov    0x18(%ebx),%edx
...
80103f42:	eb 28                	jmp    80103f6c <exit+0xac>
80103f44:	eb 1a                	jmp    80103f60 <exit+0xa0>
...
80103f72:	3b 50 24             	cmp    0x24(%eax),%edx
...
80103ff2:	3b 48 24             	cmp    0x24(%eax),%ecx
...
8010408c:	74 1e                	je     801040ac <wait+0x7c>
      if(p->parent != curproc)
8010408e:	39 73 18             	cmp    %esi,0x18(%ebx)
...
8010411e:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        p->parent = 0;
80104125:	c7 43 18 00 00 00 00 	movl   $0x0,0x18(%ebx)
        p->name[0] = 0;
8010412c:	c6 43 70 00          	movb   $0x0,0x70(%ebx)
        p->killed = 0;
...
80104145:	e8 66 06 00 00       	call   801047b0 <release>
        return pid;
...
80104163:	e8 48 06 00 00       	call   801047b0 <release>
      return -1;
...
8010418c:	e8 7f 06 00 00       	call   80104810 <acquire>
  pushcli();
...
8010419b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801041a1:	e8 6a 05 00 00       	call   80104710 <popcli>
...
801041b9:	e8 f2 05 00 00       	call   801047b0 <release>
}
...
801041e9:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801041ef:	e8 1c 05 00 00       	call   80104710 <popcli>
  if(p == 0)
...
80104218:	e8 93 05 00 00       	call   801047b0 <release>
  p->chan = chan;
8010421d:	89 7b 24             	mov    %edi,0x24(%ebx)
  p->state = SLEEPING;
80104220:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
80104227:	e8 d4 fb ff ff       	call   80103e00 <sched>
  p->chan = 0;
8010422c:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
    release(&ptable.lock);
80104233:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
8010423a:	e8 71 05 00 00       	call   801047b0 <release>
    acquire(lk);
...
8010424b:	5d                   	pop    %ebp
    acquire(lk);
8010424c:	e9 bf 05 00 00       	jmp    80104810 <acquire>
80104251:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  p->chan = chan;
80104258:	89 7b 24             	mov    %edi,0x24(%ebx)
  p->state = SLEEPING;
...
8010429f:	e8 6c 05 00 00       	call   80104810 <acquire>
...
801042d2:	3b 58 24             	cmp    0x24(%eax),%ebx
...
801042f4:	c9                   	leave
  release(&ptable.lock);
801042f5:	e9 b6 04 00 00       	jmp    801047b0 <release>
...
8010430f:	e8 fc 04 00 00       	call   80104810 <acquire>
...
8010434d:	e8 5e 04 00 00       	call   801047b0 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
80104389:	bb c4 1d 11 80       	mov    $0x80111dc4,%ebx
...
801043ae:	81 fb c4 3e 11 80    	cmp    $0x80113ec4,%ebx
801043b4:	0f 84 86 00 00 00    	je     80104440 <procdump+0xc0>
    if(p->state == UNUSED)
801043ba:	8b 43 9c             	mov    -0x64(%ebx),%eax
...
80104404:	e8 17 02 00 00       	call   80104620 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
80104455:	8b 75 0c             	mov    0xc(%ebp),%esi
80104458:	8b 5d 08             	mov    0x8(%ebp),%ebx
  //check if pr is valid. Assume priority is 0-100.
  if (pr < 0 || pr > 100) {
8010445b:	83 fe 64             	cmp    $0x64,%esi
8010445e:	77 67                	ja     801044c7 <setpriority+0x77>
  }
...
80104463:	68 20 1d 11 80       	push   $0x80111d20
80104468:	e8 a3 03 00 00       	call   80104810 <acquire>
8010446d:	83 c4 10             	add    $0x10,%esp

  struct proc *current = ptable.proc;
80104470:	b8 54 1d 11 80       	mov    $0x80111d54,%eax
80104475:	eb 15                	jmp    8010448c <setpriority+0x3c>
80104477:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010447e:	00 
8010447f:	90                   	nop
    ...
    current++;
80104480:	05 84 00 00 00       	add    $0x84,%eax
  while (current < &ptable.proc[NPROC]) {
80104485:	3d 54 3e 11 80       	cmp    $0x80113e54,%eax
8010448a:	74 34                	je     801044c0 <setpriority+0x70>
    if (current->pid == pid) {
8010448c:	39 58 10             	cmp    %ebx,0x10(%eax)
8010448f:	75 ef                	jne    80104480 <setpriority+0x30>
      exists = current->pr; // save
80104491:	8b 98 80 00 00 00    	mov    0x80(%eax),%ebx
      current->pr = pr; // change
80104497:	89 b0 80 00 00 00    	mov    %esi,0x80(%eax)
  }

  //unlock
  release(&ptable.lock);
8010449d:	83 ec 0c             	sub    $0xc,%esp
801044a0:	68 20 1d 11 80       	push   $0x80111d20
801044a5:	e8 06 03 00 00       	call   801047b0 <release>
  return exists;
...
801044b4:	5d                   	pop    %ebp
801044b5:	c3                   	ret
801044b6:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
801044bd:	00 
801044be:	66 90                	xchg   %ax,%ax
  int exists = -1;
801044c0:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
801044c5:	eb d6                	jmp    8010449d <setpriority+0x4d>
    return -1; // error
801044c7:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
801044cc:	eb df                	jmp    801044ad <setpriority+0x5d>
...
801044da:	68 f8 78 10 80       	push   $0x801078f8
...
8010451f:	e8 ec 02 00 00       	call   80104810 <acquire>
  while (lk->locked) {
...
80104535:	e8 96 fc ff ff       	call   801041d0 <sleep>
  while (lk->locked) {
...
80104543:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104549:	e8 52 f5 ff ff       	call   80103aa0 <myproc>
...
8010455c:	5d                   	pop    %ebp
  release(&lk->lk);
8010455d:	e9 4e 02 00 00       	jmp    801047b0 <release>
...
8010457f:	e8 8c 02 00 00       	call   80104810 <acquire>
  lk->locked = 0;
...
80104594:	e8 f7 fc ff ff       	call   80104290 <wakeup>
  release(&lk->lk);
...
801045a4:	5d                   	pop    %ebp
  release(&lk->lk);
801045a5:	e9 06 02 00 00       	jmp    801047b0 <release>
...
801045c2:	e8 49 02 00 00       	call   80104810 <acquire>
...
801045d4:	e8 d7 01 00 00       	call   801047b0 <release>
  return r;
}
...
801045eb:	e8 b0 f4 ff ff       	call   80103aa0 <myproc>
...
8010462c:	83 e8 08             	sub    $0x8,%eax
  for(i = 0; i < 10; i++){
8010462f:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80104636:	00 
80104637:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010463e:	00 
8010463f:	90                   	nop
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80104640:	8d 98 00 00 00 80    	lea    -0x80000000(%eax),%ebx
80104646:	81 fb fe ff ff 7f    	cmp    $0x7ffffffe,%ebx
8010464c:	77 1a                	ja     80104668 <getcallerpcs+0x48>
      break;
...
8010465c:	75 e2                	jne    80104640 <getcallerpcs+0x20>
  }
  for(; i < 10; i++)
    pcs[i] = 0;
}
...
8010466b:	83 c1 28             	add    $0x28,%ecx
8010466e:	89 ca                	mov    %ecx,%edx
80104670:	29 c2                	sub    %eax,%edx
80104672:	83 e2 04             	and    $0x4,%edx
80104675:	74 29                	je     801046a0 <getcallerpcs+0x80>
    pcs[i] = 0;
80104677:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for(; i < 10; i++)
8010467d:	83 c0 04             	add    $0x4,%eax
80104680:	39 c8                	cmp    %ecx,%eax
80104682:	74 da                	je     8010465e <getcallerpcs+0x3e>
80104684:	eb 1a                	jmp    801046a0 <getcallerpcs+0x80>
80104686:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010468d:	00 
8010468e:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80104695:	00 
...
801046a9:	c7 40 fc 00 00 00 00 	movl   $0x0,-0x4(%eax)
  for(; i < 10; i++)
801046b0:	39 c8                	cmp    %ecx,%eax
801046b2:	75 ec                	jne    801046a0 <getcallerpcs+0x80>
801046b4:	eb a8                	jmp    8010465e <getcallerpcs+0x3e>
...
801046ea:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    mycpu()->intena = eflags & FL_IF;
801046f0:	e8 2b f3 ff ff       	call   80103a20 <mycpu>
...
80104703:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010470a:	00 
...
8010473c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104740:	e8 db f2 ff ff       	call   80103a20 <mycpu>
...
80104755:	68 03 79 10 80       	push   $0x80107903
8010475a:	e8 41 bc ff ff       	call   801003a0 <panic>
    panic("popcli");
8010475f:	83 ec 0c             	sub    $0xc,%esp
80104762:	68 1a 79 10 80       	push   $0x8010791a
80104767:	e8 34 bc ff ff       	call   801003a0 <panic>
...
80104793:	e8 88 f2 ff ff       	call   80103a20 <mycpu>
...
801047cb:	68 21 79 10 80       	push   $0x80107921
801047d0:	e8 cb bb ff ff       	call   801003a0 <panic>
801047d5:	8d 76 00             	lea    0x0(%esi),%esi
  r = lock->locked && lock->cpu == mycpu();
801047d8:	8b 73 08             	mov    0x8(%ebx),%esi
801047db:	e8 40 f2 ff ff       	call   80103a20 <mycpu>
...
80104828:	0f 85 d2 00 00 00    	jne    80104900 <acquire+0xf0>
  popcli();
8010482e:	e8 dd fe ff ff       	call   80104710 <popcli>
  asm volatile("lock; xchgl %0, %1" :
80104833:	b9 01 00 00 00       	mov    $0x1,%ecx
...
80104854:	e8 c7 f1 ff ff       	call   80103a20 <mycpu>
...
80104863:	eb 1b                	jmp    80104880 <acquire+0x70>
80104865:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010486c:	00 
8010486d:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80104874:	00 
80104875:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010487c:	00 
...
8010488c:	77 1a                	ja     801048a8 <acquire+0x98>
    pcs[i] = ebp[1];     // saved %eip
...
8010489d:	75 e1                	jne    80104880 <acquire+0x70>
}
...
801048ac:	83 c1 34             	add    $0x34,%ecx
801048af:	89 ca                	mov    %ecx,%edx
801048b1:	29 c2                	sub    %eax,%edx
801048b3:	83 e2 04             	and    $0x4,%edx
801048b6:	74 28                	je     801048e0 <acquire+0xd0>
    pcs[i] = 0;
801048b8:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for(; i < 10; i++)
801048be:	83 c0 04             	add    $0x4,%eax
801048c1:	39 c8                	cmp    %ecx,%eax
801048c3:	74 da                	je     8010489f <acquire+0x8f>
801048c5:	eb 19                	jmp    801048e0 <acquire+0xd0>
801048c7:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
801048ce:	00 
801048cf:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
801048d6:	00 
...
801048f2:	75 ec                	jne    801048e0 <acquire+0xd0>
801048f4:	eb a9                	jmp    8010489f <acquire+0x8f>
801048f6:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
801048fd:	00 
801048fe:	66 90                	xchg   %ax,%ax
  r = lock->locked && lock->cpu == mycpu();
80104900:	8b 5b 08             	mov    0x8(%ebx),%ebx
80104903:	e8 18 f1 ff ff       	call   80103a20 <mycpu>
80104908:	39 c3                	cmp    %eax,%ebx
8010490a:	0f 85 1e ff ff ff    	jne    8010482e <acquire+0x1e>
  popcli();
80104910:	e8 fb fd ff ff       	call   80104710 <popcli>
    panic("acquire");
80104915:	83 ec 0c             	sub    $0xc,%esp
80104918:	68 29 79 10 80       	push   $0x80107929
8010491d:	e8 7e ba ff ff       	call   801003a0 <panic>
...
8010494a:	89 d0                	mov    %edx,%eax
8010494c:	09 c8                	or     %ecx,%eax
8010494e:	a8 03                	test   $0x3,%al
80104950:	75 1e                	jne    80104970 <memset+0x30>
    c &= 0xFF;
80104952:	0f b6 45 0c          	movzbl 0xc(%ebp),%eax
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
80104956:	c1 e9 02             	shr    $0x2,%ecx
  asm volatile("cld; rep stosl" :
80104959:	89 d7                	mov    %edx,%edi
8010495b:	69 c0 01 01 01 01    	imul   $0x1010101,%eax,%eax
80104961:	fc                   	cld
80104962:	f3 ab                	rep stos %eax,%es:(%edi)
  } else
    stosb(dst, c, n);
  return dst;
}
80104964:	8b 7d fc             	mov    -0x4(%ebp),%edi
80104967:	89 d0                	mov    %edx,%eax
80104969:	c9                   	leave
8010496a:	c3                   	ret
...
80104975:	fc                   	cld
80104976:	f3 aa                	rep stos %al,%es:(%edi)
80104978:	8b 7d fc             	mov    -0x4(%ebp),%edi
...
801049a8:	74 16                	je     801049c0 <memcmp+0x40>
    if(*s1 != *s2)
801049aa:	0f b6 08             	movzbl (%eax),%ecx
801049ad:	0f b6 1a             	movzbl (%edx),%ebx
...
801049d7:	8b 45 10             	mov    0x10(%ebp),%eax
...
801049e2:	8d 0c 06             	lea    (%esi,%eax,1),%ecx
801049e5:	39 ca                	cmp    %ecx,%edx
801049e7:	73 1f                	jae    80104a08 <memmove+0x38>
    s += n;
    d += n;
    while(n-- > 0)
801049e9:	85 c0                	test   %eax,%eax
801049eb:	74 0f                	je     801049fc <memmove+0x2c>
801049ed:	83 e8 01             	sub    $0x1,%eax
      *--d = *--s;
...
80104a02:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    while(n-- > 0)
80104a08:	8d 0c 06             	lea    (%esi,%eax,1),%ecx
...
80104a32:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80104a39:	00 
...
80104a44:	8b 55 10             	mov    0x10(%ebp),%edx
80104a47:	8b 45 08             	mov    0x8(%ebp),%eax
80104a4a:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  while(n > 0 && *p && *p == *q)
80104a4d:	85 d2                	test   %edx,%edx
80104a4f:	75 16                	jne    80104a67 <strncmp+0x27>
80104a51:	eb 2d                	jmp    80104a80 <strncmp+0x40>
80104a53:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
80104a58:	3a 19                	cmp    (%ecx),%bl
80104a5a:	75 12                	jne    80104a6e <strncmp+0x2e>
    n--, p++, q++;
80104a5c:	83 c0 01             	add    $0x1,%eax
80104a5f:	83 c1 01             	add    $0x1,%ecx
  while(n > 0 && *p && *p == *q)
80104a62:	83 ea 01             	sub    $0x1,%edx
80104a65:	74 19                	je     80104a80 <strncmp+0x40>
80104a67:	0f b6 18             	movzbl (%eax),%ebx
80104a6a:	84 db                	test   %bl,%bl
80104a6c:	75 ea                	jne    80104a58 <strncmp+0x18>
  if(n == 0)
    return 0;
  return (uchar)*p - (uchar)*q;
80104a6e:	0f b6 00             	movzbl (%eax),%eax
80104a71:	0f b6 11             	movzbl (%ecx),%edx
}
80104a74:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104a77:	c9                   	leave
  return (uchar)*p - (uchar)*q;
80104a78:	29 d0                	sub    %edx,%eax
}
80104a7a:	c3                   	ret
...
80104a99:	8b 55 10             	mov    0x10(%ebp),%edx
  char *os;
...
80104aaa:	0f b6 4f ff          	movzbl -0x1(%edi),%ecx
80104aae:	88 48 ff             	mov    %cl,-0x1(%eax)
80104ab1:	84 c9                	test   %cl,%cl
80104ab3:	74 13                	je     80104ac8 <strncpy+0x38>
80104ab5:	89 d3                	mov    %edx,%ebx
...
80104ac5:	8d 76 00             	lea    0x0(%esi),%esi
  while(n-- > 0)
80104ac8:	8d 0c 18             	lea    (%eax,%ebx,1),%ecx
80104acb:	83 e9 01             	sub    $0x1,%ecx
80104ace:	85 d2                	test   %edx,%edx
80104ad0:	74 ec                	je     80104abe <strncpy+0x2e>
...
80104ae3:	89 ca                	mov    %ecx,%edx
80104ae5:	c6 40 ff 00          	movb   $0x0,-0x1(%eax)
  while(n-- > 0)
80104ae9:	29 c2                	sub    %eax,%edx
80104aeb:	85 d2                	test   %edx,%edx
80104aed:	7f f1                	jg     80104ae0 <strncpy+0x50>
}
80104aef:	5b                   	pop    %ebx
80104af0:	89 f0                	mov    %esi,%eax
80104af2:	5e                   	pop    %esi
80104af3:	5f                   	pop    %edi
80104af4:	5d                   	pop    %ebp
80104af5:	c3                   	ret
...
80104b77:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
80104b7a:	e8 21 ef ff ff       	call   80103aa0 <myproc>

  if(addr >= curproc->sz || addr+4 > curproc->sz)
80104b7f:	8b 00                	mov    (%eax),%eax
80104b81:	39 c3                	cmp    %eax,%ebx
80104b83:	73 1b                	jae    80104ba0 <fetchint+0x30>
...
80104bb7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
80104bba:	e8 e1 ee ff ff       	call   80103aa0 <myproc>

  if(addr >= curproc->sz)
80104bbf:	3b 18                	cmp    (%eax),%ebx
80104bc1:	73 35                	jae    80104bf8 <fetchstr+0x48>
    return -1;
  *pp = (char*)addr;
...
80104bcc:	73 2a                	jae    80104bf8 <fetchstr+0x48>
80104bce:	89 d8                	mov    %ebx,%eax
80104bd0:	eb 15                	jmp    80104be7 <fetchstr+0x37>
...
80104be5:	73 11                	jae    80104bf8 <fetchstr+0x48>
    if(*s == 0)
...
80104bf1:	c9                   	leave
80104bf2:	c3                   	ret
80104bf3:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
...
80104c00:	c9                   	leave
80104c01:	c3                   	ret
80104c02:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80104c09:	00 
...
80104c66:	83 ec 0c             	sub    $0xc,%esp
  int i;
  struct proc *curproc = myproc();
80104c69:	e8 32 ee ff ff       	call   80103aa0 <myproc>
80104c6e:	89 c6                	mov    %eax,%esi
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104c70:	e8 2b ee ff ff       	call   80103aa0 <myproc>
...
80104c7e:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104c81:	e8 1a ee ff ff       	call   80103aa0 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104ca2:	39 d0                	cmp    %edx,%eax
80104ca4:	73 1a                	jae    80104cc0 <argptr+0x60>
...
80104cd4:	53                   	push   %ebx
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104cd5:	e8 c6 ed ff ff       	call   80103aa0 <myproc>
80104cda:	8b 55 08             	mov    0x8(%ebp),%edx
80104cdd:	8b 40 1c             	mov    0x1c(%eax),%eax
80104ce0:	8b 40 44             	mov    0x44(%eax),%eax
80104ce3:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104ce6:	e8 b5 ed ff ff       	call   80103aa0 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104cfb:	8b 5b 04             	mov    0x4(%ebx),%ebx
  struct proc *curproc = myproc();
80104cfe:	e8 9d ed ff ff       	call   80103aa0 <myproc>
  if(addr >= curproc->sz)
...
80104d25:	73 11                	jae    80104d38 <argstr+0x68>
    if(*s == 0)
...
80104d3f:	5d                   	pop    %ebp
80104d40:	c3                   	ret
80104d41:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80104d48:	00 
...
80104d90:	50                   	push   %eax
            curproc->pid, curproc->name, num);
80104d91:	8d 43 70             	lea    0x70(%ebx),%eax
    cprintf("%d %s: unknown sys call %d\n",
80104d94:	50                   	push   %eax
80104d95:	ff 73 10             	push   0x10(%ebx)
80104d98:	68 31 79 10 80       	push   $0x80107931
80104d9d:	e8 2e b9 ff ff       	call   801006d0 <cprintf>
    curproc->tf->eax = -1;
80104da2:	8b 43 1c             	mov    0x1c(%ebx),%eax
...
80104dd2:	89 55 d4             	mov    %edx,-0x2c(%ebp)
80104dd5:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  if((dp = nameiparent(path, name)) == 0)
80104dd8:	57                   	push   %edi
80104dd9:	50                   	push   %eax
80104dda:	e8 41 d3 ff ff       	call   80102120 <nameiparent>
80104ddf:	83 c4 10             	add    $0x10,%esp
80104de2:	85 c0                	test   %eax,%eax
80104de4:	74 5e                	je     80104e44 <create+0x84>
    return 0;
  ilock(dp);
80104de6:	83 ec 0c             	sub    $0xc,%esp
80104de9:	89 c3                	mov    %eax,%ebx
80104deb:	50                   	push   %eax
80104dec:	e8 ff c9 ff ff       	call   801017f0 <ilock>

  if((ip = dirlookup(dp, name, 0)) != 0){
80104df1:	83 c4 0c             	add    $0xc,%esp
80104df4:	6a 00                	push   $0x0
80104df6:	57                   	push   %edi
80104df7:	53                   	push   %ebx
80104df8:	e8 43 cf ff ff       	call   80101d40 <dirlookup>
80104dfd:	83 c4 10             	add    $0x10,%esp
80104e00:	89 c6                	mov    %eax,%esi
80104e02:	85 c0                	test   %eax,%eax
80104e04:	74 4a                	je     80104e50 <create+0x90>
    iunlockput(dp);
80104e06:	83 ec 0c             	sub    $0xc,%esp
80104e09:	53                   	push   %ebx
80104e0a:	e8 71 cc ff ff       	call   80101a80 <iunlockput>
    ilock(ip);
80104e0f:	89 34 24             	mov    %esi,(%esp)
80104e12:	e8 d9 c9 ff ff       	call   801017f0 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80104e17:	83 c4 10             	add    $0x10,%esp
80104e1a:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
80104e1f:	75 17                	jne    80104e38 <create+0x78>
80104e21:	66 83 7e 50 02       	cmpw   $0x2,0x50(%esi)
80104e26:	75 10                	jne    80104e38 <create+0x78>
...
80104e3c:	e8 3f cc ff ff       	call   80101a80 <iunlockput>
    return 0;
80104e41:	83 c4 10             	add    $0x10,%esp
}
80104e44:	8d 65 f4             	lea    -0xc(%ebp),%esp
    return 0;
80104e47:	31 f6                	xor    %esi,%esi
}
80104e49:	5b                   	pop    %ebx
80104e4a:	89 f0                	mov    %esi,%eax
80104e4c:	5e                   	pop    %esi
80104e4d:	5f                   	pop    %edi
80104e4e:	5d                   	pop    %ebp
80104e4f:	c3                   	ret
...
80104ed0:	83 ec 0c             	sub    $0xc,%esp
    dp->nlink++;  // for ".."
80104ed3:	66 83 43 56 01       	addw   $0x1,0x56(%ebx)
    iupdate(dp);
80104ed8:	53                   	push   %ebx
80104ed9:	e8 62 c8 ff ff       	call   80101740 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80104ede:	83 c4 0c             	add    $0xc,%esp
80104ee1:	ff 76 04             	push   0x4(%esi)
80104ee4:	68 69 79 10 80       	push   $0x80107969
80104ee9:	56                   	push   %esi
80104eea:	e8 51 d1 ff ff       	call   80102040 <dirlink>
80104eef:	83 c4 10             	add    $0x10,%esp
80104ef2:	85 c0                	test   %eax,%eax
80104ef4:	78 18                	js     80104f0e <create+0x14e>
80104ef6:	83 ec 04             	sub    $0x4,%esp
80104ef9:	ff 73 04             	push   0x4(%ebx)
80104efc:	68 68 79 10 80       	push   $0x80107968
80104f01:	56                   	push   %esi
80104f02:	e8 39 d1 ff ff       	call   80102040 <dirlink>
80104f07:	83 c4 10             	add    $0x10,%esp
80104f0a:	85 c0                	test   %eax,%eax
80104f0c:	79 92                	jns    80104ea0 <create+0xe0>
      panic("create dots");
80104f0e:	83 ec 0c             	sub    $0xc,%esp
80104f11:	68 5c 79 10 80       	push   $0x8010795c
80104f16:	e8 85 b4 ff ff       	call   801003a0 <panic>
    panic("create: ialloc");
80104f1b:	83 ec 0c             	sub    $0xc,%esp
80104f1e:	68 4d 79 10 80       	push   $0x8010794d
80104f23:	e8 78 b4 ff ff       	call   801003a0 <panic>
    panic("create: dirlink");
80104f28:	83 ec 0c             	sub    $0xc,%esp
80104f2b:	68 6b 79 10 80       	push   $0x8010796b
80104f30:	e8 6b b4 ff ff       	call   801003a0 <panic>
80104f35:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80104f3c:	00 
...
80104f4e:	e8 bd fc ff ff       	call   80104c10 <argint>
...
80104f60:	e8 3b eb ff ff       	call   80103aa0 <myproc>
...
80104f6e:	74 20                	je     80104f90 <sys_dup+0x50>
  struct proc *curproc = myproc();
80104f70:	e8 2b eb ff ff       	call   80103aa0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80104f80:	8b 54 98 2c          	mov    0x2c(%eax,%ebx,4),%edx
...
80104f8e:	75 f0                	jne    80104f80 <sys_dup+0x40>
    return -1;
80104f90:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80104f95:	eb 19                	jmp    80104fb0 <sys_dup+0x70>
...
80104fa0:	83 ec 0c             	sub    $0xc,%esp
      curproc->ofile[fd] = f;
80104fa3:	89 74 98 2c          	mov    %esi,0x2c(%eax,%ebx,4)
  filedup(f);
80104fa7:	56                   	push   %esi
80104fa8:	e8 63 bf ff ff       	call   80100f10 <filedup>
  return fd;
...
80104fce:	e8 3d fc ff ff       	call   80104c10 <argint>
...
80104fe0:	e8 bb ea ff ff       	call   80103aa0 <myproc>
80104fe5:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104fe8:	8b 74 90 2c          	mov    0x2c(%eax,%edx,4),%esi
...
80104ff9:	e8 12 fc ff ff       	call   80104c10 <argint>
...
8010500e:	e8 4d fc ff ff       	call   80104c60 <argptr>
...
80105024:	e8 67 c0 ff ff       	call   80101090 <fileread>
...
80105031:	5d                   	pop    %ebp
80105032:	c3                   	ret
80105033:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
    return -1;
...
8010504e:	e8 bd fb ff ff       	call   80104c10 <argint>
...
80105068:	8b 74 90 2c          	mov    0x2c(%eax,%edx,4),%esi
...
80105079:	e8 92 fb ff ff       	call   80104c10 <argint>
...
8010508e:	e8 cd fb ff ff       	call   80104c60 <argptr>
...
801050a4:	e8 77 c0 ff ff       	call   80101120 <filewrite>
...
801050ce:	e8 3d fb ff ff       	call   80104c10 <argint>
...
801050eb:	8b 74 98 0c          	mov    0xc(%eax,%ebx,4),%esi
801050ef:	85 f6                	test   %esi,%esi
801050f1:	74 25                	je     80105118 <sys_close+0x58>
  myproc()->ofile[fd] = 0;
801050f3:	e8 a8 e9 ff ff       	call   80103aa0 <myproc>
  fileclose(f);
801050f8:	83 ec 0c             	sub    $0xc,%esp
  myproc()->ofile[fd] = 0;
801050fb:	c7 44 98 0c 00 00 00 	movl   $0x0,0xc(%eax,%ebx,4)
80105102:	00 
  fileclose(f);
80105103:	56                   	push   %esi
80105104:	e8 57 be ff ff       	call   80100f60 <fileclose>
  return 0;
...
8010512e:	e8 dd fa ff ff       	call   80104c10 <argint>
...
80105148:	8b 74 90 2c          	mov    0x2c(%eax,%edx,4),%esi
...
80105158:	e8 03 fb ff ff       	call   80104c60 <argptr>
...
8010516b:	e8 d0 be ff ff       	call   80101040 <filestat>
...
8010519f:	e8 2c fb ff ff       	call   80104cd0 <argstr>
...
80105208:	e8 33 c5 ff ff       	call   80101740 <iupdate>
  iunlock(ip);
8010520d:	89 1c 24             	mov    %ebx,(%esp)
80105210:	e8 bb c6 ff ff       	call   801018d0 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80105215:	58                   	pop    %eax
80105216:	5a                   	pop    %edx
80105217:	57                   	push   %edi
80105218:	ff 75 d0             	push   -0x30(%ebp)
8010521b:	e8 00 cf ff ff       	call   80102120 <nameiparent>
...
8010522d:	e8 be c5 ff ff       	call   801017f0 <ilock>
...
80105243:	e8 f8 cd ff ff       	call   80102040 <dirlink>
...
80105253:	e8 28 c8 ff ff       	call   80101a80 <iunlockput>
  iput(ip);
80105258:	89 1c 24             	mov    %ebx,(%esp)
8010525b:	e8 c0 c6 ff ff       	call   80101920 <iput>
  end_op();
80105260:	e8 4b dc ff ff       	call   80102eb0 <end_op>
  return 0;
...
8010527c:	e8 ff c7 ff ff       	call   80101a80 <iunlockput>
    goto bad;
80105281:	83 c4 10             	add    $0x10,%esp
  ilock(ip);
80105284:	83 ec 0c             	sub    $0xc,%esp
80105287:	53                   	push   %ebx
80105288:	e8 63 c5 ff ff       	call   801017f0 <ilock>
  ip->nlink--;
8010528d:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
80105292:	89 1c 24             	mov    %ebx,(%esp)
80105295:	e8 a6 c4 ff ff       	call   80101740 <iupdate>
  iunlockput(ip);
8010529a:	89 1c 24             	mov    %ebx,(%esp)
8010529d:	e8 de c7 ff ff       	call   80101a80 <iunlockput>
  end_op();
801052a2:	e8 09 dc ff ff       	call   80102eb0 <end_op>
  return -1;
...
801052b5:	e8 c6 c7 ff ff       	call   80101a80 <iunlockput>
    end_op();
801052ba:	e8 f1 db ff ff       	call   80102eb0 <end_op>
    return -1;
801052bf:	83 c4 10             	add    $0x10,%esp
801052c2:	eb e6                	jmp    801052aa <sys_link+0x11a>
    end_op();
801052c4:	e8 e7 db ff ff       	call   80102eb0 <end_op>
    return -1;
801052c9:	eb df                	jmp    801052aa <sys_link+0x11a>
801052cb:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
...
801052df:	e8 ec f9 ff ff       	call   80104cd0 <argstr>
801052e4:	83 c4 10             	add    $0x10,%esp
801052e7:	85 c0                	test   %eax,%eax
801052e9:	0f 88 54 01 00 00    	js     80105443 <sys_unlink+0x173>
  begin_op();
801052ef:	e8 4c db ff ff       	call   80102e40 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
801052f4:	8d 5d ca             	lea    -0x36(%ebp),%ebx
801052f7:	83 ec 08             	sub    $0x8,%esp
801052fa:	53                   	push   %ebx
801052fb:	ff 75 c0             	push   -0x40(%ebp)
801052fe:	e8 1d ce ff ff       	call   80102120 <nameiparent>
80105303:	83 c4 10             	add    $0x10,%esp
80105306:	89 45 b4             	mov    %eax,-0x4c(%ebp)
80105309:	85 c0                	test   %eax,%eax
8010530b:	0f 84 58 01 00 00    	je     80105469 <sys_unlink+0x199>
  ilock(dp);
80105311:	8b 7d b4             	mov    -0x4c(%ebp),%edi
80105314:	83 ec 0c             	sub    $0xc,%esp
80105317:	57                   	push   %edi
80105318:	e8 d3 c4 ff ff       	call   801017f0 <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
8010531d:	58                   	pop    %eax
8010531e:	5a                   	pop    %edx
8010531f:	68 69 79 10 80       	push   $0x80107969
80105324:	53                   	push   %ebx
80105325:	e8 f6 c9 ff ff       	call   80101d20 <namecmp>
...
80105338:	68 68 79 10 80       	push   $0x80107968
8010533d:	53                   	push   %ebx
8010533e:	e8 dd c9 ff ff       	call   80101d20 <namecmp>
...
80105357:	e8 e4 c9 ff ff       	call   80101d40 <dirlookup>
...
8010537a:	0f 8e fd 00 00 00    	jle    8010547d <sys_unlink+0x1ad>
...
801053c2:	e8 b9 c6 ff ff       	call   80101a80 <iunlockput>
  ip->nlink--;
801053c7:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
801053cc:	89 1c 24             	mov    %ebx,(%esp)
801053cf:	e8 6c c3 ff ff       	call   80101740 <iupdate>
  iunlockput(ip);
801053d4:	89 1c 24             	mov    %ebx,(%esp)
801053d7:	e8 a4 c6 ff ff       	call   80101a80 <iunlockput>
  end_op();
801053dc:	e8 cf da ff ff       	call   80102eb0 <end_op>
  return 0;
...
8010540d:	e8 ee c6 ff ff       	call   80101b00 <readi>
80105412:	83 c4 10             	add    $0x10,%esp
80105415:	83 f8 10             	cmp    $0x10,%eax
80105418:	75 56                	jne    80105470 <sys_unlink+0x1a0>
    if(de.inum != 0)
...
80105425:	e8 56 c6 ff ff       	call   80101a80 <iunlockput>
    goto bad;
...
80105436:	e8 45 c6 ff ff       	call   80101a80 <iunlockput>
  end_op();
8010543b:	e8 70 da ff ff       	call   80102eb0 <end_op>
  return -1;
...
8010545c:	e8 df c2 ff ff       	call   80101740 <iupdate>
80105461:	83 c4 10             	add    $0x10,%esp
80105464:	e9 53 ff ff ff       	jmp    801053bc <sys_unlink+0xec>
    end_op();
80105469:	e8 42 da ff ff       	call   80102eb0 <end_op>
    return -1;
8010546e:	eb d3                	jmp    80105443 <sys_unlink+0x173>
      panic("isdirempty: readi");
80105470:	83 ec 0c             	sub    $0xc,%esp
80105473:	68 8d 79 10 80       	push   $0x8010798d
80105478:	e8 23 af ff ff       	call   801003a0 <panic>
    panic("unlink: nlink < 1");
8010547d:	83 ec 0c             	sub    $0xc,%esp
80105480:	68 7b 79 10 80       	push   $0x8010797b
80105485:	e8 16 af ff ff       	call   801003a0 <panic>
    panic("unlink: writei");
8010548a:	83 ec 0c             	sub    $0xc,%esp
8010548d:	68 9f 79 10 80       	push   $0x8010799f
80105492:	e8 09 af ff ff       	call   801003a0 <panic>
80105497:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010549e:	00 
8010549f:	90                   	nop
...
801054af:	e8 1c f8 ff ff       	call   80104cd0 <argstr>
...
801054d2:	78 79                	js     8010554d <sys_open+0xad>
  ...
  begin_op();
801054d4:	e8 67 d9 ff ff       	call   80102e40 <begin_op>

  if(omode & O_CREATE){
    ip = create(path, T_FILE, 0, 0);
801054d9:	8b 45 e0             	mov    -0x20(%ebp),%eax
  if(omode & O_CREATE){
801054dc:	f6 45 e5 02          	testb  $0x2,-0x1b(%ebp)
801054e0:	75 76                	jne    80105558 <sys_open+0xb8>
    if(ip == 0){
      end_op();
      return -1;
    }
...
801054e6:	e8 15 cc ff ff       	call   80102100 <namei>
801054eb:	83 c4 10             	add    $0x10,%esp
801054ee:	89 c6                	mov    %eax,%esi
801054f0:	85 c0                	test   %eax,%eax
801054f2:	74 7e                	je     80105572 <sys_open+0xd2>
      end_op();
      return -1;
    }
    ilock(ip);
...
801054f8:	e8 f3 c2 ff ff       	call   801017f0 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
801054fd:	83 c4 10             	add    $0x10,%esp
80105500:	66 83 7e 50 01       	cmpw   $0x1,0x50(%esi)
80105505:	0f 84 bd 00 00 00    	je     801055c8 <sys_open+0x128>
      end_op();
      return -1;
    }
  }
...
8010550b:	e8 90 b9 ff ff       	call   80100ea0 <filealloc>
80105510:	89 c7                	mov    %eax,%edi
80105512:	85 c0                	test   %eax,%eax
80105514:	74 26                	je     8010553c <sys_open+0x9c>
  struct proc *curproc = myproc();
80105516:	e8 85 e5 ff ff       	call   80103aa0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
8010551b:	31 db                	xor    %ebx,%ebx
8010551d:	8d 76 00             	lea    0x0(%esi),%esi
    if(curproc->ofile[fd] == 0){
80105520:	8b 54 98 2c          	mov    0x2c(%eax,%ebx,4),%edx
80105524:	85 d2                	test   %edx,%edx
80105526:	74 58                	je     80105580 <sys_open+0xe0>
  for(fd = 0; fd < NOFILE; fd++){
...
80105534:	e8 27 ba ff ff       	call   80100f60 <fileclose>
80105539:	83 c4 10             	add    $0x10,%esp
    iunlockput(ip);
8010553c:	83 ec 0c             	sub    $0xc,%esp
8010553f:	56                   	push   %esi
80105540:	e8 3b c5 ff ff       	call   80101a80 <iunlockput>
    end_op();
80105545:	e8 66 d9 ff ff       	call   80102eb0 <end_op>
    return -1;
8010554a:	83 c4 10             	add    $0x10,%esp
    return -1;
8010554d:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80105552:	eb 65                	jmp    801055b9 <sys_open+0x119>
80105554:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ip = create(path, T_FILE, 0, 0);
80105558:	83 ec 0c             	sub    $0xc,%esp
8010555b:	31 c9                	xor    %ecx,%ecx
8010555d:	ba 02 00 00 00       	mov    $0x2,%edx
80105562:	6a 00                	push   $0x0
80105564:	e8 57 f8 ff ff       	call   80104dc0 <create>
    if(ip == 0){
80105569:	83 c4 10             	add    $0x10,%esp
    ip = create(path, T_FILE, 0, 0);
8010556c:	89 c6                	mov    %eax,%esi
    if(ip == 0){
8010556e:	85 c0                	test   %eax,%eax
80105570:	75 99                	jne    8010550b <sys_open+0x6b>
      end_op();
80105572:	e8 39 d9 ff ff       	call   80102eb0 <end_op>
      return -1;
80105577:	eb d4                	jmp    8010554d <sys_open+0xad>
80105579:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  }
  iunlock(ip);
80105580:	83 ec 0c             	sub    $0xc,%esp
      curproc->ofile[fd] = f;
80105583:	89 7c 98 2c          	mov    %edi,0x2c(%eax,%ebx,4)
  iunlock(ip);
80105587:	56                   	push   %esi
80105588:	e8 43 c3 ff ff       	call   801018d0 <iunlock>
  end_op();
8010558d:	e8 1e d9 ff ff       	call   80102eb0 <end_op>
...
8010559e:	89 77 10             	mov    %esi,0x10(%edi)
  f->readable = !(omode & O_WRONLY);
801055a1:	89 d0                	mov    %edx,%eax
  f->off = 0;
801055a3:	c7 47 14 00 00 00 00 	movl   $0x0,0x14(%edi)
  f->readable = !(omode & O_WRONLY);
801055aa:	f7 d0                	not    %eax
801055ac:	83 e0 01             	and    $0x1,%eax
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
801055af:	83 e2 03             	and    $0x3,%edx
  f->readable = !(omode & O_WRONLY);
801055b2:	88 47 08             	mov    %al,0x8(%edi)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
801055b5:	0f 95 47 09          	setne  0x9(%edi)
  return fd;
}
801055b9:	8d 65 f4             	lea    -0xc(%ebp),%esp
801055bc:	89 d8                	mov    %ebx,%eax
801055be:	5b                   	pop    %ebx
801055bf:	5e                   	pop    %esi
801055c0:	5f                   	pop    %edi
801055c1:	5d                   	pop    %ebp
801055c2:	c3                   	ret
801055c3:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
    if(ip->type == T_DIR && omode != O_RDONLY){
801055c8:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
801055cb:	85 c9                	test   %ecx,%ecx
801055cd:	0f 84 38 ff ff ff    	je     8010550b <sys_open+0x6b>
801055d3:	e9 64 ff ff ff       	jmp    8010553c <sys_open+0x9c>
...
8010560f:	e8 ac f7 ff ff       	call   80104dc0 <create>
...
8010561f:	e8 5c c4 ff ff       	call   80101a80 <iunlockput>
  end_op();
80105624:	e8 87 d8 ff ff       	call   80102eb0 <end_op>
  return 0;
...
8010562f:	c3                   	ret
    end_op();
80105630:	e8 7b d8 ff ff       	call   80102eb0 <end_op>
    return -1;
...
80105669:	e8 a2 f5 ff ff       	call   80104c10 <argint>
  if((argstr(0, &path)) < 0 ||
...
8010567e:	e8 8d f5 ff ff       	call   80104c10 <argint>
     argint(1, &major) < 0 ||
...
8010569e:	e8 1d f7 ff ff       	call   80104dc0 <create>
     argint(2, &minor) < 0 ||
...
801056ae:	e8 cd c3 ff ff       	call   80101a80 <iunlockput>
  end_op();
801056b3:	e8 f8 d7 ff ff       	call   80102eb0 <end_op>
  return 0;
...
801056bf:	90                   	nop
    end_op();
801056c0:	e8 eb d7 ff ff       	call   80102eb0 <end_op>
    return -1;
...
801056d5:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
801056d8:	e8 c3 e3 ff ff       	call   80103aa0 <myproc>
801056dd:	89 c6                	mov    %eax,%esi
  
  begin_op();
801056df:	e8 5c d7 ff ff       	call   80102e40 <begin_op>
...
801056ff:	e8 fc c9 ff ff       	call   80102100 <namei>
...
80105711:	e8 da c0 ff ff       	call   801017f0 <ilock>
  if(ip->type != T_DIR){
...
80105724:	e8 a7 c1 ff ff       	call   801018d0 <iunlock>
  iput(curproc->cwd);
80105729:	58                   	pop    %eax
8010572a:	ff 76 6c             	push   0x6c(%esi)
8010572d:	e8 ee c1 ff ff       	call   80101920 <iput>
  end_op();
80105732:	e8 79 d7 ff ff       	call   80102eb0 <end_op>
  curproc->cwd = ip;
...
80105754:	e8 27 c3 ff ff       	call   80101a80 <iunlockput>
    end_op();
80105759:	e8 52 d7 ff ff       	call   80102eb0 <end_op>
    return -1;
...
80105770:	e8 3b d7 ff ff       	call   80102eb0 <end_op>
    return -1;
80105775:	eb ea                	jmp    80105761 <sys_chdir+0x91>
...
801057b1:	e8 5a f4 ff ff       	call   80104c10 <argint>
...
801057d0:	e8 6b f1 ff ff       	call   80104940 <memset>
...
801057fa:	e8 71 f3 ff ff       	call   80104b70 <fetchint>
...
80105818:	e8 93 f3 ff ff       	call   80104bb0 <fetchstr>
...
80105855:	e8 96 b2 ff ff       	call   80100af0 <exec>
...
80105881:	e8 da f3 ff ff       	call   80104c60 <argptr>
80105886:	83 c4 10             	add    $0x10,%esp
80105889:	85 c0                	test   %eax,%eax
8010588b:	0f 88 93 00 00 00    	js     80105924 <sys_pipe+0xb4>
    return -1;
...
8010589c:	e8 5f dc ff ff       	call   80103500 <pipealloc>
801058a1:	83 c4 10             	add    $0x10,%esp
801058a4:	85 c0                	test   %eax,%eax
801058a6:	78 7c                	js     80105924 <sys_pipe+0xb4>
    return -1;
  fd0 = -1;
...
801058ab:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
801058ad:	e8 ee e1 ff ff       	call   80103aa0 <myproc>
    if(curproc->ofile[fd] == 0){
801058b2:	8b 74 98 2c          	mov    0x2c(%eax,%ebx,4),%esi
801058b6:	85 f6                	test   %esi,%esi
801058b8:	74 16                	je     801058d0 <sys_pipe+0x60>
801058ba:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  for(fd = 0; fd < NOFILE; fd++){
801058c0:	83 c3 01             	add    $0x1,%ebx
801058c3:	83 fb 10             	cmp    $0x10,%ebx
801058c6:	74 45                	je     8010590d <sys_pipe+0x9d>
    if(curproc->ofile[fd] == 0){
801058c8:	8b 74 98 2c          	mov    0x2c(%eax,%ebx,4),%esi
...
801058d7:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
801058da:	e8 c1 e1 ff ff       	call   80103aa0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801058e9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if(curproc->ofile[fd] == 0){
801058f0:	8b 4c 90 2c          	mov    0x2c(%eax,%edx,4),%ecx
801058f4:	85 c9                	test   %ecx,%ecx
801058f6:	74 38                	je     80105930 <sys_pipe+0xc0>
  for(fd = 0; fd < NOFILE; fd++){
801058f8:	83 c2 01             	add    $0x1,%edx
801058fb:	83 fa 10             	cmp    $0x10,%edx
801058fe:	75 f0                	jne    801058f0 <sys_pipe+0x80>
    if(fd0 >= 0)
      myproc()->ofile[fd0] = 0;
80105900:	e8 9b e1 ff ff       	call   80103aa0 <myproc>
80105905:	c7 44 b0 0c 00 00 00 	movl   $0x0,0xc(%eax,%esi,4)
8010590c:	00 
    fileclose(rf);
8010590d:	83 ec 0c             	sub    $0xc,%esp
80105910:	ff 75 e0             	push   -0x20(%ebp)
80105913:	e8 48 b6 ff ff       	call   80100f60 <fileclose>
    fileclose(wf);
80105918:	58                   	pop    %eax
80105919:	ff 75 e4             	push   -0x1c(%ebp)
8010591c:	e8 3f b6 ff ff       	call   80100f60 <fileclose>
    return -1;
80105921:	83 c4 10             	add    $0x10,%esp
    return -1;
80105924:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105929:	eb 16                	jmp    80105941 <sys_pipe+0xd1>
8010592b:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
      curproc->ofile[fd] = f;
80105930:	89 7c 90 2c          	mov    %edi,0x2c(%eax,%edx,4)
  }
  fd[0] = fd0;
...
{
  return fork();
80105950:	e9 eb e2 ff ff       	jmp    80103c40 <fork>
...
80105963:	83 ec 08             	sub    $0x8,%esp
  exit();
80105966:	e8 55 e5 ff ff       	call   80103ec0 <exit>
...
{
  return wait();
80105970:	e9 bb e6 ff ff       	jmp    80104030 <wait>
...
8010599e:	e8 5d e9 ff ff       	call   80104300 <kill>
...
801059c3:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
801059c6:	e8 d5 e0 ff ff       	call   80103aa0 <myproc>
...
801059e7:	78 27                	js     80105a10 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
801059e9:	e8 b2 e0 ff ff       	call   80103aa0 <myproc>
  if(growproc(n) < 0)
...
801059f6:	e8 c5 e1 ff ff       	call   80103bc0 <growproc>
...
80105a37:	78 64                	js     80105a9d <sys_sleep+0x7d>
    return -1;
  acquire(&tickslock);
80105a39:	83 ec 0c             	sub    $0xc,%esp
80105a3c:	68 80 3e 11 80       	push   $0x80113e80
80105a41:	e8 ca ed ff ff       	call   80104810 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80105a46:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
80105a49:	8b 1d 60 3e 11 80    	mov    0x80113e60,%ebx
  while(ticks - ticks0 < n){
80105a4f:	83 c4 10             	add    $0x10,%esp
80105a52:	85 d2                	test   %edx,%edx
80105a54:	75 2b                	jne    80105a81 <sys_sleep+0x61>
80105a56:	eb 50                	jmp    80105aa8 <sys_sleep+0x88>
...
80105a6d:	e8 5e e7 ff ff       	call   801041d0 <sleep>
  while(ticks - ticks0 < n){
...
80105a7f:	73 27                	jae    80105aa8 <sys_sleep+0x88>
    if(myproc()->killed){
80105a81:	e8 1a e0 ff ff       	call   80103aa0 <myproc>
80105a86:	8b 40 28             	mov    0x28(%eax),%eax
...
80105a95:	e8 16 ed ff ff       	call   801047b0 <release>
      return -1;
80105a9a:	83 c4 10             	add    $0x10,%esp
    return -1;
80105a9d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105aa2:	eb 16                	jmp    80105aba <sys_sleep+0x9a>
80105aa4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  }
  release(&tickslock);
80105aa8:	83 ec 0c             	sub    $0xc,%esp
80105aab:	68 80 3e 11 80       	push   $0x80113e80
80105ab0:	e8 fb ec ff ff       	call   801047b0 <release>
  return 0;
...
80105ac4:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105ac7:	68 80 3e 11 80       	push   $0x80113e80
80105acc:	e8 3f ed ff ff       	call   80104810 <acquire>
  xticks = ticks;
80105ad1:	8b 1d 60 3e 11 80    	mov    0x80113e60,%ebx
  release(&tickslock);
80105ad7:	c7 04 24 80 3e 11 80 	movl   $0x80113e80,(%esp)
80105ade:	e8 cd ec ff ff       	call   801047b0 <release>
  return xticks;
}
...
80105af6:	e8 a5 df ff ff       	call   80103aa0 <myproc>
80105afb:	8b 40 10             	mov    0x10(%eax),%eax
80105afe:	c9                   	leave
80105aff:	c3                   	ret

80105b00 <sys_setpgid>:
{
	return myproc()->pid;
}
int
...
80105b04:	83 ec 14             	sub    $0x14,%esp
	int pid;
	struct proc *p = myproc();
80105b07:	e8 94 df ff ff       	call   80103aa0 <myproc>
  	if(argint(0, &pid) < 0)
...
80105b17:	e8 f4 f0 ff ff       	call   80104c10 <argint>
80105b1c:	83 c4 10             	add    $0x10,%esp
80105b1f:	85 c0                	test   %eax,%eax
80105b21:	78 0d                	js     80105b30 <sys_setpgid+0x30>
		return -1;
	p->pgid = pid;
80105b23:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b26:	89 43 14             	mov    %eax,0x14(%ebx)
	return 0;
80105b29:	31 c0                	xor    %eax,%eax
}
80105b2b:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80105b2e:	c9                   	leave
80105b2f:	c3                   	ret
		return -1;
80105b30:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105b35:	eb f4                	jmp    80105b2b <sys_setpgid+0x2b>
80105b37:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80105b3e:	00 
80105b3f:	90                   	nop

80105b40 <sys_getppid>:
int 
sys_getppid(void){
...
80105b46:	e8 55 df ff ff       	call   80103aa0 <myproc>
80105b4b:	8b 40 18             	mov    0x18(%eax),%eax
80105b4e:	8b 40 10             	mov    0x10(%eax),%eax
}
80105b51:	c9                   	leave
80105b52:	c3                   	ret
80105b53:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80105b5a:	00 
80105b5b:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi

80105b60 <sys_getpgid>:
int 
sys_getpgid(void) 
{
...
80105b64:	83 ec 14             	sub    $0x14,%esp
	int pid;
	struct proc *p = myproc();
80105b67:	e8 34 df ff ff       	call   80103aa0 <myproc>
...
80105b77:	e8 94 f0 ff ff       	call   80104c10 <argint>
		return -1;
	
	return p? p->pgid : -1;
80105b7c:	83 c4 10             	add    $0x10,%esp
80105b7f:	85 db                	test   %ebx,%ebx
80105b81:	74 0d                	je     80105b90 <sys_getpgid+0x30>
80105b83:	85 c0                	test   %eax,%eax
80105b85:	78 09                	js     80105b90 <sys_getpgid+0x30>
80105b87:	8b 43 14             	mov    0x14(%ebx),%eax
}
...
80105b95:	eb f3                	jmp    80105b8a <sys_getpgid+0x2a>
80105b97:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80105b9e:	00 
80105b9f:	90                   	nop

80105ba0 <sys_uptime_ms>:
int 
sys_uptime_ms(void) {
...
80105bac:	e8 5f ec ff ff       	call   80104810 <acquire>
	xticks = ticks;
80105bb1:	8b 1d 60 3e 11 80    	mov    0x80113e60,%ebx
	release(&tickslock);
80105bb7:	c7 04 24 80 3e 11 80 	movl   $0x80113e80,(%esp)
80105bbe:	e8 ed eb ff ff       	call   801047b0 <release>
	return (uint)(xticks *1000/100);
80105bc3:	b8 1f 85 eb 51       	mov    $0x51eb851f,%eax
80105bc8:	69 d3 e8 03 00 00    	imul   $0x3e8,%ebx,%edx
}
80105bce:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80105bd1:	c9                   	leave
	return (uint)(xticks *1000/100);
80105bd2:	f7 e2                	mul    %edx
80105bd4:	89 d0                	mov    %edx,%eax
80105bd6:	c1 e8 05             	shr    $0x5,%eax
}
80105bd9:	c3                   	ret
80105bda:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi

80105be0 <sys_setpriority>:
...
80105c16:	e8 35 e8 ff ff       	call   80104450 <setpriority>
  return res;
...
80105c36:	54                   	push   %esp
  call trap
80105c37:	e8 24 01 00 00       	call   80105d60 <trap>
  addl $4, %esp
...
80105d14:	66 a3 c6 40 11 80    	mov    %ax,0x801140c6
  initlock(&tickslock, "time");
80105d1a:	e8 e1 e8 ff ff       	call   80104600 <initlock>
}
...
80105d84:	ff 24 85 10 7f 10 80 	jmp    *-0x7fef80f0(,%eax,4)
...
80105da8:	8b 50 28             	mov    0x28(%eax),%edx
...
80105de3:	8b 40 28             	mov    0x28(%eax),%eax
...
80105ee5:	89 58 1c             	mov    %ebx,0x1c(%eax)
    syscall();
80105ee8:	e8 63 ee ff ff       	call   80104d50 <syscall>
    if(myproc()->killed)
...
80105f65:	e8 a6 e8 ff ff       	call   80104810 <acquire>
      ticks++;
...
80105f84:	e8 27 e8 ff ff       	call   801047b0 <release>
...
80106167:	6a 00                	push   $0x0
  jmp alltraps
80106169:	e9 b9 fa ff ff       	jmp    80105c27 <alltraps>
...
80106170:	6a 01                	push   $0x1
  jmp alltraps
80106172:	e9 b0 fa ff ff       	jmp    80105c27 <alltraps>
...
80106179:	6a 02                	push   $0x2
  jmp alltraps
8010617b:	e9 a7 fa ff ff       	jmp    80105c27 <alltraps>
...
8010618b:	6a 04                	push   $0x4
  jmp alltraps
8010618d:	e9 95 fa ff ff       	jmp    80105c27 <alltraps>
...
80106194:	6a 05                	push   $0x5
  jmp alltraps
80106196:	e9 8c fa ff ff       	jmp    80105c27 <alltraps>
...
8010619d:	6a 06                	push   $0x6
  jmp alltraps
8010619f:	e9 83 fa ff ff       	jmp    80105c27 <alltraps>
...
801061a6:	6a 07                	push   $0x7
  jmp alltraps
801061a8:	e9 7a fa ff ff       	jmp    80105c27 <alltraps>
...
801061ad:	6a 08                	push   $0x8
  jmp alltraps
801061af:	e9 73 fa ff ff       	jmp    80105c27 <alltraps>
...
801061b6:	6a 09                	push   $0x9
  jmp alltraps
801061b8:	e9 6a fa ff ff       	jmp    80105c27 <alltraps>
...
801061c4:	6a 0b                	push   $0xb
  jmp alltraps
801061c6:	e9 5c fa ff ff       	jmp    80105c27 <alltraps>
...
801061cb:	6a 0c                	push   $0xc
  jmp alltraps
801061cd:	e9 55 fa ff ff       	jmp    80105c27 <alltraps>
...
801061d9:	6a 0e                	push   $0xe
  jmp alltraps
801061db:	e9 47 fa ff ff       	jmp    80105c27 <alltraps>
...
801061e2:	6a 0f                	push   $0xf
  jmp alltraps
801061e4:	e9 3e fa ff ff       	jmp    80105c27 <alltraps>
...
801061eb:	6a 10                	push   $0x10
  jmp alltraps
801061ed:	e9 35 fa ff ff       	jmp    80105c27 <alltraps>
...
801061f2:	6a 11                	push   $0x11
  jmp alltraps
801061f4:	e9 2e fa ff ff       	jmp    80105c27 <alltraps>
...
801061fb:	6a 12                	push   $0x12
  jmp alltraps
801061fd:	e9 25 fa ff ff       	jmp    80105c27 <alltraps>
...
80106204:	6a 13                	push   $0x13
  jmp alltraps
80106206:	e9 1c fa ff ff       	jmp    80105c27 <alltraps>
...
8010620d:	6a 14                	push   $0x14
  jmp alltraps
8010620f:	e9 13 fa ff ff       	jmp    80105c27 <alltraps>
...
80106216:	6a 15                	push   $0x15
  jmp alltraps
80106218:	e9 0a fa ff ff       	jmp    80105c27 <alltraps>
...
8010621f:	6a 16                	push   $0x16
  jmp alltraps
80106221:	e9 01 fa ff ff       	jmp    80105c27 <alltraps>
...
80106228:	6a 17                	push   $0x17
  jmp alltraps
8010622a:	e9 f8 f9 ff ff       	jmp    80105c27 <alltraps>
...
80106231:	6a 18                	push   $0x18
  jmp alltraps
80106233:	e9 ef f9 ff ff       	jmp    80105c27 <alltraps>
...
8010623a:	6a 19                	push   $0x19
  jmp alltraps
8010623c:	e9 e6 f9 ff ff       	jmp    80105c27 <alltraps>
...
80106243:	6a 1a                	push   $0x1a
  jmp alltraps
80106245:	e9 dd f9 ff ff       	jmp    80105c27 <alltraps>
...
8010624c:	6a 1b                	push   $0x1b
  jmp alltraps
8010624e:	e9 d4 f9 ff ff       	jmp    80105c27 <alltraps>
...
80106255:	6a 1c                	push   $0x1c
  jmp alltraps
80106257:	e9 cb f9 ff ff       	jmp    80105c27 <alltraps>
...
8010625e:	6a 1d                	push   $0x1d
  jmp alltraps
80106260:	e9 c2 f9 ff ff       	jmp    80105c27 <alltraps>
...
80106267:	6a 1e                	push   $0x1e
  jmp alltraps
80106269:	e9 b9 f9 ff ff       	jmp    80105c27 <alltraps>
...
80106270:	6a 1f                	push   $0x1f
  jmp alltraps
80106272:	e9 b0 f9 ff ff       	jmp    80105c27 <alltraps>
...
80106279:	6a 20                	push   $0x20
  jmp alltraps
8010627b:	e9 a7 f9 ff ff       	jmp    80105c27 <alltraps>
...
80106282:	6a 21                	push   $0x21
  jmp alltraps
80106284:	e9 9e f9 ff ff       	jmp    80105c27 <alltraps>
...
8010628b:	6a 22                	push   $0x22
  jmp alltraps
8010628d:	e9 95 f9 ff ff       	jmp    80105c27 <alltraps>
...
80106294:	6a 23                	push   $0x23
  jmp alltraps
80106296:	e9 8c f9 ff ff       	jmp    80105c27 <alltraps>
...
8010629d:	6a 24                	push   $0x24
  jmp alltraps
8010629f:	e9 83 f9 ff ff       	jmp    80105c27 <alltraps>
...
801062a6:	6a 25                	push   $0x25
  jmp alltraps
801062a8:	e9 7a f9 ff ff       	jmp    80105c27 <alltraps>
...
801062af:	6a 26                	push   $0x26
  jmp alltraps
801062b1:	e9 71 f9 ff ff       	jmp    80105c27 <alltraps>
...
801062b8:	6a 27                	push   $0x27
  jmp alltraps
801062ba:	e9 68 f9 ff ff       	jmp    80105c27 <alltraps>
...
801062c1:	6a 28                	push   $0x28
  jmp alltraps
801062c3:	e9 5f f9 ff ff       	jmp    80105c27 <alltraps>
...
801062ca:	6a 29                	push   $0x29
  jmp alltraps
801062cc:	e9 56 f9 ff ff       	jmp    80105c27 <alltraps>
...
801062d3:	6a 2a                	push   $0x2a
  jmp alltraps
801062d5:	e9 4d f9 ff ff       	jmp    80105c27 <alltraps>
...
801062dc:	6a 2b                	push   $0x2b
  jmp alltraps
801062de:	e9 44 f9 ff ff       	jmp    80105c27 <alltraps>
...
801062e5:	6a 2c                	push   $0x2c
  jmp alltraps
801062e7:	e9 3b f9 ff ff       	jmp    80105c27 <alltraps>
...
801062ee:	6a 2d                	push   $0x2d
  jmp alltraps
801062f0:	e9 32 f9 ff ff       	jmp    80105c27 <alltraps>
...
801062f7:	6a 2e                	push   $0x2e
  jmp alltraps
801062f9:	e9 29 f9 ff ff       	jmp    80105c27 <alltraps>
...
80106300:	6a 2f                	push   $0x2f
  jmp alltraps
80106302:	e9 20 f9 ff ff       	jmp    80105c27 <alltraps>
...
80106309:	6a 30                	push   $0x30
  jmp alltraps
8010630b:	e9 17 f9 ff ff       	jmp    80105c27 <alltraps>
...
80106312:	6a 31                	push   $0x31
  jmp alltraps
80106314:	e9 0e f9 ff ff       	jmp    80105c27 <alltraps>
...
8010631b:	6a 32                	push   $0x32
  jmp alltraps
8010631d:	e9 05 f9 ff ff       	jmp    80105c27 <alltraps>
...
80106324:	6a 33                	push   $0x33
  jmp alltraps
80106326:	e9 fc f8 ff ff       	jmp    80105c27 <alltraps>
...
8010632d:	6a 34                	push   $0x34
  jmp alltraps
8010632f:	e9 f3 f8 ff ff       	jmp    80105c27 <alltraps>
...
80106336:	6a 35                	push   $0x35
  jmp alltraps
80106338:	e9 ea f8 ff ff       	jmp    80105c27 <alltraps>
...
8010633f:	6a 36                	push   $0x36
  jmp alltraps
80106341:	e9 e1 f8 ff ff       	jmp    80105c27 <alltraps>
...
80106348:	6a 37                	push   $0x37
  jmp alltraps
8010634a:	e9 d8 f8 ff ff       	jmp    80105c27 <alltraps>
...
80106351:	6a 38                	push   $0x38
  jmp alltraps
80106353:	e9 cf f8 ff ff       	jmp    80105c27 <alltraps>
...
8010635a:	6a 39                	push   $0x39
  jmp alltraps
8010635c:	e9 c6 f8 ff ff       	jmp    80105c27 <alltraps>
...
80106363:	6a 3a                	push   $0x3a
  jmp alltraps
80106365:	e9 bd f8 ff ff       	jmp    80105c27 <alltraps>
...
8010636c:	6a 3b                	push   $0x3b
  jmp alltraps
8010636e:	e9 b4 f8 ff ff       	jmp    80105c27 <alltraps>
...
80106375:	6a 3c                	push   $0x3c
  jmp alltraps
80106377:	e9 ab f8 ff ff       	jmp    80105c27 <alltraps>
...
8010637e:	6a 3d                	push   $0x3d
  jmp alltraps
80106380:	e9 a2 f8 ff ff       	jmp    80105c27 <alltraps>
...
80106387:	6a 3e                	push   $0x3e
  jmp alltraps
80106389:	e9 99 f8 ff ff       	jmp    80105c27 <alltraps>
...
80106390:	6a 3f                	push   $0x3f
  jmp alltraps
80106392:	e9 90 f8 ff ff       	jmp    80105c27 <alltraps>
...
80106399:	6a 40                	push   $0x40
  jmp alltraps
8010639b:	e9 87 f8 ff ff       	jmp    80105c27 <alltraps>
...
801063a2:	6a 41                	push   $0x41
  jmp alltraps
801063a4:	e9 7e f8 ff ff       	jmp    80105c27 <alltraps>
...
801063ab:	6a 42                	push   $0x42
  jmp alltraps
801063ad:	e9 75 f8 ff ff       	jmp    80105c27 <alltraps>
...
801063b4:	6a 43                	push   $0x43
  jmp alltraps
801063b6:	e9 6c f8 ff ff       	jmp    80105c27 <alltraps>
...
801063bd:	6a 44                	push   $0x44
  jmp alltraps
801063bf:	e9 63 f8 ff ff       	jmp    80105c27 <alltraps>
...
801063c6:	6a 45                	push   $0x45
  jmp alltraps
801063c8:	e9 5a f8 ff ff       	jmp    80105c27 <alltraps>
...
801063cf:	6a 46                	push   $0x46
  jmp alltraps
801063d1:	e9 51 f8 ff ff       	jmp    80105c27 <alltraps>
...
801063d8:	6a 47                	push   $0x47
  jmp alltraps
801063da:	e9 48 f8 ff ff       	jmp    80105c27 <alltraps>
...
801063e1:	6a 48                	push   $0x48
  jmp alltraps
801063e3:	e9 3f f8 ff ff       	jmp    80105c27 <alltraps>
...
801063ea:	6a 49                	push   $0x49
  jmp alltraps
801063ec:	e9 36 f8 ff ff       	jmp    80105c27 <alltraps>
...
801063f3:	6a 4a                	push   $0x4a
  jmp alltraps
801063f5:	e9 2d f8 ff ff       	jmp    80105c27 <alltraps>
...
801063fc:	6a 4b                	push   $0x4b
  jmp alltraps
801063fe:	e9 24 f8 ff ff       	jmp    80105c27 <alltraps>
...
80106405:	6a 4c                	push   $0x4c
  jmp alltraps
80106407:	e9 1b f8 ff ff       	jmp    80105c27 <alltraps>
...
8010640e:	6a 4d                	push   $0x4d
  jmp alltraps
80106410:	e9 12 f8 ff ff       	jmp    80105c27 <alltraps>
...
80106417:	6a 4e                	push   $0x4e
  jmp alltraps
80106419:	e9 09 f8 ff ff       	jmp    80105c27 <alltraps>
...
80106420:	6a 4f                	push   $0x4f
  jmp alltraps
80106422:	e9 00 f8 ff ff       	jmp    80105c27 <alltraps>
...
80106429:	6a 50                	push   $0x50
  jmp alltraps
8010642b:	e9 f7 f7 ff ff       	jmp    80105c27 <alltraps>
...
80106432:	6a 51                	push   $0x51
  jmp alltraps
80106434:	e9 ee f7 ff ff       	jmp    80105c27 <alltraps>
...
8010643b:	6a 52                	push   $0x52
  jmp alltraps
8010643d:	e9 e5 f7 ff ff       	jmp    80105c27 <alltraps>
...
80106444:	6a 53                	push   $0x53
  jmp alltraps
80106446:	e9 dc f7 ff ff       	jmp    80105c27 <alltraps>
...
8010644d:	6a 54                	push   $0x54
  jmp alltraps
8010644f:	e9 d3 f7 ff ff       	jmp    80105c27 <alltraps>
...
80106456:	6a 55                	push   $0x55
  jmp alltraps
80106458:	e9 ca f7 ff ff       	jmp    80105c27 <alltraps>
...
8010645f:	6a 56                	push   $0x56
  jmp alltraps
80106461:	e9 c1 f7 ff ff       	jmp    80105c27 <alltraps>
...
80106468:	6a 57                	push   $0x57
  jmp alltraps
8010646a:	e9 b8 f7 ff ff       	jmp    80105c27 <alltraps>
...
80106471:	6a 58                	push   $0x58
  jmp alltraps
80106473:	e9 af f7 ff ff       	jmp    80105c27 <alltraps>
...
8010647a:	6a 59                	push   $0x59
  jmp alltraps
8010647c:	e9 a6 f7 ff ff       	jmp    80105c27 <alltraps>
...
80106483:	6a 5a                	push   $0x5a
  jmp alltraps
80106485:	e9 9d f7 ff ff       	jmp    80105c27 <alltraps>
...
8010648c:	6a 5b                	push   $0x5b
  jmp alltraps
8010648e:	e9 94 f7 ff ff       	jmp    80105c27 <alltraps>
...
80106495:	6a 5c                	push   $0x5c
  jmp alltraps
80106497:	e9 8b f7 ff ff       	jmp    80105c27 <alltraps>
...
8010649e:	6a 5d                	push   $0x5d
  jmp alltraps
801064a0:	e9 82 f7 ff ff       	jmp    80105c27 <alltraps>
...
801064a7:	6a 5e                	push   $0x5e
  jmp alltraps
801064a9:	e9 79 f7 ff ff       	jmp    80105c27 <alltraps>
...
801064b0:	6a 5f                	push   $0x5f
  jmp alltraps
801064b2:	e9 70 f7 ff ff       	jmp    80105c27 <alltraps>
...
801064b9:	6a 60                	push   $0x60
  jmp alltraps
801064bb:	e9 67 f7 ff ff       	jmp    80105c27 <alltraps>
...
801064c2:	6a 61                	push   $0x61
  jmp alltraps
801064c4:	e9 5e f7 ff ff       	jmp    80105c27 <alltraps>
...
801064cb:	6a 62                	push   $0x62
  jmp alltraps
801064cd:	e9 55 f7 ff ff       	jmp    80105c27 <alltraps>
...
801064d4:	6a 63                	push   $0x63
  jmp alltraps
801064d6:	e9 4c f7 ff ff       	jmp    80105c27 <alltraps>
...
801064dd:	6a 64                	push   $0x64
  jmp alltraps
801064df:	e9 43 f7 ff ff       	jmp    80105c27 <alltraps>
...
801064e6:	6a 65                	push   $0x65
  jmp alltraps
801064e8:	e9 3a f7 ff ff       	jmp    80105c27 <alltraps>
...
801064ef:	6a 66                	push   $0x66
  jmp alltraps
801064f1:	e9 31 f7 ff ff       	jmp    80105c27 <alltraps>
...
801064f8:	6a 67                	push   $0x67
  jmp alltraps
801064fa:	e9 28 f7 ff ff       	jmp    80105c27 <alltraps>
...
80106501:	6a 68                	push   $0x68
  jmp alltraps
80106503:	e9 1f f7 ff ff       	jmp    80105c27 <alltraps>
...
8010650a:	6a 69                	push   $0x69
  jmp alltraps
8010650c:	e9 16 f7 ff ff       	jmp    80105c27 <alltraps>
...
80106513:	6a 6a                	push   $0x6a
  jmp alltraps
80106515:	e9 0d f7 ff ff       	jmp    80105c27 <alltraps>
...
8010651c:	6a 6b                	push   $0x6b
  jmp alltraps
8010651e:	e9 04 f7 ff ff       	jmp    80105c27 <alltraps>
...
80106525:	6a 6c                	push   $0x6c
  jmp alltraps
80106527:	e9 fb f6 ff ff       	jmp    80105c27 <alltraps>
...
8010652e:	6a 6d                	push   $0x6d
  jmp alltraps
80106530:	e9 f2 f6 ff ff       	jmp    80105c27 <alltraps>
...
80106537:	6a 6e                	push   $0x6e
  jmp alltraps
80106539:	e9 e9 f6 ff ff       	jmp    80105c27 <alltraps>
...
80106540:	6a 6f                	push   $0x6f
  jmp alltraps
80106542:	e9 e0 f6 ff ff       	jmp    80105c27 <alltraps>
...
80106549:	6a 70                	push   $0x70
  jmp alltraps
8010654b:	e9 d7 f6 ff ff       	jmp    80105c27 <alltraps>
...
80106552:	6a 71                	push   $0x71
  jmp alltraps
80106554:	e9 ce f6 ff ff       	jmp    80105c27 <alltraps>
...
8010655b:	6a 72                	push   $0x72
  jmp alltraps
8010655d:	e9 c5 f6 ff ff       	jmp    80105c27 <alltraps>
...
80106564:	6a 73                	push   $0x73
  jmp alltraps
80106566:	e9 bc f6 ff ff       	jmp    80105c27 <alltraps>
...
8010656d:	6a 74                	push   $0x74
  jmp alltraps
8010656f:	e9 b3 f6 ff ff       	jmp    80105c27 <alltraps>
...
80106576:	6a 75                	push   $0x75
  jmp alltraps
80106578:	e9 aa f6 ff ff       	jmp    80105c27 <alltraps>
...
8010657f:	6a 76                	push   $0x76
  jmp alltraps
80106581:	e9 a1 f6 ff ff       	jmp    80105c27 <alltraps>
...
80106588:	6a 77                	push   $0x77
  jmp alltraps
8010658a:	e9 98 f6 ff ff       	jmp    80105c27 <alltraps>
...
80106591:	6a 78                	push   $0x78
  jmp alltraps
80106593:	e9 8f f6 ff ff       	jmp    80105c27 <alltraps>
...
8010659a:	6a 79                	push   $0x79
  jmp alltraps
8010659c:	e9 86 f6 ff ff       	jmp    80105c27 <alltraps>
...
801065a3:	6a 7a                	push   $0x7a
  jmp alltraps
801065a5:	e9 7d f6 ff ff       	jmp    80105c27 <alltraps>
...
801065ac:	6a 7b                	push   $0x7b
  jmp alltraps
801065ae:	e9 74 f6 ff ff       	jmp    80105c27 <alltraps>
...
801065b5:	6a 7c                	push   $0x7c
  jmp alltraps
801065b7:	e9 6b f6 ff ff       	jmp    80105c27 <alltraps>
...
801065be:	6a 7d                	push   $0x7d
  jmp alltraps
801065c0:	e9 62 f6 ff ff       	jmp    80105c27 <alltraps>
...
801065c7:	6a 7e                	push   $0x7e
  jmp alltraps
801065c9:	e9 59 f6 ff ff       	jmp    80105c27 <alltraps>
...
801065d0:	6a 7f                	push   $0x7f
  jmp alltraps
801065d2:	e9 50 f6 ff ff       	jmp    80105c27 <alltraps>
...
801065d9:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801065de:	e9 44 f6 ff ff       	jmp    80105c27 <alltraps>
...
801065e5:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801065ea:	e9 38 f6 ff ff       	jmp    80105c27 <alltraps>
...
801065f1:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801065f6:	e9 2c f6 ff ff       	jmp    80105c27 <alltraps>
...
801065fd:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106602:	e9 20 f6 ff ff       	jmp    80105c27 <alltraps>
...
80106609:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010660e:	e9 14 f6 ff ff       	jmp    80105c27 <alltraps>
...
80106615:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010661a:	e9 08 f6 ff ff       	jmp    80105c27 <alltraps>
...
80106621:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106626:	e9 fc f5 ff ff       	jmp    80105c27 <alltraps>
...
8010662d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106632:	e9 f0 f5 ff ff       	jmp    80105c27 <alltraps>
...
80106639:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010663e:	e9 e4 f5 ff ff       	jmp    80105c27 <alltraps>
...
80106645:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010664a:	e9 d8 f5 ff ff       	jmp    80105c27 <alltraps>
...
80106651:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106656:	e9 cc f5 ff ff       	jmp    80105c27 <alltraps>
...
8010665d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106662:	e9 c0 f5 ff ff       	jmp    80105c27 <alltraps>
...
80106669:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010666e:	e9 b4 f5 ff ff       	jmp    80105c27 <alltraps>
...
80106675:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010667a:	e9 a8 f5 ff ff       	jmp    80105c27 <alltraps>
...
80106681:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106686:	e9 9c f5 ff ff       	jmp    80105c27 <alltraps>
...
8010668d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106692:	e9 90 f5 ff ff       	jmp    80105c27 <alltraps>
...
80106699:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010669e:	e9 84 f5 ff ff       	jmp    80105c27 <alltraps>
...
801066a5:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801066aa:	e9 78 f5 ff ff       	jmp    80105c27 <alltraps>
...
801066b1:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801066b6:	e9 6c f5 ff ff       	jmp    80105c27 <alltraps>
...
801066bd:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801066c2:	e9 60 f5 ff ff       	jmp    80105c27 <alltraps>
...
801066c9:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801066ce:	e9 54 f5 ff ff       	jmp    80105c27 <alltraps>
...
801066d5:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801066da:	e9 48 f5 ff ff       	jmp    80105c27 <alltraps>
...
801066e1:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801066e6:	e9 3c f5 ff ff       	jmp    80105c27 <alltraps>
...
801066ed:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801066f2:	e9 30 f5 ff ff       	jmp    80105c27 <alltraps>
...
801066f9:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801066fe:	e9 24 f5 ff ff       	jmp    80105c27 <alltraps>
...
80106705:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010670a:	e9 18 f5 ff ff       	jmp    80105c27 <alltraps>
...
80106711:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106716:	e9 0c f5 ff ff       	jmp    80105c27 <alltraps>
...
8010671d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106722:	e9 00 f5 ff ff       	jmp    80105c27 <alltraps>
...
80106729:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010672e:	e9 f4 f4 ff ff       	jmp    80105c27 <alltraps>
...
80106735:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010673a:	e9 e8 f4 ff ff       	jmp    80105c27 <alltraps>
...
80106741:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106746:	e9 dc f4 ff ff       	jmp    80105c27 <alltraps>
...
8010674d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106752:	e9 d0 f4 ff ff       	jmp    80105c27 <alltraps>
...
80106759:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010675e:	e9 c4 f4 ff ff       	jmp    80105c27 <alltraps>
...
80106765:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010676a:	e9 b8 f4 ff ff       	jmp    80105c27 <alltraps>
...
80106771:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106776:	e9 ac f4 ff ff       	jmp    80105c27 <alltraps>
...
8010677d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106782:	e9 a0 f4 ff ff       	jmp    80105c27 <alltraps>
...
80106789:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010678e:	e9 94 f4 ff ff       	jmp    80105c27 <alltraps>
...
80106795:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010679a:	e9 88 f4 ff ff       	jmp    80105c27 <alltraps>
...
801067a1:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801067a6:	e9 7c f4 ff ff       	jmp    80105c27 <alltraps>
...
801067ad:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801067b2:	e9 70 f4 ff ff       	jmp    80105c27 <alltraps>
...
801067b9:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801067be:	e9 64 f4 ff ff       	jmp    80105c27 <alltraps>
...
801067c5:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801067ca:	e9 58 f4 ff ff       	jmp    80105c27 <alltraps>
...
801067d1:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801067d6:	e9 4c f4 ff ff       	jmp    80105c27 <alltraps>
...
801067dd:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801067e2:	e9 40 f4 ff ff       	jmp    80105c27 <alltraps>
...
801067e9:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801067ee:	e9 34 f4 ff ff       	jmp    80105c27 <alltraps>
...
801067f5:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801067fa:	e9 28 f4 ff ff       	jmp    80105c27 <alltraps>
...
80106801:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106806:	e9 1c f4 ff ff       	jmp    80105c27 <alltraps>
...
8010680d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106812:	e9 10 f4 ff ff       	jmp    80105c27 <alltraps>
...
80106819:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010681e:	e9 04 f4 ff ff       	jmp    80105c27 <alltraps>
...
80106825:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010682a:	e9 f8 f3 ff ff       	jmp    80105c27 <alltraps>
...
80106831:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106836:	e9 ec f3 ff ff       	jmp    80105c27 <alltraps>
...
8010683d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106842:	e9 e0 f3 ff ff       	jmp    80105c27 <alltraps>
...
80106849:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010684e:	e9 d4 f3 ff ff       	jmp    80105c27 <alltraps>
...
80106855:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010685a:	e9 c8 f3 ff ff       	jmp    80105c27 <alltraps>
...
80106861:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106866:	e9 bc f3 ff ff       	jmp    80105c27 <alltraps>
...
8010686d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106872:	e9 b0 f3 ff ff       	jmp    80105c27 <alltraps>
...
80106879:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010687e:	e9 a4 f3 ff ff       	jmp    80105c27 <alltraps>
...
80106885:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010688a:	e9 98 f3 ff ff       	jmp    80105c27 <alltraps>
...
80106891:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106896:	e9 8c f3 ff ff       	jmp    80105c27 <alltraps>
...
8010689d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801068a2:	e9 80 f3 ff ff       	jmp    80105c27 <alltraps>
...
801068a9:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801068ae:	e9 74 f3 ff ff       	jmp    80105c27 <alltraps>
...
801068b5:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801068ba:	e9 68 f3 ff ff       	jmp    80105c27 <alltraps>
...
801068c1:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801068c6:	e9 5c f3 ff ff       	jmp    80105c27 <alltraps>
...
801068cd:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801068d2:	e9 50 f3 ff ff       	jmp    80105c27 <alltraps>
...
801068d9:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801068de:	e9 44 f3 ff ff       	jmp    80105c27 <alltraps>
...
801068e5:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801068ea:	e9 38 f3 ff ff       	jmp    80105c27 <alltraps>
...
801068f1:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801068f6:	e9 2c f3 ff ff       	jmp    80105c27 <alltraps>
...
801068fd:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106902:	e9 20 f3 ff ff       	jmp    80105c27 <alltraps>
...
80106909:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010690e:	e9 14 f3 ff ff       	jmp    80105c27 <alltraps>
...
80106915:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010691a:	e9 08 f3 ff ff       	jmp    80105c27 <alltraps>
...
80106921:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106926:	e9 fc f2 ff ff       	jmp    80105c27 <alltraps>
...
8010692d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106932:	e9 f0 f2 ff ff       	jmp    80105c27 <alltraps>
...
80106939:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010693e:	e9 e4 f2 ff ff       	jmp    80105c27 <alltraps>
...
80106945:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010694a:	e9 d8 f2 ff ff       	jmp    80105c27 <alltraps>
...
80106951:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106956:	e9 cc f2 ff ff       	jmp    80105c27 <alltraps>
...
8010695d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106962:	e9 c0 f2 ff ff       	jmp    80105c27 <alltraps>
...
80106969:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010696e:	e9 b4 f2 ff ff       	jmp    80105c27 <alltraps>
...
80106975:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010697a:	e9 a8 f2 ff ff       	jmp    80105c27 <alltraps>
...
80106981:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106986:	e9 9c f2 ff ff       	jmp    80105c27 <alltraps>
...
8010698d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106992:	e9 90 f2 ff ff       	jmp    80105c27 <alltraps>
...
80106999:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010699e:	e9 84 f2 ff ff       	jmp    80105c27 <alltraps>
...
801069a5:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801069aa:	e9 78 f2 ff ff       	jmp    80105c27 <alltraps>
...
801069b1:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801069b6:	e9 6c f2 ff ff       	jmp    80105c27 <alltraps>
...
801069bd:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801069c2:	e9 60 f2 ff ff       	jmp    80105c27 <alltraps>
...
801069c9:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801069ce:	e9 54 f2 ff ff       	jmp    80105c27 <alltraps>
...
801069d5:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801069da:	e9 48 f2 ff ff       	jmp    80105c27 <alltraps>
...
801069e1:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801069e6:	e9 3c f2 ff ff       	jmp    80105c27 <alltraps>
...
801069ed:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801069f2:	e9 30 f2 ff ff       	jmp    80105c27 <alltraps>
...
801069f9:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801069fe:	e9 24 f2 ff ff       	jmp    80105c27 <alltraps>
...
80106a05:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80106a0a:	e9 18 f2 ff ff       	jmp    80105c27 <alltraps>
...
80106a11:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106a16:	e9 0c f2 ff ff       	jmp    80105c27 <alltraps>
...
80106a1d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106a22:	e9 00 f2 ff ff       	jmp    80105c27 <alltraps>
...
80106a29:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80106a2e:	e9 f4 f1 ff ff       	jmp    80105c27 <alltraps>
...
80106a35:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80106a3a:	e9 e8 f1 ff ff       	jmp    80105c27 <alltraps>
...
80106a41:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106a46:	e9 dc f1 ff ff       	jmp    80105c27 <alltraps>
...
80106a4d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106a52:	e9 d0 f1 ff ff       	jmp    80105c27 <alltraps>
...
80106a59:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80106a5e:	e9 c4 f1 ff ff       	jmp    80105c27 <alltraps>
...
80106a65:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80106a6a:	e9 b8 f1 ff ff       	jmp    80105c27 <alltraps>
...
80106a71:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106a76:	e9 ac f1 ff ff       	jmp    80105c27 <alltraps>
...
80106a7d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106a82:	e9 a0 f1 ff ff       	jmp    80105c27 <alltraps>
...
80106a89:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80106a8e:	e9 94 f1 ff ff       	jmp    80105c27 <alltraps>
...
80106a95:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80106a9a:	e9 88 f1 ff ff       	jmp    80105c27 <alltraps>
...
80106aa1:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106aa6:	e9 7c f1 ff ff       	jmp    80105c27 <alltraps>
...
80106aad:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106ab2:	e9 70 f1 ff ff       	jmp    80105c27 <alltraps>
...
80106ab9:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80106abe:	e9 64 f1 ff ff       	jmp    80105c27 <alltraps>
...
80106ac5:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80106aca:	e9 58 f1 ff ff       	jmp    80105c27 <alltraps>
...
80106ad1:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106ad6:	e9 4c f1 ff ff       	jmp    80105c27 <alltraps>
...
80106add:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106ae2:	e9 40 f1 ff ff       	jmp    80105c27 <alltraps>
...
80106ae9:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80106aee:	e9 34 f1 ff ff       	jmp    80105c27 <alltraps>
...
80106af5:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80106afa:	e9 28 f1 ff ff       	jmp    80105c27 <alltraps>
...
80106b01:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106b06:	e9 1c f1 ff ff       	jmp    80105c27 <alltraps>
...
80106b0d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106b12:	e9 10 f1 ff ff       	jmp    80105c27 <alltraps>
...
80106b19:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80106b1e:	e9 04 f1 ff ff       	jmp    80105c27 <alltraps>
...
80106b25:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106b2a:	e9 f8 f0 ff ff       	jmp    80105c27 <alltraps>
...
80106b31:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106b36:	e9 ec f0 ff ff       	jmp    80105c27 <alltraps>
...
80106b3d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106b42:	e9 e0 f0 ff ff       	jmp    80105c27 <alltraps>
...
80106b49:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80106b4e:	e9 d4 f0 ff ff       	jmp    80105c27 <alltraps>
...
80106b55:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80106b5a:	e9 c8 f0 ff ff       	jmp    80105c27 <alltraps>
...
80106b61:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106b66:	e9 bc f0 ff ff       	jmp    80105c27 <alltraps>
...
80106b6d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106b72:	e9 b0 f0 ff ff       	jmp    80105c27 <alltraps>
...
80106b79:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80106b7e:	e9 a4 f0 ff ff       	jmp    80105c27 <alltraps>
...
80106b85:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80106b8a:	e9 98 f0 ff ff       	jmp    80105c27 <alltraps>
...
80106b91:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106b96:	e9 8c f0 ff ff       	jmp    80105c27 <alltraps>
...
80106b9d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106ba2:	e9 80 f0 ff ff       	jmp    80105c27 <alltraps>
...
80106ba9:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80106bae:	e9 74 f0 ff ff       	jmp    80105c27 <alltraps>
...
80106bb5:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80106bba:	e9 68 f0 ff ff       	jmp    80105c27 <alltraps>
...
80106bc1:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106bc6:	e9 5c f0 ff ff       	jmp    80105c27 <alltraps>
...
80106bcd:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106bd2:	e9 50 f0 ff ff       	jmp    80105c27 <alltraps>
...
80106d57:	e8 e4 db ff ff       	call   80104940 <memset>
...
80106e74:	0f 84 c2 00 00 00    	je     80106f3c <switchuvm+0xec>
  pushcli();
80106e7a:	e8 41 d8 ff ff       	call   801046c0 <pushcli>
...
80106f29:	5d                   	pop    %ebp
  popcli();
80106f2a:	e9 e1 d7 ff ff       	jmp    80104710 <popcli>
...
80106f8f:	e8 ac d9 ff ff       	call   80104940 <memset>
...
80106fc0:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106fc1:	e9 0a da ff ff       	jmp    801049d0 <memmove>
...
801070fb:	e8 40 d8 ff ff       	call   80104940 <memset>
...
801072a0:	e8 9b d6 ff ff       	call   80104940 <memset>
...
80107410:	e8 bb d5 ff ff       	call   801049d0 <memmove>
...
80107528:	e8 a3 d4 ff ff       	call   801049d0 <memmove>
    len -= n;
    buf += n;
