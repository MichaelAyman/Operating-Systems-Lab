...
main(void)
{
  ...
  if(fork() > 0)
  11:	e8 0e 03 00 00       	call   324 <fork>
  16:	85 c0                	test   %eax,%eax
  18:	7e 0d                	jle    27 <main+0x27>
    sleep(5);  // Let child exit before parent.
  1a:	83 ec 0c             	sub    $0xc,%esp
  1d:	6a 05                	push   $0x5
  1f:	e8 98 03 00 00       	call   3bc <sleep>
  24:	83 c4 10             	add    $0x10,%esp
  exit();
  27:	e8 00 03 00 00       	call   32c <exit>
  2c:	66 90                	xchg   %ax,%ax
  2e:	66 90                	xchg   %ax,%ax
...
float sqrt(int num) {
 ...
 2e3:	d9 05 d8 07 00 00    	flds   0x7d8
 ...
 2fe:	dc ea                	fsubr  %st,%st(2)
    eps = eps / 10;
 300:	d8 35 dc 07 00 00    	fdivs  0x7dc
  for (i = 0; i < 5; i++) {
 ...
 4b9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 637:	90                   	nop
          s = "(null)";
 638:	ba e0 07 00 00       	mov    $0x7e0,%edx
        while(*s != 0){
 ...
 651:	a1 14 0b 00 00       	mov    0xb14,%eax
{
 ...
 691:	5b                   	pop    %ebx
  freep = p;
 692:	89 15 14 0b 00 00    	mov    %edx,0xb14
}
 698:	5e                   	pop    %esi
 699:	5f                   	pop    %edi
 69a:	5d                   	pop    %ebp
 ...
 6c9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6cc:	89 15 14 0b 00 00    	mov    %edx,0xb14
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ec:	8b 3d 14 0b 00 00    	mov    0xb14,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 72f:	73 4f                	jae    780 <malloc+0xa0>
    ...
    if(p == freep)
 731:	8b 3d 14 0b 00 00    	mov    0xb14,%edi
 ...
 75a:	e8 f1 fe ff ff       	call   650 <free>
  return freep;
 75f:	8b 15 14 0b 00 00    	mov    0xb14,%edx
 ...
 7a7:	0b 00 00 
    base.s.size = 0;
 7aa:	bf 18 0b 00 00       	mov    $0xb18,%edi
    base.s.ptr = freep = prevp = &base;
 7af:	c7 05 18 0b 00 00 18 	movl   $0xb18,0xb18
 7b6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7b9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7bb:	c7 05 1c 0b 00 00 00 	movl   $0x0,0xb1c
 7c2:	00 00 00 
    if(p->s.size >= nunits){
