...
int main() {
   ...
   e:	51                   	push   %ecx
	int pid = fork();
   f:	e8 40 03 00 00       	call   354 <fork>
  ...
  18:	75 1f                	jne    39 <main+0x39>
			int ppid= getppid();
  1a:	e8 f5 03 00 00       	call   414 <getppid>
  1f:	89 c3                	mov    %eax,%ebx
			printf(1,"pid: %d. ppid: %d\n", getpid(),ppid);
  21:	e8 b6 03 00 00       	call   3dc <getpid>
  26:	53                   	push   %ebx
  27:	50                   	push   %eax
  28:	68 25 08 00 00       	push   $0x825
  2d:	6a 01                	push   $0x1
  2f:	e8 bc 04 00 00       	call   4f0 <printf>
			exit();
  34:	e8 23 03 00 00       	call   35c <exit>
		}
		else {
			wait();
  39:	e8 26 03 00 00       	call   364 <wait>
		}
	exit();
  ...
  43:	50                   	push   %eax
  44:	50                   	push   %eax
  45:	68 18 08 00 00       	push   $0x818
  4a:	6a 01                	push   $0x1
  4c:	e8 9f 04 00 00       	call   4f0 <printf>
			exit();
  51:	e8 06 03 00 00       	call   35c <exit>
  56:	66 90                	xchg   %ax,%ax
  58:	66 90                	xchg   %ax,%ax
  5a:	66 90                	xchg   %ax,%ax
  5c:	66 90                	xchg   %ax,%ax
...
float sqrt(int num) {
 ...
 313:	d9 05 38 08 00 00    	flds   0x838
 ...
 32e:	dc ea                	fsubr  %st,%st(2)
    eps = eps / 10;
 330:	d8 35 3c 08 00 00    	fdivs  0x83c
  for (i = 0; i < 5; i++) {
 ...
 4f9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 677:	90                   	nop
          s = "(null)";
 678:	ba 40 08 00 00       	mov    $0x840,%edx
        while(*s != 0){
