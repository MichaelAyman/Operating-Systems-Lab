...
float sqrt(int num) {
 ...
 2e3:	d9 05 0c 08 00 00    	flds   0x80c
 ...
 2fe:	dc ea                	fsubr  %st,%st(2)
    eps = eps / 10;
 300:	d8 35 10 08 00 00    	fdivs  0x810
  for (i = 0; i < 5; i++) {
...
000003f4 <printptable>:
SYSCALL(printptable)
 3f4:	b8 1c 00 00 00       	mov    $0x1c,%eax
 3f9:	cd 40                	int    $0x40
 3fb:	c3                   	ret    

000003fc <setpriority>:
SYSCALL(setpriority)
 ...
 41c:	89 d1                	mov    %edx,%ecx
{
 ...
 48e:	56                   	push   %esi
 48f:	57                   	push   %edi
 490:	e8 b7 fe ff ff       	call   34c <write>
  while(--i >= 0)
 ...
 4c9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 505:	57                   	push   %edi
 506:	56                   	push   %esi
 507:	e8 40 fe ff ff       	call   34c <write>
 ...
 55e:	e8 e9 fd ff ff       	call   34c <write>
        putc(fd, c);
 ...
 56f:	57                   	push   %edi
 570:	56                   	push   %esi
 571:	e8 d6 fd ff ff       	call   34c <write>
        putc(fd, c);
 ...
 5db:	57                   	push   %edi
 5dc:	56                   	push   %esi
 5dd:	e8 6a fd ff ff       	call   34c <write>
        while(*s != 0){
 ...
 61c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 61f:	e8 28 fd ff ff       	call   34c <write>
        ap++;
 ...
 647:	90                   	nop
          s = "(null)";
 648:	ba 14 08 00 00       	mov    $0x814,%edx
        while(*s != 0){
 ...
 661:	a1 48 0b 00 00       	mov    0xb48,%eax
{
 ...
 6a1:	5b                   	pop    %ebx
  freep = p;
 6a2:	89 15 48 0b 00 00    	mov    %edx,0xb48
}
 6a8:	5e                   	pop    %esi
 6a9:	5f                   	pop    %edi
 6aa:	5d                   	pop    %ebp
 ...
 6d9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6dc:	89 15 48 0b 00 00    	mov    %edx,0xb48
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6fc:	8b 3d 48 0b 00 00    	mov    0xb48,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 73f:	73 4f                	jae    790 <malloc+0xa0>
    ...
    if(p == freep)
 741:	8b 3d 48 0b 00 00    	mov    0xb48,%edi
 ...
 753:	e8 5c fc ff ff       	call   3b4 <sbrk>
  if(p == (char*)-1)
 ...
 76a:	e8 f1 fe ff ff       	call   660 <free>
  return freep;
 76f:	8b 15 48 0b 00 00    	mov    0xb48,%edx
 ...
 79c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 79f:	89 15 48 0b 00 00    	mov    %edx,0xb48
}
 ...
 7b7:	0b 00 00 
    base.s.size = 0;
 7ba:	bf 4c 0b 00 00       	mov    $0xb4c,%edi
    base.s.ptr = freep = prevp = &base;
 7bf:	c7 05 4c 0b 00 00 4c 	movl   $0xb4c,0xb4c
 7c6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7c9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7cb:	c7 05 50 0b 00 00 00 	movl   $0x0,0xb50
 7d2:	00 00 00 
    if(p->s.size >= nunits){
