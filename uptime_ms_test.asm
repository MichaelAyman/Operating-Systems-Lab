...
int main() {
  ...
  11:	e8 e0 03 00 00       	call   3f6 <uptime_ms>
  16:	83 ec 04             	sub    $0x4,%esp
  19:	50                   	push   %eax
  1a:	68 48 08 00 00       	push   $0x848
  1f:	6a 01                	push   $0x1
  21:	e8 ba 04 00 00       	call   4e0 <printf>
	exit();
  26:	e8 0b 03 00 00       	call   336 <exit>
  2b:	66 90                	xchg   %ax,%ax
  2d:	66 90                	xchg   %ax,%ax
  2f:	66 90                	xchg   %ax,%ax
  31:	66 90                	xchg   %ax,%ax
...
float sqrt(int num) {
 ...
 2e8:	d9 05 6c 08 00 00    	flds   0x86c
 ...
 2fe:	dc ea                	fsubr  %st,%st(2)
    eps = eps / 10;
 300:	d8 35 70 08 00 00    	fdivs  0x870
  for (i = 0; i < 5; i++) {
 ...
 428:	89 d1                	mov    %edx,%ecx
{
 ...
 46b:	0f b6 92 d4 08 00 00 	movzbl 0x8d4(%edx),%edx
 ...
 4e9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 553:	ff 24 85 7c 08 00 00 	jmp    *0x87c(,%eax,4)
 ...
 688:	bf 74 08 00 00       	mov    $0x874,%edi
...
free(void *ap)
{
 ...
 6c1:	a1 e8 08 00 00       	mov    0x8e8,%eax
{
 ...
 709:	5b                   	pop    %ebx
  freep = p;
 70a:	89 15 e8 08 00 00    	mov    %edx,0x8e8
}
 710:	5e                   	pop    %esi
 711:	5f                   	pop    %edi
 712:	5d                   	pop    %ebp
 ...
 747:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 74a:	89 15 e8 08 00 00    	mov    %edx,0x8e8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7ab:	39 05 e8 08 00 00    	cmp    %eax,0x8e8
 ...
 7ce:	e8 ed fe ff ff       	call   6c0 <free>
  return freep;
 7d3:	8b 15 e8 08 00 00    	mov    0x8e8,%edx
 ...
 7fc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7ff:	89 15 e8 08 00 00    	mov    %edx,0x8e8
}
 ...
 80f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 810:	c7 05 e8 08 00 00 ec 	movl   $0x8ec,0x8e8
 817:	08 00 00 
    base.s.size = 0;
 81a:	b8 ec 08 00 00       	mov    $0x8ec,%eax
    base.s.ptr = freep = prevp = &base;
 81f:	c7 05 ec 08 00 00 ec 	movl   $0x8ec,0x8ec
 826:	08 00 00 
    base.s.size = 0;
 829:	c7 05 f0 08 00 00 00 	movl   $0x0,0x8f0
 830:	00 00 00 
    if(p->s.size >= nunits){
