...
int main(int argc, char *argv[]) {
  ...
  24:	e8 f7 04 00 00       	call   520 <printf>
        exit();
  29:	e8 48 03 00 00       	call   376 <exit>
    }
  ...
  46:	50                   	push   %eax
  47:	56                   	push   %esi
  48:	e8 f1 03 00 00       	call   43e <setpriority>
...
float sqrt(int num) {
 ...
 328:	d9 05 d0 08 00 00    	flds   0x8d0
 ...
 33e:	dc ea                	fsubr  %st,%st(2)
    eps = eps / 10;
 340:	d8 35 d4 08 00 00    	fdivs  0x8d4
  for (i = 0; i < 5; i++) {
 ...
 468:	89 d1                	mov    %edx,%ecx
{
 ...
 4ab:	0f b6 92 30 09 00 00 	movzbl 0x930(%edx),%edx
 ...
 529:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 593:	ff 24 85 d8 08 00 00 	jmp    *0x8d8(,%eax,4)
 ...
 6c8:	bf c9 08 00 00       	mov    $0x8c9,%edi
...
free(void *ap)
{
 ...
 701:	a1 44 09 00 00       	mov    0x944,%eax
{
 ...
 749:	5b                   	pop    %ebx
  freep = p;
 74a:	89 15 44 09 00 00    	mov    %edx,0x944
}
 750:	5e                   	pop    %esi
 751:	5f                   	pop    %edi
 752:	5d                   	pop    %ebp
 ...
 787:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 78a:	89 15 44 09 00 00    	mov    %edx,0x944
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7ac:	8b 15 44 09 00 00    	mov    0x944,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7eb:	39 05 44 09 00 00    	cmp    %eax,0x944
 ...
 80e:	e8 ed fe ff ff       	call   700 <free>
  return freep;
 813:	8b 15 44 09 00 00    	mov    0x944,%edx
 ...
 83c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 83f:	89 15 44 09 00 00    	mov    %edx,0x944
}
 ...
 84f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 850:	c7 05 44 09 00 00 48 	movl   $0x948,0x944
 857:	09 00 00 
    base.s.size = 0;
 85a:	b8 48 09 00 00       	mov    $0x948,%eax
    base.s.ptr = freep = prevp = &base;
 85f:	c7 05 48 09 00 00 48 	movl   $0x948,0x948
 866:	09 00 00 
    base.s.size = 0;
 869:	c7 05 4c 09 00 00 00 	movl   $0x0,0x94c
 870:	00 00 00 
    if(p->s.size >= nunits){
