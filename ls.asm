...
main(int argc, char *argv[])
{
  ...
  exit();
  3d:	e8 fa 05 00 00       	call   63c <exit>
    ls(".");
  42:	83 ec 0c             	sub    $0xc,%esp
  45:	68 40 0b 00 00       	push   $0xb40
  4a:	e8 b1 00 00 00       	call   100 <ls>
    exit();
  4f:	e8 e8 05 00 00       	call   63c <exit>
  54:	66 90                	xchg   %ax,%ax
  56:	66 90                	xchg   %ax,%ax
  58:	66 90                	xchg   %ax,%ax
  5a:	66 90                	xchg   %ax,%ax
...
00000100 <ls>:
{
 ...
 10f:	6a 00                	push   $0x0
 111:	57                   	push   %edi
 112:	e8 65 05 00 00       	call   67c <open>
 ...
 12d:	56                   	push   %esi
 12e:	50                   	push   %eax
 12f:	e8 60 05 00 00       	call   694 <fstat>
 ...
 155:	53                   	push   %ebx
 156:	e8 09 05 00 00       	call   664 <close>
 ...
 20b:	50                   	push   %eax
 20c:	53                   	push   %ebx
 20d:	e8 42 04 00 00       	call   654 <read>
 ...
 313:	e8 4c 03 00 00       	call   664 <close>
    return;
 ...
 469:	31 db                	xor    %ebx,%ebx
{
 ...
 475:	57                   	push   %edi
 476:	6a 00                	push   $0x0
 478:	e8 d7 01 00 00       	call   654 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 4dd:	e8 9a 01 00 00       	call   67c <open>
  if(fd < 0)
 ...
 4f1:	50                   	push   %eax
 4f2:	e8 9d 01 00 00       	call   694 <fstat>
  close(fd);
 4f7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 4fa:	89 c6                	mov    %eax,%esi
  close(fd);
 4fc:	e8 63 01 00 00       	call   664 <close>
  return r;
...
float sqrt(int num) {
 ...
 59d:	0f 88 8d 00 00 00    	js     630 <sqrt+0xa0>
    middle = (start + end) / 2;
 5a3:	89 d8                	mov    %ebx,%eax
 5a5:	d1 f8                	sar    %eax
    if (middle * middle == num) {
 5a7:	89 c2                	mov    %eax,%edx
 5a9:	0f af d0             	imul   %eax,%edx
 5ac:	39 d3                	cmp    %edx,%ebx
 5ae:	74 78                	je     628 <sqrt+0x98>
 5b0:	89 de                	mov    %ebx,%esi
  float solution = 0.0;
 5b2:	d9 ee                	fldz   
  int start = 0;
 5b4:	31 c9                	xor    %ecx,%ecx
 5b6:	eb 25                	jmp    5dd <sqrt+0x4d>
 ...
 5c0:	dd d8                	fstp   %st(0)
    ...
    if (middle * middle < num) {
      solution = start;
 5c2:	89 4d f4             	mov    %ecx,-0xc(%ebp)
      start = middle + 1;
 5c5:	8d 48 01             	lea    0x1(%eax),%ecx
      solution = start;
 5c8:	db 45 f4             	fildl  -0xc(%ebp)
  while (start <= end) {
 5cb:	39 ce                	cmp    %ecx,%esi
 5cd:	7c 19                	jl     5e8 <sqrt+0x58>
    middle = (start + end) / 2;
 5cf:	8d 04 0e             	lea    (%esi,%ecx,1),%eax
 5d2:	d1 f8                	sar    %eax
    if (middle * middle == num) {
 5d4:	89 c2                	mov    %eax,%edx
 5d6:	0f af d0             	imul   %eax,%edx
 5d9:	39 da                	cmp    %ebx,%edx
 5db:	74 49                	je     626 <sqrt+0x96>
    if (middle * middle < num) {
 5dd:	39 d3                	cmp    %edx,%ebx
 5df:	7f df                	jg     5c0 <sqrt+0x30>
    }
    else {
      end = middle - 1;
 5e1:	8d 70 ff             	lea    -0x1(%eax),%esi
  while (start <= end) {
 5e4:	39 ce                	cmp    %ecx,%esi
 5e6:	7d e7                	jge    5cf <sqrt+0x3f>
 ...
 5e8:	89 5d f4             	mov    %ebx,-0xc(%ebp)
 5eb:	b8 05 00 00 00       	mov    $0x5,%eax
 5f0:	db 45 f4             	fildl  -0xc(%ebp)
 5f3:	d9 05 44 0b 00 00    	flds   0xb44
 5f9:	eb 07                	jmp    602 <sqrt+0x72>
 5fb:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
 5ff:	90                   	nop
      solution += eps;
 600:	dc c2                	fadd   %st,%st(2)
    while (solution * solution <= num) {
 602:	d9 c2                	fld    %st(2)
 604:	d8 cb                	fmul   %st(3),%st
 606:	d9 ca                	fxch   %st(2)
 608:	db f2                	fcomi  %st(2),%st
 60a:	dd da                	fstp   %st(2)
 60c:	73 f2                	jae    600 <sqrt+0x70>
    }
    solution = solution - eps;
 60e:	dc ea                	fsubr  %st,%st(2)
    eps = eps / 10;
 610:	d8 35 48 0b 00 00    	fdivs  0xb48
  for (i = 0; i < 5; i++) {
 616:	83 e8 01             	sub    $0x1,%eax
 619:	75 e7                	jne    602 <sqrt+0x72>
 61b:	dd d8                	fstp   %st(0)
 61d:	dd d8                	fstp   %st(0)
  }
  return solution;
 ...
 62b:	db 45 f4             	fildl  -0xc(%ebp)
      break;
 62e:	eb b8                	jmp    5e8 <sqrt+0x58>
  float solution = 0.0;
 630:	d9 ee                	fldz   
 632:	eb b4                	jmp    5e8 <sqrt+0x58>
...
SYSCALL(fork)
 634:	b8 01 00 00 00       	mov    $0x1,%eax
 639:	cd 40                	int    $0x40
 63b:	c3                   	ret    
...
0000064c <pipe>:
SYSCALL(pipe)
 64c:	b8 04 00 00 00       	mov    $0x4,%eax
 651:	cd 40                	int    $0x40
 653:	c3                   	ret    
...
00000664 <close>:
SYSCALL(close)
 664:	b8 15 00 00 00       	mov    $0x15,%eax
 669:	cd 40                	int    $0x40
 66b:	c3                   	ret    

0000066c <kill>:
SYSCALL(kill)
 66c:	b8 06 00 00 00       	mov    $0x6,%eax
 671:	cd 40                	int    $0x40
 673:	c3                   	ret    

00000674 <exec>:
SYSCALL(exec)
 674:	b8 07 00 00 00       	mov    $0x7,%eax
 679:	cd 40                	int    $0x40
 67b:	c3                   	ret    

0000067c <open>:
SYSCALL(open)
 67c:	b8 0f 00 00 00       	mov    $0xf,%eax
 681:	cd 40                	int    $0x40
 683:	c3                   	ret    

00000684 <mknod>:
SYSCALL(mknod)
 684:	b8 11 00 00 00       	mov    $0x11,%eax
 689:	cd 40                	int    $0x40
 68b:	c3                   	ret    

0000068c <unlink>:
SYSCALL(unlink)
 68c:	b8 12 00 00 00       	mov    $0x12,%eax
 691:	cd 40                	int    $0x40
 693:	c3                   	ret    

00000694 <fstat>:
SYSCALL(fstat)
 694:	b8 08 00 00 00       	mov    $0x8,%eax
 699:	cd 40                	int    $0x40
 69b:	c3                   	ret    

0000069c <link>:
SYSCALL(link)
 69c:	b8 13 00 00 00       	mov    $0x13,%eax
 6a1:	cd 40                	int    $0x40
 6a3:	c3                   	ret    

000006a4 <mkdir>:
SYSCALL(mkdir)
 6a4:	b8 14 00 00 00       	mov    $0x14,%eax
 6a9:	cd 40                	int    $0x40
 6ab:	c3                   	ret    

000006ac <chdir>:
SYSCALL(chdir)
 6ac:	b8 09 00 00 00       	mov    $0x9,%eax
 6b1:	cd 40                	int    $0x40
 6b3:	c3                   	ret    

000006b4 <dup>:
SYSCALL(dup)
 6b4:	b8 0a 00 00 00       	mov    $0xa,%eax
 6b9:	cd 40                	int    $0x40
 6bb:	c3                   	ret    

000006bc <getpid>:
SYSCALL(getpid)
 6bc:	b8 0b 00 00 00       	mov    $0xb,%eax
 6c1:	cd 40                	int    $0x40
 6c3:	c3                   	ret    

000006c4 <sbrk>:
SYSCALL(sbrk)
 6c4:	b8 0c 00 00 00       	mov    $0xc,%eax
 6c9:	cd 40                	int    $0x40
 6cb:	c3                   	ret    

000006cc <sleep>:
SYSCALL(sleep)
 6cc:	b8 0d 00 00 00       	mov    $0xd,%eax
 6d1:	cd 40                	int    $0x40
 6d3:	c3                   	ret    

000006d4 <uptime>:
SYSCALL(uptime)
 6d4:	b8 0e 00 00 00       	mov    $0xe,%eax
 6d9:	cd 40                	int    $0x40
 6db:	c3                   	ret    

000006dc <gettid>:
SYSCALL(gettid)
 6dc:	b8 16 00 00 00       	mov    $0x16,%eax
 6e1:	cd 40                	int    $0x40
 6e3:	c3                   	ret    

000006e4 <getpgid>:
SYSCALL(getpgid)
 6e4:	b8 17 00 00 00       	mov    $0x17,%eax
 6e9:	cd 40                	int    $0x40
 6eb:	c3                   	ret    

000006ec <setpgid>:
SYSCALL(setpgid)
 6ec:	b8 18 00 00 00       	mov    $0x18,%eax
 6f1:	cd 40                	int    $0x40
 6f3:	c3                   	ret    

000006f4 <getppid>:
SYSCALL(getppid)
 6f4:	b8 19 00 00 00       	mov    $0x19,%eax
 6f9:	cd 40                	int    $0x40
 6fb:	c3                   	ret    

000006fc <uptime_ms>:
SYSCALL(uptime_ms)
 6fc:	b8 1a 00 00 00       	mov    $0x1a,%eax
 701:	cd 40                	int    $0x40
 703:	c3                   	ret    

00000704 <printptable>:
SYSCALL(printptable)
 704:	b8 1c 00 00 00       	mov    $0x1c,%eax
 709:	cd 40                	int    $0x40
 70b:	c3                   	ret    

0000070c <setpriority>:
SYSCALL(setpriority)
 70c:	b8 1b 00 00 00       	mov    $0x1b,%eax
 711:	cd 40                	int    $0x40
 713:	c3                   	ret    
 ...
 72c:	89 d1                	mov    %edx,%ecx
{
 ...
 759:	0f b6 92 ac 0b 00 00 	movzbl 0xbac(%edx),%edx
 ...
 79e:	56                   	push   %esi
 79f:	57                   	push   %edi
 7a0:	e8 b7 fe ff ff       	call   65c <write>
  while(--i >= 0)
 ...
 7d9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 815:	57                   	push   %edi
 816:	56                   	push   %esi
 817:	e8 40 fe ff ff       	call   65c <write>
 ...
 849:	ff 24 85 54 0b 00 00 	jmp    *0xb54(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 86e:	e8 e9 fd ff ff       	call   65c <write>
        putc(fd, c);
 ...
 87f:	57                   	push   %edi
 880:	56                   	push   %esi
 881:	e8 d6 fd ff ff       	call   65c <write>
        putc(fd, c);
 ...
 8eb:	57                   	push   %edi
 8ec:	56                   	push   %esi
 8ed:	e8 6a fd ff ff       	call   65c <write>
        while(*s != 0){
 ...
 92c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 92f:	e8 28 fd ff ff       	call   65c <write>
        ap++;
 ...
 957:	90                   	nop
          s = "(null)";
 958:	ba 4c 0b 00 00       	mov    $0xb4c,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 971:	a1 18 0f 00 00       	mov    0xf18,%eax
{
 ...
 9b1:	5b                   	pop    %ebx
  freep = p;
 9b2:	89 15 18 0f 00 00    	mov    %edx,0xf18
}
 9b8:	5e                   	pop    %esi
 9b9:	5f                   	pop    %edi
 9ba:	5d                   	pop    %ebp
 ...
 9e9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 9ec:	89 15 18 0f 00 00    	mov    %edx,0xf18
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 a09:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 a0c:	8b 3d 18 0f 00 00    	mov    0xf18,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 a4f:	73 4f                	jae    aa0 <malloc+0xa0>
    ...
    if(p == freep)
 a51:	8b 3d 18 0f 00 00    	mov    0xf18,%edi
 ...
 a63:	e8 5c fc ff ff       	call   6c4 <sbrk>
  if(p == (char*)-1)
 ...
 a7a:	e8 f1 fe ff ff       	call   970 <free>
  return freep;
 a7f:	8b 15 18 0f 00 00    	mov    0xf18,%edx
 ...
 aac:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 aaf:	89 15 18 0f 00 00    	mov    %edx,0xf18
}
 ...
 abf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 ac0:	c7 05 18 0f 00 00 1c 	movl   $0xf1c,0xf18
 ac7:	0f 00 00 
    base.s.size = 0;
 aca:	bf 1c 0f 00 00       	mov    $0xf1c,%edi
    base.s.ptr = freep = prevp = &base;
 acf:	c7 05 1c 0f 00 00 1c 	movl   $0xf1c,0xf1c
 ad6:	0f 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 ad9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 adb:	c7 05 20 0f 00 00 00 	movl   $0x0,0xf20
 ae2:	00 00 00 
    if(p->s.size >= nunits){
